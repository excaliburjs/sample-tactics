...
var tx={};o.r(tx),o.d(tx,{Axes:()=>O,Buttons:()=>z,Gamepad:()=>Gamepad,Gamepads:()=>t6,KeyEvent:()=>ei,Keyboard:()=>es,Keys:()=>N,NativePointerButton:()=>tp,PointerButton:()=>t_,PointerComponent:()=>su,PointerEvent:()=>PointerEvent,PointerEventReceiver:()=>rU,PointerScope:()=>G,PointerSystem:()=>rv,PointerType:()=>tg,WheelDeltaMode:()=>tu,WheelEvent:()=>WheelEvent});// NAMESPACE OBJECT: ./Util/Index.ts
var tw={};/**
...
this.at(e).navigatorGamepad=t[e],z)"number"==typeof(s=z[i])&&t[e].buttons[s]&&(o=t[e].buttons[s].value)!==this._oldPads[e].getButton(s)&&(t[e].buttons[s].pressed?(this.at(e).updateButton(s,o),this.at(e).events.emit("button",new tG(s,o,this.at(e)))):this.at(e).updateButton(s,0));// Axes
...
l.pos=l.pos.add(l.dir.scale(-2*iB.surfaceEpsilon));let d=new eg(1/0,1/0);if(this._dynamicCollisionTree.rayCastQuery(l,s+2*iB.surfaceEpsilon,e=>{if(!this._pairExists(t,e)&&i$.canCollide(t,e)){let t=e.rayCast(l,s+10*iB.surfaceEpsilon);if(t){let i=t.sub(h);i.size<d.size&&(d=i,r=e)}}return!1}),r&&eg.isValid(d)){let s=new i$(t,r);this._pairs.has(s.id)||(this._pairs.add(s.id),this._collisionPairCache.push(s));// move the fast moving object to the other body
 ...
 */class i8 extends iz{constructor(t){var e,i,s;super(),this.type="ex.body",this.dependencies=[iN,iG],this.id=tA("body",i8._ID++),this.events=new tS,this._oldTransform=new iL,/**
 ...
 *
 *
 */class sm{constructor(t,e){this._stopped=!1,this._repeatBuilder=e,this._repeatContext=new sR(t),this._actionQueue=this._repeatContext.getQueue(),this._repeatBuilder(this._repeatContext)}update(t){this._stopped||(this._actionQueue.isComplete()&&(this._actionQueue.clearActions(),this._repeatBuilder(this._repeatContext)),this._actionQueue.update(t))}isComplete(){return this._stopped}stop(){this._stopped=!0,this._actionQueue.clearActions()}reset(){}}class sf{constructor(t,e,i,s){if(this._started=!1,this._stopped=!1,this._entity=t,this._tx=t.get(iN),this._motion=t.get(iG),this._speed=s,this._offset=new eg(e,i),s<=0)throw t7.getInstance().error("Attempted to moveBy with speed less than or equal to zero : "+s),Error("Speed must be greater than 0 pixels per second")}update(t){this._started||(this._started=!0,this._start=new eg(this._tx.pos.x,this._tx.pos.y),this._end=this._start.add(this._offset),this._distance=this._offset.size,this._dir=this._end.sub(this._start).normalize()),this.isComplete(this._entity)?(this._tx.pos=em(this._end.x,this._end.y),this._motion.vel=em(0,0)):this._motion.vel=this._dir.scale(this._speed)}isComplete(t){let e=t.get(iN);return this._stopped||e.pos.distance(this._start)>=this._distance}stop(){this._motion.vel=em(0,0),this._stopped=!0}reset(){this._started=!1,this._stopped=!1}}class sv{constructor(t,e,i,s){this.entity=t,this._started=!1,this._stopped=!1,this._tx=t.get(iN),this._motion=t.get(iG),this._end=new eg(e,i),this._speed=s}update(t){this._started||(this._started=!0,this._start=new eg(this._tx.pos.x,this._tx.pos.y),this._distance=this._start.distance(this._end),this._dir=this._end.sub(this._start).normalize());let e=this._dir.scale(this._speed);this._motion.vel=em(e.x,e.y),this.isComplete(this.entity)&&(this._tx.pos=em(this._end.x,this._end.y),this._motion.vel=em(0,0))}isComplete(t){let e=t.get(iN);return this._stopped||new eg(e.pos.x,e.pos.y).distance(this._start)>=this._distance}stop(){this._motion.vel=em(0,0),this._stopped=!0}reset(){this._started=!1,this._stopped=!1}}/**
 ...
 */class sR{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sD extends iz{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,iG]}onAdd(t){this._ctx=new sR(t)}onRemove(){this._ctx=null}/**
 ...
 *
 */class sG extends iz{constructor(t,e=!0){super(),this.draw=t,this.useTransform=e,this.type="ex.debuggraphics"}}let sW={PreUpdate:"preupdate",PostUpdate:"postupdate",PreDraw:"predraw",PostDraw:"postdraw"};/**
...
rr._POS=new eg(0,0),rr._SCALE=new eg(1,1),rr._ACC=new eg(0,0),rr._VEL=new eg(0,0),rr._VEL_ACC=new eg(0,0),rr._SCALE_FACTOR=new eg(0,0);class rn extends s5{constructor(){super(...arguments),this.types=["ex.transform","ex.motion"],this.systemType=to.Update,this.priority=-1}update(t,e){let i,s;for(let r=0;r<t.length;r++){i=t[r].get(iN),s=t[r].get(iG);let n=t[r].get(i8);if(null==n?void 0:n.sleeping)continue;let o=s.acc.clone();(null==n?void 0:n.collisionType)===X.Active&&(null==n?void 0:n.useGravity)&&o.addEqual(iB.gravity),null==n||n.captureOldTransform(),// Update transform and motion based on Euler linear algebra
...
})(),a.fWn,a.Ia8;var h=a.rqv;a.hLI,a.yyv,a.tX5;var l=a.vtX;a.r7K,a.lCh,a.cE4;var d=a.fwF;a.sce,a.AQ6;var c=a._c7;a.KUs,a.Ajp,a.dkO,a.RDh;var u=a._H9;a.mxs,a.OmD,a.kBf,a.C4F,a.NQt,a.JjN,a.EK_,a.V1s,a.xHm,a.Xz7,a.Cdc,a.FKn,a.SUY,a.ab2,a.GfZ,a.YMS,a.oyv,a.aUb,a.SdD,a.JUv,a.jEj,a.TFq,a.HDU,a.R_y,a.ydN,a.t50,a.s$$,a.v2G;var p=a.Ilk;a.s9i,a.dxL,a.LLX;var _=a.wA2;a.R_p,a.IQ$,a.I5F,a.X8$,a.FR6,a.U8o;var g=a.kbG;a.iS_,a.cGG,a.RPN,a.skb,a.SLU,a.RdJ,a.cNu,a.gU7,a.LSk,a.Nmp;var m=a.d1Y;a.xrL,a.sRW,a.cmV,a.qWz,a.N0Q;var f=a.q8b;a.ynB,a.jT9;var v=a.wAz,y=a.D4V;a.NLr,a.N6H,a.W1A,a.JHW,a.ZZ$,a.v2K,a.pBf,a.vpe,a.GMl,a.zW2,a.B0K,a.Nv7,a.C_p,a.MUA,a.xqU,a.pTp,a.vUK,a.j9l;var x=a.Zxw;a.v51,a.Hdx;var w=a.Z$d;a.iqV,a.o$7;var b=a.olM;a.Zm$,a.$QH,a.i78,a.nJg,a.h6u,a.hts,a.j88,a.VME,a.fy2,a.nt,a.Ukr,a.zsu,a.oA6,a.TVh,a.TwZ,a.GTT,a.xxj,a.XdK,a.Jmb;var C=a.cXo;a.Dm5,a.IIB,a.ebW,a.zI0,a.LYD,a.cEG,a.SEl,a.t9V,a.ez5,a.N1d,a.R8U,a.SKZ,a.__J,a.RI$,a.x12,a.ccz;var A=a.aNw;a.XrL,a.xwn,a.dNK,a.ini,a.YdH,a.F5T,a.y3G,a.l57,a.xn0,a.t2V,a.uxB,a.cpd,a.fiy,a.$XZ,a.UG6,a.uqK,a.STE,a.y$z,a.mAD,a.sOq,a.hUw;var S=a._0G;a.Sqs,a.hpZ;var T=a.Vol;a.vYX,a.wIZ,a.cBi,a.c30;var E=a.MPV;a.RFv,a.Ux6,a.rxy,a.I$c,a.kfC,a.VjY,a.mgq,a.YVA,a.Kgp,a.HH$,a.M_d,a.rgh,a.Ra6,a.KhR,a.BS5,a.xhz,a.xOq,a.a9j,a.bHk,a.CgK,a.cuY,a.kvE,a.SBu,a.AE_,a.ctO,a.OLH;var P=a.kky;a.nSF,a.zHn,a.zwx,a.AeJ,a.hLz,a.D9g,a.wA,a.jhr,a.GVs,a._zO,a.LXZ,a.w6$,a.mhV,a.MOD,a.kwd,a.Lmr;var I=a.xsS;a.K5l,a.lLr,a.Z$r,a.IXb,a.SGH,a.SMj,a.L34,a.exe,a.bnF,a.MFA;var M=a.$uU;a.Sap,a.jyi,a.E03;var k=a.V6q;a.rg2,a.DVW,a.nVo,a.F6N,a.xP7,a.Odq,a.Zif,a.ZGJ,a.MJk;var R=a.xvT;a.PHM,a.dpR,a.n9L,a.KwO,a.SxM,a.B7y,a.x7r,a.wx7,a.Uvn,a.OFT,a.xzN,a.CcZ,a.M5Z;var D=a.ZrN,B=a.OWs;a.dF9,a.oZy,a.rD2,a.VHo,a.ohE,a.R$E,a.xQN,a.AdJ,a.q3I,a.Pab;var F=a.uZ5;a.McK,a.F9c,a.k0b,a.hnT,a.RSJ,a.Mku,a.h90,a.rms,a.ErP,a.aVg,a.lPc,a.Z8E,a._N2,a.yFn,a.lNv,a.cu9,a.MZQ,a.FUM,a.BxR;var U=a.vdf,L=a.iaL;a.w6H,a.Q4c,a.Xxe,a.Uxb,a.Yr5;var z=a.Bhw;a.yOA;var O={};O=new URL("title.46943752.png",import.meta.url).toString();var H={};H=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var N={};N=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var G={};G=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var W={};W=new URL("UISheet.2837e64f.png",import.meta.url).toString();var $={};$=new URL("TerrainSheet.720a833c.png",import.meta.url).toString();var V={};V=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var q={};q=new URL("RedHighlightSheet.4a69e4d5.png",import.meta.url).toString();var X={};X=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var Z={};Z=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var K={};K=new URL("hit.cc332530.wav",import.meta.url).toString();var Y={};Y=new URL("move.8e8aee5f.wav",import.meta.url).toString();var j={};j=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();const Q={TitleImage:new C(/*@__PURE__*/t(O)),KnightSpriteSheet:new C(/*@__PURE__*/t(H)),SpiderSheet:new C(/*@__PURE__*/t(N)),HeartSheet:new C(/*@__PURE__*/t(G)),UISheet:new C(/*@__PURE__*/t(W)),TerrainSheet:new C(/*@__PURE__*/t($)),HighlightSheet:new C(/*@__PURE__*/t(V)),RedHighlightSheet:new C(/*@__PURE__*/t(q)),CloudSheet:new C(/*@__PURE__*/t(X)),SmokeSheet:new C(/*@__PURE__*/t(Z)),HitSound:new M(/*@__PURE__*/t(K)),MoveSound:new M(/*@__PURE__*/t(Y)),SelectSound:new M(/*@__PURE__*/t(j))},J=k.fromImageSource({image:Q.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),tt=k.fromImageSource({image:Q.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),te=k.fromImageSource({image:Q.RedHighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),ti=d.fromSpriteSheetCoordinates({spriteSheet:tt,strategy:c.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),ts=d.fromSpriteSheetCoordinates({spriteSheet:te,strategy:c.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),tr=k.fromImageSource({image:Q.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),tn=d.fromSpriteSheetCoordinates({spriteSheet:tr,strategy:c.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),to=k.fromImageSource({image:Q.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),ta=d.fromSpriteSheetCoordinates({spriteSheet:to,strategy:c.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),th=k.fromImageSource({image:Q.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),tl=Q.SmokeSheet.toSprite(),td=Q.TitleImage.toSprite(),tc=new A;for(let t of Object.values(Q))tc.addResource(t);const tu=performance.now();console.log("Random seed:",tu),new P(tu);const tp=z(3,3),t_=z(96,128),tg={Knight:{graphics:{offset:z(0,12*tp.y),idle:ta},health:5,movement:4,attack:2,range:1},Spider:{graphics:{offset:z(0,8*tp.y),idle:tn},health:3,movement:3,attack:1,range:1}};class tm extends _{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=z(0,0),/**
...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=B.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const tf=ti.clone(),tv=ti.clone(),ty=ts.clone();(e=s||(s={})).Grass="G",e.Water="W",e.Sand="S",e.Stone="T";class tx extends l{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:z(t*(i.tileWidth+i.margin)*tp.x,e*(i.tileHeight+i.margin)*tp.y).add(t_),anchor:B.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this._terrain="G",this.pathNode=new tm(this.pos),this.addComponent(this.pathNode),this.terrain="G",tf.scale=tp,tf.opacity=.75,tv.scale=tp,tv.opacity=.75,tv.tint=p.Green,ty.scale=tp,ty.opacity=.75,this.graphics.add("range",tf),this.graphics.add("path",tv),this.graphics.add("attack",ty)}get terrain(){return this._terrain}set terrain(t){switch(this._terrain=t,this.terrain){case"G":this.sprite=J.sprites[L(0,1)];break;case"S":this.sprite=J.sprites[L(2,3)];break;case"W":this.sprite=J.sprites[4],this.pathNode.isWalkable=!1;break;case"T":this.sprite=J.sprites[5]}this.sprite.scale=tp,this.graphics.use(this.sprite.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
...
return[]}}class tb{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new tx(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tw(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&e.unit.active&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-t_.x)/((this.tileWidth+this.margin)*tp.x)),Math.floor((t.y-t_.y)/((this.tileHeight+this.margin)*tp.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}const tC=new T({emitterType:v.Circle,radius:16,minVel:0,maxVel:20,minAngle:0,maxAngle:6.2,isEmitting:!1,emitRate:8,opacity:.75,fadeFlag:!0,particleLife:1500,maxSize:20,minSize:1,startSize:10,endSize:.01,acceleration:z(0,-32),particleSprite:tl,randomRotation:!0,particleRotationalVelocity:Math.PI});class tA extends l{constructor(t,e){super({pos:t,z:10});let i=new x({family:"notjamslab14",size:16*tp.x,unit:w.Px,color:p.Yellow,baseAlign:u.Top,quality:4,shadow:{offset:z(2,2).scale(tp),color:p.Black}}),s=new R({text:e.toFixed(0),font:i});this.graphics.add(s)}}class tS{constructor(t){this.scene=t}spawnDamageNumber(t,e){let i=new tA(t,e);i.actions.easeBy(z(0,-100),1e3,f.EaseOutCubic).die(),this.scene.add(i)}}class tT extends l{constructor(t,e,i,s,r){super({name:i,anchor:z(0,0),z:2}),this.player=r,this.cell=null,this.moved=!1,this.attacked=!1,this.unitConfig={...tg[i]},this.health=this.unitConfig.health,this.anim=this.unitConfig.graphics.idle.clone(),this.anim.scale=tp,this.graphics.use(this.anim),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onInitialize(t){this.damageManager=new tS(t.currentScene)}onPostUpdate(){this.attacked?this.anim.tint=p.Gray:this.anim.tint=p.White,this.health<=0&&(this.cell?.removeUnit(this),// TODO better death animation
this.actions.runAction(new S([new h(this,t=>t.rotateBy(2e3,.5)),new h(this,t=>t.easeBy(z(0,-1e3),300,f.EaseInQuad))])).die())}onPostDraw(t){if(this.health>0){let e=th.getSprite(F(this.health,0,5),0);e&&(e.scale=tp,e.draw(t,10*tp.x+this.unitConfig.graphics.offset.x,10*tp.y+this.unitConfig.graphics.offset.y))}}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new h(this,t=>{t.delay(200),t.callMethod(()=>{Q.MoveSound.play()})}),s=new h(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,f.EaseInOutCubic),t.callMethod(()=>{tC.pos=this.pos.add(tp.scale(16)),tC.emitParticles(5)})}),r=new S([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this),this.moved=!0}reset(){this.moved=!1,this.attacked=!1}canAttack(){return!this.attacked}canMove(){return!this.moved}hasActions(){return this.canMove()||this.canAttack()}pass(){this.moved=!0,this.attacked=!0}getPossibleTargets(){if(this.cell){let t=this.cell.board.pathFinder.getRange(this.cell.pathNode,~this.player.mask,this.unitConfig.range);return t.filter(t=>t.owner)}}async attack(t){t.health-=this.unitConfig.attack,Q.HitSound.play(),this.damageManager.spawnDamageNumber(t.pos.add(t.unitConfig.graphics.offset).add(z(16*tp.x,0)),this.unitConfig.attack),await t.actions.blink(200,200,5).toPromise(),this.attacked=!0}}class tE{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=tE._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=tE._CURRENT_GROUP=tE._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}async turnEnd(){this.active=!1}}class tP extends tE{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new b,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this)),document.body.oncontextmenu=()=>!1}async pointerClick(t){if(!this.active)return;this.selectionManager.resetHighlight();let e=this.board.getCellByWorldPos(t.worldPos);if(t.button===E.Left){// a unit is currently selected
...
t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,t.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[])}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}function tM(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tk=globalThis,tR=tk.ShadowRoot&&(void 0===tk.ShadyCSS||tk.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tD=Symbol(),tB=new WeakMap;class tF{constructor(t,e,i){if(this._$cssResult$=!0,i!==tD)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(tR&&void 0===t){let i=void 0!==e&&1===e.length;i&&(t=tB.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&tB.set(e,t))}return t}toString(){return this.cssText}}const tU=t=>new tF("string"==typeof t?t:t+"",void 0,tD),tL=(t,...e)=>{let i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new tF(i,t,tD)},tz=(t,e)=>{if(tR)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let i of e){let e=document.createElement("style"),s=tk.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}},tO=tR?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return tU(e)})(t):t,{is:tH,defineProperty:tN,getOwnPropertyDescriptor:tG,getOwnPropertyNames:tW,getOwnPropertySymbols:t$,getPrototypeOf:tV}=Object,tq=globalThis,tX=tq.trustedTypes,tZ=tX?tX.emptyScript:"",tK=tq.reactiveElementPolyfillSupport,tY=(t,e)=>t,tj={toAttribute(t,e){switch(e){case Boolean:t=t?tZ:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},tQ=(t,e)=>!tH(t,e),tJ={attribute:!0,type:String,converter:tj,reflect:!1,hasChanged:tQ};Symbol.metadata??=Symbol("metadata"),tq.litPropertyMetadata??=new WeakMap;class t0 extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=tJ){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&tN(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=tG(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get(){return s?.call(this)},set(e){let n=s?.call(this);r.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??tJ}static _$Ei(){if(this.hasOwnProperty(tY("elementProperties")))return;let t=tV(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(tY("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tY("properties"))){let t=this.properties,e=[...tW(t),...t$(t)];for(let i of e)this.createProperty(i,t[i])}let t=this[Symbol.metadata];if(null!==t){let e=litPropertyMetadata.get(t);if(void 0!==e)for(let[t,i]of e)this.elementProperties.set(t,i)}for(let[t,e]of(this._$Eh=new Map,this.elementProperties)){let i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let t of i)e.unshift(tO(t))}else void 0!==t&&e.push(tO(t));return e}static _$Eu(t,e){let i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$E_??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$E_?.delete(t)}_$ES(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return tz(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$E_?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EO(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){let r=(void 0!==i.converter?.toAttribute?i.converter:tj).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){let t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:tj;this._$Em=s,this[s]=r.fromAttribute(e,t.type),this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){if(!((i??=this.constructor.getPropertyOptions(t)).hasChanged??tQ)(s?r:this[t],e))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(t){Promise.reject(t)}let t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[e,i]of t)!0!==i.wrapped||this._$AL.has(e)||void 0===this[e]||this.C(e,this[e],i)}let t=!1,e=this._$AL;try{(t=this.shouldUpdate(e))?(this.willUpdate(e),this._$E_?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$ET()}catch(e){throw t=!1,this._$ET(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$E_?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach(t=>this._$EO(t,this[t])),this._$ET()}updated(t){}firstUpdated(t){}}t0.elementStyles=[],t0.shadowRootOptions={mode:"open"},t0[tY("elementProperties")]=new Map,t0[tY("finalized")]=new Map,tK?.({ReactiveElement:t0}),(tq.reactiveElementVersions??=[]).push("2.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const t1=globalThis,t2=t1.trustedTypes,t5=t2?t2.createPolicy("lit-html",{createHTML:t=>t}):void 0,t3="$lit$",t4=`lit$${(Math.random()+"").slice(9)}$`,t9="?"+t4,t6=`<${t9}>`,t7=document,t8=()=>t7.createComment(""),et=t=>null===t||"object"!=typeof t&&"function"!=typeof t,ee=Array.isArray,ei=t=>ee(t)||"function"==typeof t?.[Symbol.iterator],es="[ 	\n\f\r]",er=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,en=/-->/g,eo=/>/g,ea=RegExp(`>|${es}(?:([^\\s"'>=/]+)(${es}*=${es}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),eh=/'/g,el=/"/g,ed=/^(?:script|style|textarea|title)$/i,ec=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),eu=ec(1),ep=(ec(2),Symbol.for("lit-noChange")),e_=Symbol.for("lit-nothing"),eg=new WeakMap,em=t7.createTreeWalker(t7,129);function ef(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==t5?t5.createHTML(e):e}const ev=(t,e)=>{let i=t.length-1,s=[],r,n=2===e?"<svg>":"",o=er;for(let e=0;e<i;e++){let i=t[e],a,h,l=-1,d=0;for(;d<i.length&&(o.lastIndex=d,null!==(h=o.exec(i)));)d=o.lastIndex,o===er?"!--"===h[1]?o=en:void 0!==h[1]?o=eo:void 0!==h[2]?(ed.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=ea):void 0!==h[3]&&(o=ea):o===ea?">"===h[0]?(o=r??er,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,a=h[1],o=void 0===h[3]?ea:'"'===h[3]?el:eh):o===el||o===eh?o=ea:o===en||o===eo?o=er:(o=ea,r=void 0);let c=o===ea&&t[e+1].startsWith("/>")?" ":"";n+=o===er?i+t6:l>=0?(s.push(a),i.slice(0,l)+t3+i.slice(l)+t4+c):i+t4+(-2===l?e:c)}return[ef(t,n+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class ey{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,a=this.parts,[h,l]=ev(t,e);if(this.el=ey.createElement(h,i),em.currentNode=this.el.content,2===e){let t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=em.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(let t of s.getAttributeNames())if(t.endsWith(t3)){let e=l[n++],i=s.getAttribute(t).split(t4),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?eA:"?"===o[1]?eS:"@"===o[1]?eT:eC}),s.removeAttribute(t)}else t.startsWith(t4)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(ed.test(s.tagName)){let t=s.textContent.split(t4),e=t.length-1;if(e>0){s.textContent=t2?t2.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],t8()),em.nextNode(),a.push({type:2,index:++r});s.append(t[e],t8())}}}else if(8===s.nodeType){if(s.data===t9)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(t4,t+1));)a.push({type:7,index:r}),t+=t4.length-1}}r++}}static createElement(t,e){let i=t7.createElement("template");return i.innerHTML=t,i}}function ex(t,e,i=t,s){if(e===ep)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl,n=et(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t))._$AT(t,i,s),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=ex(t,r._$AS(t,e.values),r,s)),e}class ew{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??t7).importNode(e,!0);em.currentNode=s;let r=em.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new eb(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new eE(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=em.nextNode(),n++)}return em.currentNode=t7,s}p(t){let e=0;for(let i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class eb{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=e_,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){et(t=ex(this,t,e))?t===e_||null==t||""===t?(this._$AH!==e_&&this._$AR(),this._$AH=e_):t!==this._$AH&&t!==ep&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):ei(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==e_&&et(this._$AH)?this._$AA.nextSibling.data=t:this.$(t7.createTextNode(t)),this._$AH=t}g(t){let{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ey.createElement(ef(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let t=new ew(s,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=eg.get(t.strings);return void 0===e&&eg.set(t.strings,e=new ey(t)),e}T(t){ee(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new eb(this.k(t8()),this.k(t8()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class eC{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=e_,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=e_}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(void 0===r)(n=!et(t=ex(this,t,e,0))||t!==this._$AH&&t!==ep)&&(this._$AH=t);else{let s,o;let a=t;for(t=r[0],s=0;s<r.length-1;s++)(o=ex(this,a[i+s],e,s))===ep&&(o=this._$AH[s]),n||=!et(o)||o!==this._$AH[s],o===e_?t=e_:t!==e_&&(t+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!s&&this.O(t)}O(t){t===e_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class eA extends eC{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===e_?void 0:t}}class eS extends eC{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==e_)}}class eT extends eC{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=ex(this,t,e,0)??e_)===ep)return;let i=this._$AH,s=t===e_&&i!==e_||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==e_&&(i===e_||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class eE{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){ex(this,t)}}const eP=t1.litHtmlPolyfillSupport;eP?.(ey,eb),(t1.litHtmlVersions??=[]).push("3.1.0");const eI=(t,e,i)=>{let s=i?.renderBefore??e,r=s._$litPart$;if(void 0===r){let t=i?.renderBefore??null;s._$litPart$=r=new eb(e.insertBefore(t8(),t),t,void 0,i??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class eM extends t0{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=eI(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ep}}eM._$litElement$=!0,eM.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:eM});const ek=globalThis.litElementPolyfillSupport;ek?.({LitElement:eM}),(globalThis.litElementVersions??=[]).push("4.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eR={attribute:!0,type:String,converter:tj,reflect:!1,hasChanged:tQ},eD=(t=eR,e,i)=>{let{kind:s,metadata:r}=i,n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(i.name,t),"accessor"===s){let{name:s}=i;return{set(i){let r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t),e}}}if("setter"===s){let{name:s}=i;return function(i){let r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};function eB(t){return(e,i)=>"object"==typeof i?eD(t,e,i):((t,e,i)=>{let s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eF=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i),eU={ATTRIBUTE:1},eL=t=>(...e)=>({_$litDirective$:t,values:e});class ez{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eO="important",eH=" !"+eO,eN=eL(class extends ez{constructor(t){if(super(t),t.type!==eU.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(eH);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?eO:""):i[t]=s}}return ep}}),eG=eL(class extends ez{constructor(t){if(super(t),t.type!==eU.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return ep}});let eW=class extends eM{static #t=this.styles=tL`
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),this.clearEvents())}render(){let t=this._show?eu`<div class="overlay" @click=${this.hide}></div>`:e_;return eu`
        ${t}
        <div class=${eG({menu:!0,show:this._show})} style=${eN({left:`${this.left}px`,top:`${this.top}px`})}>
            <div class="title-bar"></div>
            <div class="options">
                <button style=${eN({display:this.unit?.canMove()?"block":"none"})} @click="${this.sendEvent("move")}">Move</button>
                <button style=${eN({display:this.unit?.canAttack()?"block":"none"})} @click="${this.sendEvent("attack")}">Attack</button>
...
this._debounce=0}};tM([eB({type:Number})],eW.prototype,"left",void 0),tM([eB({type:Number})],eW.prototype,"top",void 0),tM([eB({type:Number})],eW.prototype,"fontSize",void 0),tM([eB({type:Number})],eW.prototype,"width",void 0),tM([eB({attribute:!1})],eW.prototype,"unit",void 0),tM([eB({type:Number})],eW.prototype,"pixelConversion",void 0),tM([eB({state:!0,attribute:!1})],eW.prototype,"_show",void 0),tM([(t,e,i)=>{let s=t=>t.renderRoot?.querySelector(".menu")??null;return eF(t,e,{get(){return s(this)}})}],eW.prototype,"menuHtml",void 0),eW=tM([(i="unit-menu",(t,e)=>{void 0!==e?e.addInitializer(()=>{customElements.define(i,t)}):customElements.define(i,t)})],eW);class e${constructor(t){this.engine=t,this.uiToWorldPos=new Map,this.unitMenu=new eW,document.body.appendChild(this.unitMenu),document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString()),window.addEventListener("resize",()=>{document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString());let t=this.uiToWorldPos.get(this.unitMenu);if(t){let e=this.engine.screen.worldToPageCoordinates(t);this.unitMenu.left=e.x+this.worldDistanceToPage(32),this.unitMenu.top=e.y}})}worldDistanceToPage(t){let e=this.engine.screen.worldToPageCoordinates(B.Zero),i=this.engine.screen.worldToPageCoordinates(z(t*tp.x,0)).sub(e);return i.x}showUnitMenu(t,e){let i=this.unitMenu,s=this.engine.screen.worldToPageCoordinates(t.pos);i.left=s.x+this.worldDistanceToPage(32),i.top=s.y,i.unit=t;let r=()=>{e.move(),a()},n=()=>{e.attack(),a()},o=()=>{e.pass(),a()};i.addEventListener("move",r),i.addEventListener("attack",n),i.addEventListener("pass",o);let a=()=>{i.removeEventListener("move",r),i.removeEventListener("attack",n),i.removeEventListener("pass",o)};return i.clearEvents=a,i.show(),this.uiToWorldPos.set(i,t.pos),i}}class eV{constructor(t,e,i,s){if(this.engine=t,this.players=e,this.maxTurns=s,this.currentTurn=1,this.currentPlayerIndex=0,this.topScreen=z(400,-2e3),this.centerScreen=z(400,400),this.bottomScreen=z(400,2e3),0===e.length)throw Error("Players should be non-zero in length");this.currentPlayer=e[this.currentPlayerIndex],this.selectionManager=i,this.turnText=new R({text:`Turn ${this.currentTurn}`,font:new x({family:"notjamslab14",size:32*tp.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4})});let r=t.screen.resolution.width;this.turnActor=new l({pos:this.topScreen,coordPlane:g.Screen,color:new p(240,50,50,.4),width:r,height:100,z:10}),this.turnActor.graphics.opacity=0,this.turnActor.graphics.add("text",this.turnText),this.turnActor.graphics.show("text"),t.add(this.turnActor)}async showTurnDisplay(){0===this.currentPlayerIndex&&(this.turnText.text=`Turn ${this.currentTurn}`,await this.turnActor.actions.runAction(new S([new h(this.turnActor,t=>t.easeTo(this.centerScreen,1200,f.EaseInOutCubic).delay(700).easeTo(this.bottomScreen,1200,f.EaseInOutCubic)),new h(this.turnActor,t=>t.fade(1,1200).delay(700).fade(0,1200))])).toPromise(),this.turnActor.pos=this.topScreen)}async start(){// TODO win condition
for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),this.showTurnDisplay(),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayerIndex=this.currentPlayerIndex%this.players.length,this.currentPlayer=this.players[this.currentPlayerIndex],0===this.currentPlayerIndex&&this.currentTurn++}}class eq extends tE{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}findClosestEnemy(t){let e=this.board.getUnits().filter(t=>t.player!==this).map(t=>t.cell).filter(t=>!!t),i=this.findClosestCell(t,e);return i?.unit?i.unit:null}findValidMoveCells(t){// pick a random valid move
...
// }
this.selectionManger.reset()}}return!0}}class eX extends l{constructor(t){super({pos:t,vel:z(U(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=Q.CloudSheet.toSprite(),this.cloudSprite.scale=tp,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class eZ extends I{constructor(t){super(),this.levelData=t}onInitialize(t){this.engine=t,this.add(new eX(z(800,0))),this.add(new eX(z(400,300))),this.add(new eX(z(700,700))),this.board=this.parse(this.levelData),this.add(tC)}onActivate(){this.turnManager.start()}onDeactivate(){// TODO deactivate event handlers on types that have them!!
}parse(t){let e=new tb(t.height,t.width,this);this.selectionManager=new tI(e),this.uiManager=new e$(this.engine),// TODO support arbitrary players
this.players=[new tP(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new eq(t.players[1],this.selectionManager,e)],this.turnManager=new eV(this.engine,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t="K"===r.charAt(1)?"Knight":"Spider",n=+r.charAt(2)-1;o=new tT(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}const eK={name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","G","G","G","G"]},eY=new y({width:800,height:800,displayMode:m.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}}),ej=new class extends I{onInitialize(t){t.input.pointers.primary.once("down",()=>{t.goToScene("level1")}),this.add(new eX(z(800,0))),this.add(new eX(z(400,300))),this.add(new eX(z(700,700))),this.title=new l({pos:z(400,400),coordPlane:g.Screen}),this.title.scale=tp,this.title.graphics.use(td),this.title.actions.repeatForever(t=>{t.easeBy(z(0,-30*tp.y),1e3,f.EaseInOutQuad).easeBy(z(0,30*tp.y),1e3,f.EaseInOutQuad)}),this.add(this.title),this.instructions=new l({pos:z(400,600),coordPlane:g.Screen});let e=new x({family:"notjamslab14",size:32*tp.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4,shadow:{offset:z(10,10).scale(tp),color:p.Black}}),i=new R({text:"Click to Play!",font:e});this.instructions.graphics.use(i),this.instructions.actions.repeatForever(t=>{// ctx.blink(300, 300, 2);
t.rotateTo(Math.PI/32,.2),t.rotateTo(-Math.PI/32,.2)}),this.add(this.instructions)}};eY.addScene("start",ej);const eQ=new class extends eZ{// TODO cinematic?
constructor(){super(eK)}onInitialize(t){super.onInitialize(t);let e=this.board.cells[0].unit;e&&(this.focus=new l({pos:e.pos.add(z(16,16).scale(tp))}))}onActivate(){this.camera.strategy.lockToActor(this.focus),this.camera.zoomOverTime(4,1e3,f.EaseInOutCubic)}};eY.addScene("tutorial",eQ);const eJ=new eZ({name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","G","G","GK1","G","G","G","G","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","GS2","GS2","GS2","GS2","GS2","GS2"]});eY.addScene("level1",eJ),eY.start(tc).then(()=>{eY.goToScene("start")});//# sourceMappingURL=index.38b00a84.js.map

//# sourceMappingURL=index.38b00a84.js.map
