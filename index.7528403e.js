...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],x=this._context.getTransform(),y=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=x.multiply(b),C=x.multiply(C),A=x.multiply(A),S=x.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let T=this._context.tint,E=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,F=e/P,B=i/I,D=(e+f-.01)/P,R=(i+v-.01)/I,k=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
k[this._vertexIndex++]=b.x,k[this._vertexIndex++]=b.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=F,k[this._vertexIndex++]=B,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (0, 1) - 1
k[this._vertexIndex++]=A.x,k[this._vertexIndex++]=A.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=F,k[this._vertexIndex++]=R,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (1, 0) - 2
...
k[this._vertexIndex++]=S.x,k[this._vertexIndex++]=S.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=D,k[this._vertexIndex++]=R,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a}hasPendingDraws(){return 0!==this._imageCount}flush(){// nothing to draw early exit
...
for(let t in this._warningTest)this._warningTest[t]()||t7.getInstance().warn("Warning browser feature missing, Excalibur will have reduced performance:",t);return!0}}/**
     ...
     * collision events.
     */p.Fixed="Fixed";let iI=5,iF={},iB=()=>{for(let t in iF)iF[t]=0},iD=(t,e)=>{let i=tC.isEnabled("suppress-obsolete-message");iF[t]<iI&&!i&&(t7.getInstance().warn(t),console.trace&&e.showStackTrace&&console.trace()),iF[t]++};/**
 ...
 */ik.disableMinimumSpeedForFastBody=!1,function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);n>3&&o&&Object.defineProperty(e,i,o)}([iR({message:"Alias for incorrect spelling used in older versions, will be removed in v0.25.0",alternateMethod:"dynamicTreeVelocityMultiplier"})],ik,"dynamicTreeVelocityMultiplyer",null),/**
 ...
 */class sD{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sR extends iU{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,iW]}onAdd(t){this._ctx=new sD(t)}onRemove(){this._ctx=null}/**
 ...
 */class sz extends sn{/**
     ...
     */set angularVelocity(t){this.motion.angularVelocity=t}get scale(){return this.get(iN).scale}set scale(t){this.get(iN).scale=t}get anchor(){return this._anchor}set anchor(t){this._anchor=eR(t,t=>this._handleAnchorChange(t)),this._handleAnchorChange(t)}_handleAnchorChange(t){this.graphics&&(this.graphics.anchor=t)}/**
...
let r=i[s];if(r){so(r)&&(null==r||r.tick(e,this._token));let i=this.renderFromTopOfGraphic?0:r.height-this.tileHeight;r.draw(t,a*this.tileWidth,l*this.tileHeight-i)}}l=0}this.emit("postdraw",new tR(t,e,this))}debug(t){let e=this.tileWidth*this.columns,i=this.tileHeight*this.rows,s=eg.Zero;for(let i=0;i<this.rows+1;i++){let r=em(0,i*this.tileHeight);t.drawLine(s.add(r),s.add(em(e,r.y)),ef.Red,2)}for(let e=0;e<this.columns+1;e++){let r=em(e*this.tileWidth,0);t.drawLine(s.add(r),s.add(em(r.x,i)),ef.Red,2)}let r=this._composite.getColliders();for(let e of r){let i=ef.Gray;i.a=.5;let s=e.localBounds,r=e.worldPos.sub(this.pos);t.drawRectangle(r,s.width,s.height,i)}}}/**
 * TileMap Tile
 *
...
this.browser=new rR(window,document);// Check compatibility
...
this._overrideInitialize(this),this._isReady=!0,this._isReadyResolve(),this.emit("start",new tF(this)),this._isReadyPromise}_mainloop(t){this.emit("preframe",new tU(this,this.stats.prevFrame));let e=t*this.timescale;this.currentFrameElapsedMs=e;// reset frame stats (reuse existing instances)
...
})(),r.fWn,r.Ia8;var n=r.rqv;r.hLI,r.yyv,r.tX5;var o=r.vtX;r.r7K,r.lCh,r.cE4;var a=r.fwF;r.sce,r.AQ6;var h=r._c7;r.KUs,r.Ajp,r.dkO,r.RDh,r._H9,r.mxs,r.OmD,r.kBf,r.C4F,r.NQt,r.JjN,r.EK_,r.V1s,r.xHm,r.Xz7,r.Cdc,r.FKn,r.SUY,r.ab2,r.GfZ,r.YMS,r.oyv,r.aUb,r.SdD,r.JUv,r.jEj,r.TFq,r.HDU,r.R_y,r.ydN,r.t50,r.s$$,r.v2G;var l=r.Ilk;r.s9i,r.dxL,r.LLX;var d=r.wA2;r.R_p,r.IQ$,r.I5F,r.X8$,r.FR6,r.U8o;var c=r.kbG;r.iS_,r.cGG,r.RPN,r.skb,r.SLU,r.RdJ,r.cNu,r.gU7,r.LSk,r.Nmp;var u=r.d1Y;r.xrL,r.sRW,r.cmV,r.qWz,r.N0Q;var p=r.q8b;r.ynB,r.jT9,r.wAz;var _=r.D4V;r.NLr,r.N6H,r.W1A,r.JHW,r.ZZ$,r.v2K,r.pBf,r.vpe,r.GMl,r.zW2,r.B0K,r.Nv7,r.C_p,r.MUA,r.xqU,r.pTp,r.vUK,r.j9l,r.Zxw,r.v51,r.Hdx,r.Z$d,r.iqV,r.o$7,r.olM,r.Zm$,r.$QH,r.i78,r.nJg,r.h6u,r.hts,r.j88,r.VME,r.fy2,r.nt,r.Ukr,r.zsu,r.oA6,r.TVh,r.TwZ,r.GTT,r.xxj,r.XdK,r.Jmb;var g=r.cXo;r.Dm5,r.IIB,r.ebW,r.zI0,r.LYD,r.cEG,r.SEl,r.t9V,r.ez5,r.N1d,r.R8U,r.SKZ,r.__J,r.RI$,r.x12,r.ccz;var m=r.aNw;r.XrL,r.xwn,r.dNK,r.ini,r.YdH,r.F5T,r.y3G,r.l57,r.xn0,r.t2V,r.uxB,r.cpd,r.fiy,r.$XZ,r.UG6,r.uqK,r.STE,r.y$z,r.mAD,r.sOq,r.hUw;var f=r._0G;r.Sqs,r.hpZ,r.Vol,r.vYX,r.wIZ,r.cBi,r.c30,r.MPV,r.RFv,r.Ux6,r.rxy,r.I$c,r.kfC,r.VjY,r.mgq,r.YVA,r.Kgp,r.HH$,r.M_d,r.rgh,r.Ra6,r.KhR,r.BS5,r.xhz,r.xOq,r.a9j,r.bHk,r.CgK,r.cuY,r.kvE,r.SBu,r.AE_,r.ctO,r.OLH,r.kky,r.nSF,r.zHn,r.zwx,r.AeJ,r.hLz,r.D9g,r.wA,r.jhr,r.GVs,r._zO,r.LXZ,r.w6$,r.mhV,r.MOD,r.kwd,r.Lmr,r.xsS,r.K5l,r.lLr,r.Z$r,r.IXb,r.SGH,r.SMj,r.L34,r.exe,r.bnF,r.MFA;var v=r.$uU;r.Sap,r.jyi,r.E03;var x=r.V6q;r.rg2,r.DVW,r.nVo,r.F6N,r.xP7,r.Odq,r.Zif,r.ZGJ,r.MJk,r.xvT,r.PHM,r.dpR,r.n9L,r.KwO,r.SxM,r.B7y,r.x7r,r.wx7,r.Uvn,r.OFT,r.xzN,r.CcZ,r.M5Z,r.ZrN;var y=r.OWs;r.dF9,r.oZy,r.rD2,r.VHo,r.ohE,r.R$E,r.xQN,r.AdJ,r.q3I,r.Pab;var w=r.uZ5;r.McK,r.F9c,r.k0b,r.hnT,r.RSJ,r.Mku,r.h90,r.rms,r.ErP,r.aVg,r.lPc,r.Z8E,r._N2,r.yFn,r.lNv,r.cu9,r.MZQ,r.FUM,r.BxR;var b=r.vdf,C=r.iaL;r.w6H,r.Q4c,r.Xxe,r.Uxb,r.Yr5;var A=r.Bhw;r.yOA;var S={};S=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var T={};T=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var E={};E=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var P={};P=new URL("UISheet.2837e64f.png",import.meta.url).toString();var I={};I=new URL("TerrainSheet.720a833c.png",import.meta.url).toString();var F={};F=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var B={};B=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var D={};D=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var R={};R=new URL("hit.cc332530.wav",import.meta.url).toString();var k={};k=new URL("move.8e8aee5f.wav",import.meta.url).toString();var M={};M=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();const L={KnightSpriteSheet:new g(/*@__PURE__*/t(S)),SpiderSheet:new g(/*@__PURE__*/t(T)),HeartSheet:new g(/*@__PURE__*/t(E)),UISheet:new g(/*@__PURE__*/t(P)),TerrainSheet:new g(/*@__PURE__*/t(I)),HighlightSheet:new g(/*@__PURE__*/t(F)),CloudSheet:new g(/*@__PURE__*/t(B)),Smoke:new g(/*@__PURE__*/t(D)),HitSound:new v(/*@__PURE__*/t(R)),MoveSound:new v(/*@__PURE__*/t(k)),SelectSound:new v(/*@__PURE__*/t(M))},z=x.fromImageSource({image:L.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),U=x.fromImageSource({image:L.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),O=a.fromSpriteSheetCoordinates({spriteSheet:U,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),H=x.fromImageSource({image:L.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),N=a.fromSpriteSheetCoordinates({spriteSheet:H,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),W=x.fromImageSource({image:L.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),G=a.fromSpriteSheetCoordinates({spriteSheet:W,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),V=x.fromImageSource({image:L.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),q=new m;for(let t of Object.values(L))q.addResource(t);const X=A(3,3),Z=A(96,128),K={Knight:{graphics:{offset:A(0,12*X.y),idle:G},health:5,range:4,attack:2},Spider:{graphics:{offset:A(0,8*X.y),idle:N},health:3,range:3,attack:1}};class Y extends o{constructor(t){super({pos:t,coordPlane:c.Screen,vel:A(b(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=L.CloudSheet.toSprite(),this.cloudSprite.scale=X,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class $ extends d{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=A(0,0),this.gScore=1/0,this.hScore=1/0,this.weight=1,this.isWalkable=!0,this.direction=y.Zero,this.connections=[],this.previousNode=null,this.pos=t}}class j extends o{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:A(t*(i.tileWidth+i.margin)*X.x,e*(i.tileHeight+i.margin)*X.y).add(Z),anchor:y.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this.pathNode=new $(this.pos),this.addComponent(this.pathNode),this.sprite=z.sprites[C(0,5)],this.sprite.scale=X,this.graphics.use(this.sprite.clone()),O.scale=X,this.graphics.add("range",O.clone()),this.graphics.add("path",O.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.isWalkable=!1}toggleHighlight(t,e,i){if(i&&t){let t=this.graphics.getGraphic(e);t&&(t.tint=i)}t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     * Returns the orthogonal neighbors (up, down, left, right)
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class Q{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([$.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i){i>=0&&(e.push(t),t.connections.forEach(t=>{this._getRangeHelper(t,e,i-1)}))}getRange(t,e){let i=[];return this._getRangeHelper(t,i,e),// dedup results
i=i.filter((t,e,i)=>i.indexOf(t)===e)}findPath(t,e){let i=this.query.getEntities().map(t=>t.get($));i.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=y.Down;let s=[t],r=[];for(;s.length>0;){// priority queue, evaluate nodes with the lowest cost
let t=s.sort((t,e)=>t.hScore-e.hScore),i=t[0];// Done!
if(i===e)return this._buildPath(i);// Remove current from the open node set
let n=s.indexOf(i);s.splice(n,1),r.push(i);// Find the neighbors that haven't been explored
let o=i.connections.filter(t=>t.isWalkable).filter(t=>-1===r.indexOf(t)),a=i.direction;o.forEach(t=>{if(-1===s.indexOf(t)){t.previousNode=i,t.gScore=t.weight+i.gScore,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight;// Turn penalty if direction is not straight
let r=t.pos.sub(i.pos).normalize();t.direction=r;let n=a.dot(r);0===n&&(t.hScore+=130),s.push(t)}})}// error case
return[]}}class J extends o{constructor(t,e,i,s){super({anchor:A(0,0)}),this.cell=null,this.unitConfig={...K[i]};let r=this.unitConfig.graphics.idle;r.scale=X,this.graphics.use(r),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onPostDraw(t){let e=V.getSprite(w(this.unitConfig.health,0,5),0);e&&(e.scale=X,e.draw(t,10*X.x,16*X.y))}async move(t){this.cell&&(this.cell.unit=null,this.cell.pathNode.isWalkable=!0);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new n(this,t=>{t.delay(200),t.callMethod(()=>{L.MoveSound.play()})}),s=new n(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,p.EaseInOutCubic)}),r=new f([t,s]);await this.actions.runAction(r).toPromise()}e&&(e.addUnit(this),this.cell=e)}}const tt=new _({width:800,height:800,displayMode:u.FitScreenAndFill});// TODO move to level
// Add clouds :3
tt.add(new Y(A(800,0))),tt.add(new Y(A(400,300))),tt.add(new Y(A(700,700)));const te=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new j(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new Q(i)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-Z.x)/((this.tileWidth+this.margin)*X.x)),Math.floor((t.y-Z.y)/((this.tileHeight+this.margin)*X.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,tt.currentScene);new class{constructor(t,e){this.engine=t,this.board=e,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.active=!0,t.input.pointers.on("down",this.pointerclick.bind(this)),t.input.pointers.on("move",this.pointermove.bind(this))}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}pointerclick(t){if(this.active){if(this.currentUnitSelection)0===this.currentPath.length&&this.showAndFindPath(t.worldPos),this.currentPath.length>1&&(this.currentUnitSelection.move(this.currentPath).then(()=>{this.reset()}),this.resetHighlight(),this.currentUnitSelection=null),this.reset();else{// no unit selected
let e=this.board.getCellByWorldPos(t.worldPos);e?.unit?(this.currentUnitSelection=e.unit,this.showAndFindRange(this.currentUnitSelection)):this.reset()}}}showAndFindRange(t){if(!this.currentUnitSelection||!t.cell)return;let e=this.board.pathFinder.getRange(t.cell.pathNode,this.currentUnitSelection.unitConfig.range);e.forEach(t=>{let e=t.owner;e.toggleHighlight(!0,"range")}),this.currentRange=e}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path")})}showAndFindPath(t){if(!this.currentUnitSelection)return;let e=this.currentUnitSelection.cell?.pathNode,i=this.board.getCellByWorldPos(t);if(this.resetHighlight(),this.showAndFindRange(this.currentUnitSelection),i&&this.currentRange.includes(i.pathNode)){// todo limit path by range
let t=this.board.pathFinder.findPath(e,i?.pathNode);t.forEach(t=>{let e=t.owner;e.toggleHighlight(!0,"path",l.Green)}),this.currentPath=t}}pointermove(t){this.active&&this.currentUnitSelection&&(this.resetHighlight(),this.showAndFindRange(this.currentUnitSelection),this.showAndFindPath(t.worldPos))}}(tt,te),new Q(tt.currentScene);const ti=new J(0,0,"Spider",te);tt.add(ti);const ts=new J(4,5,"Spider",te);tt.add(ts);const tr=new J(1,1,"Knight",te);tt.add(tr),tt.onInitialize=()=>{// const cell = board.getCell(2, 2);
...
//     }
// })
},tt.start(q).then(()=>{});//# sourceMappingURL=index.7528403e.js.map

//# sourceMappingURL=index.7528403e.js.map
