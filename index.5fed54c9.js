 ...
 */class ek{isStale(){return this._transformStale}/**
     ...
     */get origin(){return this._origin}set origin(t){this._origin=eB(t,()=>{this._transformStale=!0}),this._transformStale=!0}constructor(t){var e,i,s,r,n,o;this.id=ek._ID++,this.transform=eP.identity(),this.tint=null,this._transformStale=!0,/**
...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],x=this._context.getTransform(),y=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=x.multiply(b),C=x.multiply(C),A=x.multiply(A),S=x.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let T=this._context.tint,E=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,M=e/P,R=i/I,F=(e+f-.01)/P,B=(i+v-.01)/I,D=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
D[this._vertexIndex++]=b.x,D[this._vertexIndex++]=b.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=M,D[this._vertexIndex++]=R,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (0, 1) - 1
D[this._vertexIndex++]=A.x,D[this._vertexIndex++]=A.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=M,D[this._vertexIndex++]=B,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (1, 0) - 2
D[this._vertexIndex++]=C.x,D[this._vertexIndex++]=C.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=F,D[this._vertexIndex++]=R,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (1, 1) - 3
D[this._vertexIndex++]=S.x,D[this._vertexIndex++]=S.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=F,D[this._vertexIndex++]=B,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a}hasPendingDraws(){return 0!==this._imageCount}flush(){// nothing to draw early exit
...
for(let t in this._warningTest)this._warningTest[t]()||t7.getInstance().warn("Warning browser feature missing, Excalibur will have reduced performance:",t);return!0}}/**
     ...
     * collision events.
     */p.Fixed="Fixed";let iI=5,iM={},iR=()=>{for(let t in iM)iM[t]=0},iF=(t,e)=>{let i=tC.isEnabled("suppress-obsolete-message");iM[t]<iI&&!i&&(t7.getInstance().warn(t),console.trace&&e.showStackTrace&&console.trace()),iM[t]++};/**
 ...
 */class sF{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sB extends iU{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,iW]}onAdd(t){this._ctx=new sF(t)}onRemove(){this._ctx=null}/**
...
this.emit("postdebugdraw",new tk(t,this))}/**
     ...
     */isTimerActive(t){return this._timers.indexOf(t)>-1&&!t.complete}isCurrentScene(){return!!this.engine&&this.engine.currentScene===this}_collectActorStats(t){let e=this.actors.filter(t=>t instanceof sO);for(let i of e)t.stats.currFrame.actors.ui++;for(let e of this.actors)for(let i of(t.stats.currFrame.actors.alive++,e.children))sU(i)?t.stats.currFrame.actors.ui++:t.stats.currFrame.actors.alive++}}(R=tc||(tc={})).Protanope="Protanope",R.Deuteranope="Deuteranope",R.Tritanope="Tritanope";/**
...
this._overrideInitialize(this),this._isReady=!0,this._isReadyResolve(),this.emit("start",new tM(this)),this._isReadyPromise}_mainloop(t){this.emit("preframe",new tU(this,this.stats.prevFrame));let e=t*this.timescale;this.currentFrameElapsedMs=e;// reset frame stats (reuse existing instances)
...
return[]}}class to extends o{constructor(t,e,i,s,r){super({anchor:E(0,0)}),this.player=r,this.cell=null,this.moved=!1,this.unitConfig={...J[i]},this.health=this.unitConfig.health,this.anim=this.unitConfig.graphics.idle.clone(),this.anim.scale=j,this.graphics.use(this.anim),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onPostUpdate(){this.moved?this.anim.tint=l.Gray:this.anim.tint=l.White}onPostDraw(t){let e=Z.getSprite(A(this.health,0,5),0);e&&(e.scale=j,e.draw(t,10*j.x,16*j.y))}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new n(this,t=>{t.delay(200),t.callMethod(()=>{O.MoveSound.play()})}),s=new n(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,p.EaseInOutCubic)}),r=new v([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this),this.moved=!0}reset(){this.moved=!1}canMove(){return!this.moved}async attack(t){}}class ta{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=ta._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=ta._CURRENT_GROUP=ta._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}async turnEnd(){this.active=!1}}const th=new _({width:800,height:800,displayMode:u.FitScreenAndFill});// TODO move to level
// Add clouds :3
...
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tn(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-Q.x)/((this.tileWidth+this.margin)*j.x)),Math.floor((t.y-Q.y)/((this.tileHeight+this.margin)*j.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,th.currentScene),td=new class{constructor(t){this.board=t,this.currentPlayer=null,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentRange=this.findRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range"))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}(tl),tc=new class extends ta{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await b.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.movement));let i=$.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e),await b.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await b.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await b.delay(1e3)}return!0}}("Monsters of the Forest",td,tl),tu=new class extends ta{constructor(t,e,i,s){super(t,s),this.engine=e,this.selectionManager=i,this.passed=!1,this.humanMove=new g,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this))}pointerMove(t){if(!this.active||!this.selectionManager.currentUnitSelection)return;this.selectionManager.resetHighlight();let e=this.selectionManager.findRange(this.selectionManager.currentUnitSelection);this.selectionManager.showHighlight(e,"range");let i=this.board.getCellByWorldPos(t.worldPos);if(i){let t=this.selectionManager.findPath(i,e);this.selectionManager.showHighlight(t,"path")}}async pointerClick(t){if(!this.active)return;let e=this.board.getCellByWorldPos(t.worldPos);// a unit is currently selected
this.selectionManager.currentUnitSelection?e?(this.active=!1,await this.selectionManager.selectDestinationAndMove(this.selectionManager.currentUnitSelection,e),this.humanMove.resolve()):this.selectionManager.reset():e?.unit&&e?.unit?.canMove()?this.selectionManager.selectUnit(e.unit):this.selectionManager.reset()}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new g}hasMoves(){let t=this.board.getUnits().filter(t=>t.player===this).filter(t=>t.canMove());return t.length>0&&!this.passed}async makeMove(){// TODO while there are moves to make or the player has not passed their turn wait
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}("Knights of the Round Table",th,td,tl),tp=new class{constructor(t,e,i){if(this.players=t,this.maxTurns=i,this.currentPlayerIndex=0,0===t.length)throw Error("Players should be non-zero in length");this.currentPlayer=t[this.currentPlayerIndex],this.selectionManager=e}// todo generator??
async start(){for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayer=this.players[this.currentPlayerIndex%this.players.length]}}([tu,tc],td,10),t_=new to(0,0,"Spider",tl,tc);th.add(t_);const tg=new to(4,5,"Spider",tl,tc);th.add(tg);const tm=new to(1,1,"Knight",tl,tu);th.add(tm);const tf=new to(2,1,"Knight",tl,tu);th.add(tf),th.start(K).then(()=>{tp.start()});//# sourceMappingURL=index.5fed54c9.js.map

//# sourceMappingURL=index.5fed54c9.js.map
