...
(()=>{// EXPORTS
r.d(n,{fWn:()=>/* reexport */sk,Ia8:()=>/* reexport */s_,rqv:()=>/* reexport */rY,hLI:()=>/* reexport */sD,yyv:()=>/* reexport */ry,tX5:()=>/* reexport */t1,vtX:()=>/* reexport */sU,r7K:()=>/* reexport */st,lCh:()=>/* reexport */s3,cE4:()=>/* reexport */eP,fwF:()=>/* reexport */Animation,sce:()=>/* reexport */ta,AQ6:()=>/* reexport */rd,_c7:()=>/* reexport */th,KUs:()=>/* reexport */ro,Ajp:()=>/* reexport */io,dkO:()=>/* reexport */O,RDh:()=>/* reexport */tn,_H9:()=>/* reexport */ti,mxs:()=>/* reexport */sE,OmD:()=>/* reexport */i8,kBf:()=>/* reexport */ey,C4F:()=>/* reexport */K,NQt:()=>/* reexport */rk,JjN:()=>/* reexport */rD,EK_:()=>/* reexport */z,V1s:()=>/* reexport */sJ,xHm:()=>/* reexport */sQ,Xz7:()=>/* reexport */ig,Cdc:()=>/* reexport */sc,FKn:()=>/* reexport */i1,SUY:()=>/* reexport */rz,ab2:()=>/* reexport */iJ,GfZ:()=>/* reexport */i0,YMS:()=>/* reexport */iY,oyv:()=>/* reexport */i7,aUb:()=>/* reexport */i2,SdD:()=>/* reexport */tJ,JUv:()=>/* reexport */iW,jEj:()=>/* reexport */rQ,TFq:()=>/* reexport */i3,HDU:()=>/* reexport */tj,R_y:()=>/* reexport */tY,ydN:()=>/* reexport */Z,t50:()=>/* reexport */tQ,s$$:()=>/* reexport */rl,v2G:()=>/* reexport */X,Ilk:()=>/* reexport */ef,s9i:()=>/* reexport */rP,dxL:()=>/* reexport */tc,LLX:()=>/* reexport */rT,wA2:()=>/* reexport */iz,R_p:()=>/* reexport */ij,IQ$:()=>/* reexport */ru,I5F:()=>/* reexport */t8,X8$:()=>/* reexport */ra,FR6:()=>/* reexport */tK,U8o:()=>/* reexport */tZ,kbG:()=>/* reexport */j,iS_:()=>/* reexport */t2,cGG:()=>/* reexport */rI,RPN:()=>/* reexport */s$,skb:()=>/* reexport */rf,SLU:()=>/* reexport */eN,RdJ:()=>/* reexport */Q,cNu:()=>/* reexport */sP,gU7:()=>/* reexport */iP,LSk:()=>/* reexport */sI,Nmp:()=>/* reexport */tr,d1Y:()=>/* reexport */q,xrL:()=>/* reexport */iX,sRW:()=>/* reexport */iK,cmV:()=>/* binding */na,qWz:()=>/* reexport */sS,N0Q:()=>/* reexport */sA,q8b:()=>/* reexport */sp,ynB:()=>/* reexport */i4,jT9:()=>/* reexport */sK,wAz:()=>/* reexport */tl,D4V:()=>/* reexport */rV,NLr:()=>/* reexport */rG,N6H:()=>/* reexport */t4,W1A:()=>/* reexport */t3,JHW:()=>/* reexport */sn,ZZ$:()=>/* reexport */sr,v2K:()=>/* reexport */s7,pBf:()=>/* reexport */rq,vpe:()=>/* reexport */tS,GMl:()=>/* reexport */U,zW2:()=>/* reexport */tf,B0K:()=>/* reexport */im,Nv7:()=>/* reexport */is,C_p:()=>/* reexport */ie,MUA:()=>/* reexport */t9,xqU:()=>/* reexport */t5,pTp:()=>/* reexport */sT,vUK:()=>/* reexport */tC,j9l:()=>/* reexport */sM,Zxw:()=>/* reexport */sL,v51:()=>/* reexport */sF,Hdx:()=>/* reexport */ts,Z$d:()=>/* reexport */tt,iqV:()=>/* reexport */rU,o$7:()=>/* reexport */rM,olM:()=>/* reexport */ex,Zm$:()=>/* reexport */tE,$QH:()=>/* reexport */tM,i78:()=>/* reexport */tR,nJg:()=>/* reexport */Gamepad,h6u:()=>/* reexport */tW,hts:()=>/* reexport */t$,j88:()=>/* reexport */tH,VME:()=>/* reexport */tN,fy2:()=>/* reexport */t6,nt:()=>/* reexport */r6,Ukr:()=>/* reexport */rB,zsu:()=>/* reexport */eF,oA6:()=>/* reexport */sl,TVh:()=>/* reexport */rc,TwZ:()=>/* reexport */sa,GTT:()=>/* reexport */sh,xxj:()=>/* reexport */rm,XdK:()=>/* reexport */tV,Jmb:()=>/* reexport */V,cXo:()=>/* reexport */ez,Dm5:()=>/* reexport */t0,IIB:()=>/* reexport */tx,ebW:()=>/* reexport */rW,zI0:()=>/* reexport */Y,LYD:()=>/* reexport */rx,cEG:()=>/* reexport */rw,SEl:()=>/* reexport */rK,t9V:()=>/* reexport */rZ,ez5:()=>/* reexport */ei,N1d:()=>/* reexport */es,R8U:()=>/* reexport */N,SKZ:()=>/* reexport */tT,__J:()=>/* reexport */rX,RI$:()=>/* reexport */sj,x12:()=>/* reexport */ns,ccz:()=>/* reexport */iQ,aNw:()=>/* reexport */iE,XrL:()=>/* reexport */iS,xwn:()=>/* reexport */sZ,dNK:()=>/* reexport */sX,ini:()=>/* reexport */H,YdH:()=>/* reexport */t7,F5T:()=>/* reexport */e6,y3G:()=>/* reexport */eT,l57:()=>/* reexport */G,xn0:()=>/* reexport */ix,t2V:()=>/* reexport */sR,uxB:()=>/* reexport */i$,cpd:()=>/* reexport */rn,fiy:()=>/* reexport */sf,$XZ:()=>/* reexport */sv,UG6:()=>/* reexport */tp,uqK:()=>/* reexport */iw,STE:()=>/* reexport */ib,y$z:()=>/* reexport */iH,mAD:()=>/* reexport */rb,sOq:()=>/* reexport */iG,hUw:()=>/* reexport */sN,_0G:()=>/* reexport */rj,Sqs:()=>/* reexport */ni,hpZ:()=>/* reexport */r_,Vol:()=>/* reexport */rg,vYX:()=>/* reexport */td,wIZ:()=>/* reexport */iB,cBi:()=>/* reexport */rR,c30:()=>/* reexport */rC,MPV:()=>/* reexport */t_,RFv:()=>/* reexport */su,Ux6:()=>/* reexport */PointerEvent,rxy:()=>/* reexport */rL,I$c:()=>/* reexport */$,kfC:()=>/* reexport */rv,VjY:()=>/* reexport */tg,mgq:()=>/* reexport */nr,YVA:()=>/* reexport */i9,Kgp:()=>/* reexport */e3,HH$:()=>/* reexport */tX,M_d:()=>/* reexport */tF,rgh:()=>/* reexport */tD,Ra6:()=>/* reexport */tO,KhR:()=>/* reexport */tI,BS5:()=>/* reexport */tU,xhz:()=>/* reexport */tq,xOq:()=>/* reexport */tB,a9j:()=>/* reexport */tk,bHk:()=>/* reexport */tz,CgK:()=>/* reexport */tP,cuY:()=>/* reexport */tL,kvE:()=>/* reexport */iV,SBu:()=>/* reexport */e0,AE_:()=>/* reexport */rt,ctO:()=>/* reexport */re,OLH:()=>/* reexport */sY,kky:()=>/* reexport */er,nSF:()=>/* reexport */i_,zHn:()=>/* reexport */iZ,zwx:()=>/* reexport */rh,AeJ:()=>/* reexport */sd,hLz:()=>/* reexport */si,D9g:()=>/* reexport */s9,wA:()=>/* reexport */sg,jhr:()=>/* reexport */sm,GVs:()=>/* reexport */ir,_zO:()=>/* reexport */ek,LXZ:()=>/* reexport */eR,w6$:()=>/* reexport */sx,mhV:()=>/* reexport */sy,MOD:()=>/* reexport */J,kwd:()=>/* reexport */sb,Lmr:()=>/* reexport */sw,xsS:()=>/* reexport */rS,K5l:()=>/* reexport */rA,lLr:()=>/* reexport */Screen,Z$r:()=>/* reexport */et,IXb:()=>/* reexport */sO,SGH:()=>/* reexport */rE,SMj:()=>/* reexport */tm,L34:()=>/* reexport */no,exe:()=>/* reexport */eX,bnF:()=>/* reexport */i6,MFA:()=>/* reexport */W,$uU:()=>/* reexport */iA,Sap:()=>/* reexport */iC,jyi:()=>/* reexport */eL,E03:()=>/* reexport */eH,V6q:()=>/* reexport */eO,rg2:()=>/* reexport */rO,DVW:()=>/* reexport */iv,nVo:()=>/* reexport */sq,F6N:()=>/* reexport */nt,xP7:()=>/* reexport */s5,Odq:()=>/* reexport */ri,Zif:()=>/* reexport */to,ZGJ:()=>/* reexport */iO,MJk:()=>/* reexport */rH,xvT:()=>/* reexport */Text,PHM:()=>/* reexport */te,dpR:()=>/* reexport */eU,n9L:()=>/* reexport */sV,KwO:()=>/* reexport */sG,SxM:()=>/* reexport */sW,B7y:()=>/* reexport */sH,x7r:()=>/* reexport */r$,wx7:()=>/* reexport */iU,Uvn:()=>/* reexport */iN,OFT:()=>/* reexport */iq,xzN:()=>/* reexport */s2,CcZ:()=>/* reexport */s0,M5Z:()=>/* reexport */en,ZrN:()=>/* reexport */tw,OWs:()=>/* reexport */eg,dF9:()=>/* reexport */iF,oZy:()=>/* reexport */eZ,rD2:()=>/* reexport */eK,VHo:()=>/* reexport */tG,ohE:()=>/* reexport */ia,R$E:()=>/* reexport */iy,xQN:()=>/* reexport */tu,AdJ:()=>/* reexport */WheelEvent,q3I:()=>/* reexport */rs,Pab:()=>/* reexport */el,uZ5:()=>/* reexport */eh,McK:()=>/* reexport */tA,F9c:()=>/* reexport */eo,k0b:()=>/* reexport */so,hnT:()=>/* reexport */r0,RSJ:()=>/* reexport */r3,Mku:()=>/* reexport */r2,h90:()=>/* reexport */r9,rms:()=>/* reexport */r4,ErP:()=>/* reexport */rJ,aVg:()=>/* reexport */r5,lPc:()=>/* reexport */r1,Z8E:()=>/* reexport */se,_N2:()=>/* reexport */s4,yFn:()=>/* reexport */s6,lNv:()=>/* reexport */ss,cu9:()=>/* reexport */sz,MZQ:()=>/* reexport */iI,FUM:()=>/* reexport */iD,BxR:()=>/* reexport */e8,vdf:()=>/* reexport */ep,iaL:()=>/* reexport */e_,w6H:()=>/* reexport */eu,Q4c:()=>/* reexport */iR,Xxe:()=>/* reexport */ea,Uxb:()=>/* reexport */ed,Yr5:()=>/* reexport */ec,Bhw:()=>/* reexport */em,yOA:()=>/* reexport */tv});// NAMESPACE OBJECT: ./Events.ts
var t,e,i,s,o,a,h,l,d,c,u,p,_,g,m,f,v,y,x,w,b,C,A,S,E,T,P,I,M,R,k,D,B,F,L,U,z,O,H,N,$,W,G,V,q,X,Z,K,Y,j,Q,J,tt,te,ti,ts,tr,tn,to,ta,th,tl,td,tc,tu,tp,t_,tg,tm,tf={};r.r(tf),r.d(tf,{ActivateEvent:()=>t1,CollisionEndEvent:()=>tJ,CollisionPostSolveEvent:()=>tj,CollisionPreSolveEvent:()=>tY,CollisionStartEvent:()=>tQ,ContactEndEvent:()=>tK,ContactStartEvent:()=>tZ,DeactivateEvent:()=>t2,EnterTriggerEvent:()=>t4,EnterViewPortEvent:()=>t3,EventTypes:()=>U,ExitTriggerEvent:()=>t9,ExitViewPortEvent:()=>t5,GameEvent:()=>tE,GameStartEvent:()=>tM,GameStopEvent:()=>tR,GamepadAxisEvent:()=>tW,GamepadButtonEvent:()=>t$,GamepadConnectEvent:()=>tH,GamepadDisconnectEvent:()=>tN,HiddenEvent:()=>tV,InitializeEvent:()=>t0,KillEvent:()=>tT,PostCollisionEvent:()=>tX,PostDebugDrawEvent:()=>tF,PostDrawEvent:()=>tD,PostFrameEvent:()=>tO,PostKillEvent:()=>tI,PostUpdateEvent:()=>tU,PreCollisionEvent:()=>tq,PreDebugDrawEvent:()=>tB,PreDrawEvent:()=>tk,PreFrameEvent:()=>tz,PreKillEvent:()=>tP,PreUpdateEvent:()=>tL,VisibleEvent:()=>tG});// NAMESPACE OBJECT: ./Graphics/Context/webgl-util.ts
 ...
 */class tR extends tE{constructor(t){super(),this.target=t}}/**
...
}}save(){this._states.push(this._currentState),this._currentState=this._cloneState()}restore(){this._currentState=this._states.pop()}get current(){return this._currentState}set current(t){this._currentState=t}}let eR={Complete:"complete",Load:"load",LoadStart:"loadstart",Progress:"progress",Error:"error"};/**
...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],y=this._context.getTransform(),x=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=y.multiply(b),C=y.multiply(C),A=y.multiply(A),S=y.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let E=this._context.tint,T=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,M=e/P,R=i/I,k=(e+f-.01)/P,D=(i+v-.01)/I,B=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
B[this._vertexIndex++]=b.x,B[this._vertexIndex++]=b.y,B[this._vertexIndex++]=x,B[this._vertexIndex++]=M,B[this._vertexIndex++]=R,B[this._vertexIndex++]=T,B[this._vertexIndex++]=E.r/255,B[this._vertexIndex++]=E.g/255,B[this._vertexIndex++]=E.b/255,B[this._vertexIndex++]=E.a,// (0, 1) - 1
...
B[this._vertexIndex++]=C.x,B[this._vertexIndex++]=C.y,B[this._vertexIndex++]=x,B[this._vertexIndex++]=k,B[this._vertexIndex++]=R,B[this._vertexIndex++]=T,B[this._vertexIndex++]=E.r/255,B[this._vertexIndex++]=E.g/255,B[this._vertexIndex++]=E.b/255,B[this._vertexIndex++]=E.a,// (1, 1) - 3
...
this._tracks=[],this._wasPlayingOnHidden=!1,this._playbackRate=1,this._audioContext=io.create(),this._resource=new ek("",im.type.arraybuffer),t))if(/**
...
for(let t in this._warningTest)this._warningTest[t]()||t7.getInstance().warn("Warning browser feature missing, Excalibur will have reduced performance:",t);return!0}}/**
     ...
     * collision events.
     */p.Fixed="Fixed";let iI=5,iM={},iR=()=>{for(let t in iM)iM[t]=0},ik=(t,e)=>{let i=tC.isEnabled("suppress-obsolete-message");iM[t]<iI&&!i&&(t7.getInstance().warn(t),console.trace&&e.showStackTrace&&console.trace()),iM[t]++};/**
...
class extends o{constructor(...e){ik(n,t),super(...e)}}}}(_=Z||(Z={})).Arcade="arcade",_.Realistic="realistic",(g=K||(K={}))[g.DynamicAABBTree=0]="DynamicAABBTree",(m=Y||(Y={}))[m.Euler=0]="Euler";/**
 ...
 */class iH{constructor(){this.observers=[],this.subscriptions=[]}/**
     ...
     */clear(){this.observers.length=0,this.subscriptions.length=0}}class iN extends iz{constructor(){super(...arguments),this.type="ex.transform",this._transform=new iU,this._addChildTransform=t=>{let e=t.get(iN);e&&(e._transform.parent=this._transform)},/**
 ...
 */class i8 extends iz{constructor(t){var e,i,s;super(),this.type="ex.body",this.dependencies=[iN,i$],this.id=tA("body",i8._ID++),this.events=new tS,this._oldTransform=new iU,/**
 ...
 */class sk{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sD extends iz{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,i$]}onAdd(t){this._ctx=new sk(t)}onRemove(){this._ctx=null}/**
 ...
 */class sL extends eF{constructor(t={}){var e,i,s,r,n,o,a,h,l,d,c,u,p,_,g,m,f,v,y;super(t),/**
...
this._collider.$colliderAdded.notifyAll(this._composite)}/**
     ...
     */getTileByPoint(t){let e=Math.floor((t.x-this.pos.x)/(this.tileWidth*this.scale.x)),i=Math.floor((t.y-this.pos.y)/(this.tileHeight*this.scale.y)),s=this.getTile(e,i);return e>=0&&i>=0&&e<this.columns&&i<this.rows&&s?s:null}getRows(){return this._rows}getColumns(){return this._cols}update(t,e){this.onPreUpdate(t,e),this.emit("preupdate",new tL(t,e,this)),this._oldPos.equals(this.pos)&&this._oldScale.equals(this.scale)||(this.flagCollidersDirty(),this.flagTilesDirty()),this._collidersDirty&&(this._collidersDirty=!1,this._updateColliders()),this._token++,this.pos.clone(this._oldPos),this.scale.clone(this._oldScale),this._transform.pos=this.pos,this.onPostUpdate(t,e),this.emit("postupdate",new tU(t,e,this))}/**
     * Draws the tile map to the screen. Called by the [[Scene]].
     * @param ctx ExcaliburGraphicsContext
     * @param delta  The number of milliseconds since the last draw
     */draw(t,e){let i,s,r,n;this.emit("predraw",new tk(t,e,this));// TODO fix event
...
this.emit("postdebugdraw",new tF(t,this))}/**
     ...
     */isTimerActive(t){return this._timers.indexOf(t)>-1&&!t.complete}isCurrentScene(){return!!this.engine&&this.engine.currentScene===this}_collectActorStats(t){let e=this.actors.filter(t=>t instanceof sO);for(let i of e)t.stats.currFrame.actors.ui++;for(let e of this.actors)for(let i of(t.stats.currFrame.actors.alive++,e.children))sz(i)?t.stats.currFrame.actors.ui++:t.stats.currFrame.actors.alive++}}(R=tc||(tc={})).Protanope="Protanope",R.Deuteranope="Deuteranope",R.Tritanope="Tritanope";/**
...
let s=this.engine.currentScene.world.systemManager.get(rv),r=this.engine.currentScene.world.queryManager.createQuery(s.types);s.preupdate(),s.update(r.getEntities())}_nativeButtonToPointerButton(t){switch(t){case tp.NoButton:return t_.NoButton;case tp.Left:return t_.Left;case tp.Middle:return t_.Middle;case tp.Right:return t_.Right;case tp.Unknown:return t_.Unknown;default:return eS(t)}}_stringToPointerType(t){switch(t){case"touch":return tg.Touch;case"mouse":return tg.Mouse;case"pen":return tg.Pen;default:return tg.Unknown}}}class rU{constructor(t){var e;this._samplePeriod=100,this._currentFrameTime=0,this._frames=0,this._previousSampleTime=0,this._beginFrameTime=0,this._fps=t.initialFps,this._samplePeriod=null!==(e=t.samplePeriod)&&void 0!==e?e:this._samplePeriod,this._currentFrameTime=1e3/t.initialFps,this._nowFn=t.nowFn,this._previousSampleTime=this._nowFn()}/**
 ...
 */class rz{constructor(t){var e,i,s;this._onFatalException=()=>{},this._maxFps=1/0,this._lastTime=0,this._elapsed=1,this._scheduledCbs=[],this._totalElapsed=0,this._options=t,this.tick=t.tick,this._lastTime=null!==(e=this.now())&&void 0!==e?e:0,this._maxFps=null!==(i=t.maxFps)&&void 0!==i?i:this._maxFps,this._onFatalException=null!==(s=t.onFatalException)&&void 0!==s?s:this._onFatalException,this.fpsSampler=new rU({initialFps:60,nowFn:()=>this.now()})}/**
...
let n=t&&t.pointerScope===$.Document?document:this.canvas;this.input={keyboard:new es,pointers:new rL(n,this),gamepads:new t6},this.input.keyboard.init({grabWindowFocus:null===(i=null===(e=this._originalOptions)||void 0===e?void 0:e.grabWindowFocus)||void 0===i||i}),this.input.pointers.init({grabWindowFocus:null===(r=null===(s=this._originalOptions)||void 0===s?void 0:s.grabWindowFocus)||void 0===r||r}),this.input.gamepads.init(),this.inputMapper=new rW(this.input),// Issue #385 make use of the visibility api
 ...
 */class rX extends sU{get font(){return this._font}set font(t){this._font=t,this._text.font=t}/**
     * The text to draw.
 ...
 */class rY{constructor(t,e){this._stopped=!1,this._sequenceBuilder=e,this._sequenceContext=new sk(t),this._actionQueue=this._sequenceContext.getQueue(),this._sequenceBuilder(this._sequenceContext)}update(t){this._actionQueue.update(t)}isComplete(){return this._stopped||this._actionQueue.isComplete()}stop(){this._stopped=!0}reset(){this._stopped=!1,this._actionQueue.reset()}clone(t){return new rY(t,this._sequenceBuilder)}}/**
 ...
 */class r6{/**
     ...
     */constructor(t,e=ef.Magenta,i=!1){this.path=t,this.color=e,this._stream=null,this._gif=null,this._textures=[],this._animation=null,this._transparentColor=null,this._resource=new ek(t,"arraybuffer",i),this._transparentColor=e}/**
     * Should excalibur add a cache busting querystring? By default false.
     * Must be set before loading
     */get bustCache(){return this._resource.bustCache}set bustCache(t){this._resource.bustCache=t}/**
 ...
 */const ey="important",ex=" !"+ey,ew=ef(class extends ev{constructor(t){if(super(t),t.type!==em.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(ex);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?ey:""):i[t]=s}}return t5}}),eb=ef(class extends ev{constructor(t){if(super(t),t.type!==em.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return t5}});let eC=class extends ed{static #t=this.styles=tf`
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{console.log("menu event:",t),this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),console.log("menu hide"))}render(){let t=this._show?t2`<div class="overlay" @click=${this.hide}></div>`:t3;return t2`
        ${t}
...
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new ta(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-J.x)/((this.tileWidth+this.margin)*Q.x)),Math.floor((t.y-J.y)/((this.tileHeight+this.margin)*Q.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,eA.currentScene),eE=new class{constructor(t){this.engine=t,this.uiToWorldPos=new Map,this.unitMenu=new eC,document.body.appendChild(this.unitMenu),document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString()),window.addEventListener("resize",()=>{document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString());let t=this.uiToWorldPos.get(this.unitMenu);if(t){let e=this.engine.screen.worldToPageCoordinates(t);this.unitMenu.left=e.x+this.worldDistanceToPage(32),this.unitMenu.top=e.y}})}worldDistanceToPage(t){let e=this.engine.screen.worldToPageCoordinates(A.Zero),i=this.engine.screen.worldToPageCoordinates(P(t*Q.x,0)).sub(e);return i.x}showUnitMenu(t,e){// TODO move with screen resize
console.log("show menu");let i=this.unitMenu,s=this.engine.screen.worldToPageCoordinates(t.pos);i.left=s.x+this.worldDistanceToPage(32),i.top=s.y;let r=()=>{e.move(),a()},n=()=>{e.attack(),a()},o=()=>{e.pass(),a()};i.addEventListener("move",r),i.addEventListener("attack",n),i.addEventListener("pass",o);let a=()=>{i.removeEventListener("move",r),i.removeEventListener("attack",n),i.removeEventListener("pass",o)};return i.show(),this.uiToWorldPos.set(i,t.pos),i}}(eA),eT=new class{constructor(t){this.board=t,this.currentPlayer=null,this.currentSelectionMode="move",this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentSelectionMode=e,this.currentRange=this.findRange(this.currentUnitSelection),"move"===e?this.showHighlight(this.currentRange,"range"):this.showHighlight(this.currentRange,"attack"))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}(eS),eP=new class extends tl{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await C.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.movement));let i=j.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e,"move"),await C.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await C.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await C.delay(1e3)}return!0}}("Monsters of the Forest",eT,eS),eI=new class extends tl{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new m,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this))}pointerMove(t){if(!this.active||!this.selectionManager.currentUnitSelection)return;this.selectionManager.resetHighlight();let e=this.selectionManager.findRange(this.selectionManager.currentUnitSelection);this.selectionManager.showHighlight(e,"range");let i=this.board.getCellByWorldPos(t.worldPos);if(i){let t=this.selectionManager.findPath(i,e);this.selectionManager.showHighlight(t,"path")}}async pointerClick(t){if(!this.active)return;let e=this.board.getCellByWorldPos(t.worldPos);// a unit is currently selected
this.selectionManager.currentUnitSelection?e?(this.active=!1,await this.selectionManager.selectDestinationAndMove(this.selectionManager.currentUnitSelection,e),this.humanMove.resolve()):this.selectionManager.reset():e?.unit&&e?.unit?.canMove()&&e.unit.player===this?this.uiManger.showUnitMenu(e.unit,{move:()=>{this.selectionManager.selectUnit(e.unit,"move")},attack:()=>{this.selectionManager.selectUnit(e.unit,"attack")},pass:()=>{e.unit?.pass(),this.selectionManager.reset(),this.humanMove.resolve()}}):this.selectionManager.reset()}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new m}hasMoves(){let t=this.board.getUnits().filter(t=>t.player===this).filter(t=>t.canMove());return t.length>0&&!this.passed}async makeMove(){// TODO while there are moves to make or the player has not passed their turn wait
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}("Knights of the Round Table",eA,eT,eE,eS),eM=new class{constructor(t,e,i){if(this.players=t,this.maxTurns=i,this.currentPlayerIndex=0,0===t.length)throw Error("Players should be non-zero in length");this.currentPlayer=t[this.currentPlayerIndex],this.selectionManager=e}// todo generator??
async start(){for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayer=this.players[this.currentPlayerIndex%this.players.length]}}([eI,eP],eT,10),eR=new th(0,0,"Spider",eS,eP);eA.add(eR);const ek=new th(4,5,"Spider",eS,eP);eA.add(ek);const eD=new th(1,1,"Knight",eS,eI);eA.add(eD);const eB=new th(2,1,"Knight",eS,eI);eA.add(eB),eA.start(K).then(()=>{eM.start()});//# sourceMappingURL=index.a079602b.js.map

//# sourceMappingURL=index.a079602b.js.map
