...
this.players=[new tA(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new eW(t.players[1],this.selectionManager,e)],this.turnManager=new eN(this.engine,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t="K"===r.charAt(1)?"Knight":"Spider",n=+r.charAt(2)-1;o=new tb(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}({name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","G","G","GK1","G","G","G","G","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","GS2","G","G","G","G","GS2"]});eG.addScene("level1",eV),eG.start(th).then(()=>{eG.goToScene("level1")});//# sourceMappingURL=index.47ef158f.js.map

//# sourceMappingURL=index.47ef158f.js.map
