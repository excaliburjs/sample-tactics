...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=D.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const tf=te.clone(),tv=te.clone(),ty=ti.clone();(e=s||(s={})).Grass="G",e.Water="W",e.Sand="S",e.Stone="T";class tx extends l{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:L(t*(i.tileWidth+i.margin)*tp.x,e*(i.tileHeight+i.margin)*tp.y).add(t_),anchor:D.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this._terrain="G",this.pathNode=new tm(this.pos),this.addComponent(this.pathNode),this.terrain="G",tf.scale=tp,tf.opacity=.75,tv.scale=tp,tv.opacity=.75,tv.tint=p.Green,ty.scale=tp,ty.opacity=.75,this.graphics.add("range",tf),this.graphics.add("path",tv),this.graphics.add("attack",ty)}get terrain(){return this._terrain}set terrain(t){switch(this._terrain=t,this.terrain){case"G":this.sprite=Q.sprites[U(0,1)];break;case"S":this.sprite=Q.sprites[U(2,3)];break;case"W":this.sprite=Q.sprites[4],this.pathNode.isWalkable=!1;break;case"T":this.sprite=Q.sprites[5]}this.sprite.scale=tp,this.graphics.use(this.sprite.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
...
(s=s.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}/**
     ...
     * @param range 
     * @returns 
     */findPath(t,e,i,s){let r=this.query.getEntities().map(t=>t.get(tm));r.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=D.Down;let n=[t],o=[];for(;n.length>0;){// priority queue, evaluate nodes with the lowest cost
...
}}class tS{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=tS._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=tS._CURRENT_GROUP=tS._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}async turnEnd(){this.active=!1}}class tT extends tS{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new b,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this))}pointerMove(t){if(this.active&&this.selectionManager.currentUnitSelection){// move
...
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}class tE{constructor(t){this.board=t,this.currentPlayer=null,this.currentSelectionMode="move",this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentSelectionMode=e,"move"===e?(this.currentRange=this.findMovementRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range")):(this.currentRange=this.findAttackRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"attack")))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findMovementRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findAttackRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,~t.player.mask,this.currentUnitSelection.unitConfig.range):[]}findMovementRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}function tP(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tI=globalThis,tM=tI.ShadowRoot&&(void 0===tI.ShadyCSS||tI.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tk=Symbol(),tR=new WeakMap;class tD{constructor(t,e,i){if(this._$cssResult$=!0,i!==tk)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(tM&&void 0===t){let i=void 0!==e&&1===e.length;i&&(t=tR.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&tR.set(e,t))}return t}toString(){return this.cssText}}const tB=t=>new tD("string"==typeof t?t:t+"",void 0,tk),tF=(t,...e)=>{let i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new tD(i,t,tk)},tU=(t,e)=>{if(tM)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let i of e){let e=document.createElement("style"),s=tI.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}},tL=tM?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return tB(e)})(t):t,{is:tz,defineProperty:tO,getOwnPropertyDescriptor:tH,getOwnPropertyNames:tN,getOwnPropertySymbols:tW,getPrototypeOf:t$}=Object,tG=globalThis,tV=tG.trustedTypes,tq=tV?tV.emptyScript:"",tX=tG.reactiveElementPolyfillSupport,tZ=(t,e)=>t,tK={toAttribute(t,e){switch(e){case Boolean:t=t?tq:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},tY=(t,e)=>!tz(t,e),tj={attribute:!0,type:String,converter:tK,reflect:!1,hasChanged:tY};Symbol.metadata??=Symbol("metadata"),tG.litPropertyMetadata??=new WeakMap;class tQ extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=tj){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&tO(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=tH(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get(){return s?.call(this)},set(e){let n=s?.call(this);r.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??tj}static _$Ei(){if(this.hasOwnProperty(tZ("elementProperties")))return;let t=t$(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(tZ("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tZ("properties"))){let t=this.properties,e=[...tN(t),...tW(t)];for(let i of e)this.createProperty(i,t[i])}let t=this[Symbol.metadata];if(null!==t){let e=litPropertyMetadata.get(t);if(void 0!==e)for(let[t,i]of e)this.elementProperties.set(t,i)}for(let[t,e]of(this._$Eh=new Map,this.elementProperties)){let i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let t of i)e.unshift(tL(t))}else void 0!==t&&e.push(tL(t));return e}static _$Eu(t,e){let i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$E_??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$E_?.delete(t)}_$ES(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return tU(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$E_?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EO(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){let r=(void 0!==i.converter?.toAttribute?i.converter:tK).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){let t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:tK;this._$Em=s,this[s]=r.fromAttribute(e,t.type),this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){if(!((i??=this.constructor.getPropertyOptions(t)).hasChanged??tY)(s?r:this[t],e))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(t){Promise.reject(t)}let t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[e,i]of t)!0!==i.wrapped||this._$AL.has(e)||void 0===this[e]||this.C(e,this[e],i)}let t=!1,e=this._$AL;try{(t=this.shouldUpdate(e))?(this.willUpdate(e),this._$E_?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$ET()}catch(e){throw t=!1,this._$ET(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$E_?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach(t=>this._$EO(t,this[t])),this._$ET()}updated(t){}firstUpdated(t){}}tQ.elementStyles=[],tQ.shadowRootOptions={mode:"open"},tQ[tZ("elementProperties")]=new Map,tQ[tZ("finalized")]=new Map,tX?.({ReactiveElement:tQ}),(tG.reactiveElementVersions??=[]).push("2.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tJ=globalThis,t0=tJ.trustedTypes,t1=t0?t0.createPolicy("lit-html",{createHTML:t=>t}):void 0,t2="$lit$",t5=`lit$${(Math.random()+"").slice(9)}$`,t3="?"+t5,t4=`<${t3}>`,t9=document,t6=()=>t9.createComment(""),t7=t=>null===t||"object"!=typeof t&&"function"!=typeof t,t8=Array.isArray,et=t=>t8(t)||"function"==typeof t?.[Symbol.iterator],ee="[ 	\n\f\r]",ei=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,es=/-->/g,er=/>/g,en=RegExp(`>|${ee}(?:([^\\s"'>=/]+)(${ee}*=${ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),eo=/'/g,ea=/"/g,eh=/^(?:script|style|textarea|title)$/i,el=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),ed=el(1),ec=(el(2),Symbol.for("lit-noChange")),eu=Symbol.for("lit-nothing"),ep=new WeakMap,e_=t9.createTreeWalker(t9,129);function eg(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==t1?t1.createHTML(e):e}const em=(t,e)=>{let i=t.length-1,s=[],r,n=2===e?"<svg>":"",o=ei;for(let e=0;e<i;e++){let i=t[e],a,h,l=-1,d=0;for(;d<i.length&&(o.lastIndex=d,null!==(h=o.exec(i)));)d=o.lastIndex,o===ei?"!--"===h[1]?o=es:void 0!==h[1]?o=er:void 0!==h[2]?(eh.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=en):void 0!==h[3]&&(o=en):o===en?">"===h[0]?(o=r??ei,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,a=h[1],o=void 0===h[3]?en:'"'===h[3]?ea:eo):o===ea||o===eo?o=en:o===es||o===er?o=ei:(o=en,r=void 0);let c=o===en&&t[e+1].startsWith("/>")?" ":"";n+=o===ei?i+t4:l>=0?(s.push(a),i.slice(0,l)+t2+i.slice(l)+t5+c):i+t5+(-2===l?e:c)}return[eg(t,n+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class ef{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,a=this.parts,[h,l]=em(t,e);if(this.el=ef.createElement(h,i),e_.currentNode=this.el.content,2===e){let t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=e_.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(let t of s.getAttributeNames())if(t.endsWith(t2)){let e=l[n++],i=s.getAttribute(t).split(t5),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?eb:"?"===o[1]?eC:"@"===o[1]?eA:ew}),s.removeAttribute(t)}else t.startsWith(t5)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(eh.test(s.tagName)){let t=s.textContent.split(t5),e=t.length-1;if(e>0){s.textContent=t0?t0.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],t6()),e_.nextNode(),a.push({type:2,index:++r});s.append(t[e],t6())}}}else if(8===s.nodeType){if(s.data===t3)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(t5,t+1));)a.push({type:7,index:r}),t+=t5.length-1}}r++}}static createElement(t,e){let i=t9.createElement("template");return i.innerHTML=t,i}}function ev(t,e,i=t,s){if(e===ec)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl,n=t7(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t))._$AT(t,i,s),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=ev(t,r._$AS(t,e.values),r,s)),e}class ey{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??t9).importNode(e,!0);e_.currentNode=s;let r=e_.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new ex(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new eS(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=e_.nextNode(),n++)}return e_.currentNode=t9,s}p(t){let e=0;for(let i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class ex{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=eu,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t7(t=ev(this,t,e))?t===eu||null==t||""===t?(this._$AH!==eu&&this._$AR(),this._$AH=eu):t!==this._$AH&&t!==ec&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):et(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==eu&&t7(this._$AH)?this._$AA.nextSibling.data=t:this.$(t9.createTextNode(t)),this._$AH=t}g(t){let{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ef.createElement(eg(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let t=new ey(s,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=ep.get(t.strings);return void 0===e&&ep.set(t.strings,e=new ef(t)),e}T(t){t8(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new ex(this.k(t6()),this.k(t6()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class ew{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=eu,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=eu}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(void 0===r)(n=!t7(t=ev(this,t,e,0))||t!==this._$AH&&t!==ec)&&(this._$AH=t);else{let s,o;let a=t;for(t=r[0],s=0;s<r.length-1;s++)(o=ev(this,a[i+s],e,s))===ec&&(o=this._$AH[s]),n||=!t7(o)||o!==this._$AH[s],o===eu?t=eu:t!==eu&&(t+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!s&&this.O(t)}O(t){t===eu?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class eb extends ew{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===eu?void 0:t}}class eC extends ew{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==eu)}}class eA extends ew{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=ev(this,t,e,0)??eu)===ec)return;let i=this._$AH,s=t===eu&&i!==eu||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==eu&&(i===eu||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class eS{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){ev(this,t)}}const eT=tJ.litHtmlPolyfillSupport;eT?.(ef,ex),(tJ.litHtmlVersions??=[]).push("3.1.0");const eE=(t,e,i)=>{let s=i?.renderBefore??e,r=s._$litPart$;if(void 0===r){let t=i?.renderBefore??null;s._$litPart$=r=new ex(e.insertBefore(t6(),t),t,void 0,i??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class eP extends tQ{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=eE(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ec}}eP._$litElement$=!0,eP.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:eP});const eI=globalThis.litElementPolyfillSupport;eI?.({LitElement:eP}),(globalThis.litElementVersions??=[]).push("4.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eM={attribute:!0,type:String,converter:tK,reflect:!1,hasChanged:tY},ek=(t=eM,e,i)=>{let{kind:s,metadata:r}=i,n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(i.name,t),"accessor"===s){let{name:s}=i;return{set(i){let r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t),e}}}if("setter"===s){let{name:s}=i;return function(i){let r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};function eR(t){return(e,i)=>"object"==typeof i?ek(t,e,i):((t,e,i)=>{let s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eD=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i),eB={ATTRIBUTE:1},eF=t=>(...e)=>({_$litDirective$:t,values:e});class eU{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eL="important",ez=" !"+eL,eO=eF(class extends eU{constructor(t){if(super(t),t.type!==eB.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(ez);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?eL:""):i[t]=s}}return ec}}),eH=eF(class extends eU{constructor(t){if(super(t),t.type!==eB.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return ec}});let eN=class extends eP{static #t=this.styles=tF`
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),this.clearEvents())}render(){let t=this._show?ed`<div class="overlay" @click=${this.hide}></div>`:eu;return ed`
        ${t}
        <div class=${eH({menu:!0,show:this._show})} style=${eO({left:`${this.left}px`,top:`${this.top}px`})}>
            <div class="title-bar"></div>
            <div class="options">
                <button style=${eO({display:this.unit?.canMove()?"block":"none"})} @click="${this.sendEvent("move")}">Move</button>
                <button style=${eO({display:this.unit?.canAttack()?"block":"none"})} @click="${this.sendEvent("attack")}">Attack</button>
...
this._debounce=0}};tP([eR({type:Number})],eN.prototype,"left",void 0),tP([eR({type:Number})],eN.prototype,"top",void 0),tP([eR({type:Number})],eN.prototype,"fontSize",void 0),tP([eR({type:Number})],eN.prototype,"width",void 0),tP([eR({attribute:!1})],eN.prototype,"unit",void 0),tP([eR({type:Number})],eN.prototype,"pixelConversion",void 0),tP([eR({state:!0,attribute:!1})],eN.prototype,"_show",void 0),tP([(t,e,i)=>{let s=t=>t.renderRoot?.querySelector(".menu")??null;return eD(t,e,{get(){return s(this)}})}],eN.prototype,"menuHtml",void 0),eN=tP([(i="unit-menu",(t,e)=>{void 0!==e?e.addInitializer(()=>{customElements.define(i,t)}):customElements.define(i,t)})],eN);class eW{constructor(t){this.engine=t,this.uiToWorldPos=new Map,this.unitMenu=new eN,document.body.appendChild(this.unitMenu),document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString()),window.addEventListener("resize",()=>{document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString());let t=this.uiToWorldPos.get(this.unitMenu);if(t){let e=this.engine.screen.worldToPageCoordinates(t);this.unitMenu.left=e.x+this.worldDistanceToPage(32),this.unitMenu.top=e.y}})}worldDistanceToPage(t){let e=this.engine.screen.worldToPageCoordinates(D.Zero),i=this.engine.screen.worldToPageCoordinates(L(t*tp.x,0)).sub(e);return i.x}showUnitMenu(t,e){let i=this.unitMenu,s=this.engine.screen.worldToPageCoordinates(t.pos);i.left=s.x+this.worldDistanceToPage(32),i.top=s.y,i.unit=t;let r=()=>{e.move(),a()},n=()=>{e.attack(),a()},o=()=>{e.pass(),a()};i.addEventListener("move",r),i.addEventListener("attack",n),i.addEventListener("pass",o);let a=()=>{i.removeEventListener("move",r),i.removeEventListener("attack",n),i.removeEventListener("pass",o)};return i.clearEvents=a,i.show(),this.uiToWorldPos.set(i,t.pos),i}}class e${constructor(t,e,i,s){if(this.engine=t,this.players=e,this.maxTurns=s,this.currentTurn=1,this.currentPlayerIndex=0,this.topScreen=L(400,-2e3),this.centerScreen=L(400,400),this.bottomScreen=L(400,2e3),0===e.length)throw Error("Players should be non-zero in length");this.currentPlayer=e[this.currentPlayerIndex],this.selectionManager=i,this.turnText=new k({text:`Turn ${this.currentTurn}`,font:new x({family:"notjamslab14",size:32*tp.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4})});let r=t.screen.resolution.width;this.turnActor=new l({pos:this.topScreen,coordPlane:g.Screen,color:new p(240,50,50,.4),width:r,height:100,z:10}),this.turnActor.graphics.opacity=0,this.turnActor.graphics.add("text",this.turnText),this.turnActor.graphics.show("text"),t.add(this.turnActor)}async showTurnDisplay(){0===this.currentPlayerIndex&&(this.turnText.text=`Turn ${this.currentTurn}`,await this.turnActor.actions.runAction(new S([new h(this.turnActor,t=>t.easeTo(this.centerScreen,1200,f.EaseInOutCubic).delay(700).easeTo(this.bottomScreen,1200,f.EaseInOutCubic)),new h(this.turnActor,t=>t.fade(1,1200).delay(700).fade(0,1200))])).toPromise(),this.turnActor.pos=this.topScreen)}async start(){// TODO win condition
for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),this.showTurnDisplay(),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayerIndex=this.currentPlayerIndex%this.players.length,this.currentPlayer=this.players[this.currentPlayerIndex],0===this.currentPlayerIndex&&this.currentTurn++}}class eG extends tS{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await R.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.movement));let i=tu.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e,"move"),await R.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await R.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await R.delay(1e3)}return!0}}class eV extends l{constructor(t){super({pos:t,coordPlane:g.Screen,vel:L(F(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=j.CloudSheet.toSprite(),this.cloudSprite.scale=tp,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}const eq=new y({width:800,height:800,displayMode:m.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}}),eX=new class extends P{onInitialize(t){t.input.pointers.primary.once("down",()=>{t.goToScene("level1")}),this.add(new eV(L(800,0))),this.add(new eV(L(400,300))),this.add(new eV(L(700,700))),this.title=new l({pos:L(400,400),coordPlane:g.Screen}),this.title.scale=tp,this.title.graphics.use(tl),this.title.actions.repeatForever(t=>{t.easeBy(L(0,-30*tp.y),1e3,f.EaseInOutQuad).easeBy(L(0,30*tp.y),1e3,f.EaseInOutQuad)}),this.add(this.title),this.instructions=new l({pos:L(400,600),coordPlane:g.Screen});let e=new x({family:"notjamslab14",size:32*tp.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4,shadow:{offset:L(10,10).scale(tp),color:p.Black}}),i=new k({text:"Click to Play!",font:e});this.instructions.graphics.use(i),this.instructions.actions.repeatForever(t=>{// ctx.blink(300, 300, 2);
t.rotateTo(Math.PI/32,.2),t.rotateTo(-Math.PI/32,.2)}),this.add(this.instructions)}};eq.addScene("start",eX);const eZ=new class extends P{constructor(t){super(),this.levelData=t}onInitialize(t){this.engine=t,this.add(new eV(L(800,0))),this.add(new eV(L(400,300))),this.add(new eV(L(700,700))),this.board=this.parse(this.levelData),this.add(tC)}onActivate(){this.turnManager.start()}onDeactivate(){// TODO deactivate event handlers on types that have them!!
}parse(t){let e=new tb(t.height,t.width,this);this.selectionManager=new tE(e),this.uiManager=new eW(this.engine),// TODO support arbitrary players
this.players=[new tT(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new eG(t.players[1],this.selectionManager,e)],this.turnManager=new e$(this.engine,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t="K"===r.charAt(1)?"Knight":"Spider",n=+r.charAt(2)-1;o=new tA(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}({name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","G","G","GK1","G","G","G","G","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","GS2","GS2","GS2","GS2","GS2","GS2"]});eq.addScene("level1",eZ),eq.start(td).then(()=>{eq.goToScene("start")});//# sourceMappingURL=index.70fc3efb.js.map

//# sourceMappingURL=index.70fc3efb.js.map
