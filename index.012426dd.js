...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],y=this._context.getTransform(),x=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=y.multiply(b),C=y.multiply(C),A=y.multiply(A),S=y.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let E=this._context.tint,T=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,M=e/P,k=i/I,R=(e+f-.01)/P,B=(i+v-.01)/I,D=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
D[this._vertexIndex++]=b.x,D[this._vertexIndex++]=b.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=M,D[this._vertexIndex++]=k,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a,// (0, 1) - 1
...
D[this._vertexIndex++]=C.x,D[this._vertexIndex++]=C.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=R,D[this._vertexIndex++]=k,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a,// (1, 1) - 3
D[this._vertexIndex++]=S.x,D[this._vertexIndex++]=S.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=R,D[this._vertexIndex++]=B,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a}hasPendingDraws(){return 0!==this._imageCount}flush(){// nothing to draw early exit
 ...
 */class sR{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sB extends iz{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,i$]}onAdd(t){this._ctx=new sR(t)}onRemove(){this._ctx=null}/**
 ...
 */const ev="important",ey=" !"+ev,ex=em(class extends ef{constructor(t){if(super(t),t.type!==eg.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(ey);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?ev:""):i[t]=s}}return t5}}),ew=em(class extends ef{constructor(t){if(super(t),t.type!==eg.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return t5}});let eb=class extends ed{static #t=this.styles=tf`
    ...
    `;sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.show=!1,this.requestUpdate()}}hide(){this.show=!1}render(){let t=this.show?t2`<div class="overlay" @click=${this.hide}></div>`:t3;return t2`
        ${t}
        <div class=${ew({menu:!0,show:this.show})} style=${ex({left:`${this.left}px`,top:`${this.top}px`})}>
...
async start(){for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayer=this.players[this.currentPlayerIndex%this.players.length]}}([eP,eT],eE,10),eM=new th(0,0,"Spider",eA,eT);eC.add(eM);const ek=new th(4,5,"Spider",eA,eT);eC.add(ek);const eR=new th(1,1,"Knight",eA,eP);eC.add(eR);const eB=new th(2,1,"Knight",eA,eP);eC.add(eB),eC.start(K).then(()=>{eI.start();// const uiManager = new UIManager(game);
// uiManager.showUnitMenu(knight1, knight1.pos);
// // uiManager.showMenu(spider2.pos);
});//# sourceMappingURL=index.012426dd.js.map
