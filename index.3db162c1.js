 ...
 */class eK{get vertexBuffer(){return this._vertexBuffer}get attributes(){return this._attributes}constructor(t){this._logger=t7.getInstance(),this._layout=[],this._attributes=[],this._vertexTotalSizeBytes=0;let{gl:e,shader:i,vertexBuffer:s,attributes:r}=t;this._gl=e,this._vertexBuffer=s,this._attributes=r,this._shader=i,i&&this.initialize()}/**
...
this._buffer=new eZ({gl:t,size:40*this._maxImages,type:"dynamic"}),this._layout=new eK({gl:t,shader:this._shader,vertexBuffer:this._buffer,attributes:[["a_position",2],["a_opacity",1],["a_texcoord",2],["a_textureIndex",1],["a_tint",4]]}),// Setup index buffer
...
this._buffer=new eZ({gl:t,size:16,type:"dynamic"}),// Setup a vertex layout/buffer to the material
this._layout=new eK({gl:t,vertexBuffer:this._buffer,attributes:[["a_position",2],["a_uv",2]]}),// Setup index buffer
...
class extends o{constructor(...e){iD(n,t),super(...e)}}}}(g=Z||(Z={})).Arcade="arcade",g.Realistic="realistic",(_=K||(K={}))[_.DynamicAABBTree=0]="DynamicAABBTree",(m=j||(j={}))[m.Euler=0]="Euler";/**
 ...
 *//* istanbul ignore next */class iF{static get gravity(){return iF.acc}static set gravity(t){iF.acc=t}/**
     ...
     */static useArcadePhysics(){iF.collisionResolutionStrategy=Z.Arcade}/**
     * Configures Excalibur to use rigid body physics. Rigid body physics allows for complicated
     * simulated physical interactions.
     */static useRealisticPhysics(){iF.collisionResolutionStrategy=Z.Realistic}static get dynamicTreeVelocityMultiplyer(){return iF.dynamicTreeVelocityMultiplier}static set dynamicTreeVelocityMultiplyer(t){iF.dynamicTreeVelocityMultiplier=t}}/**
 ...
 */iF.broadphaseStrategy=K.DynamicAABBTree,/**
 ...
 * simulated physical interactions.
 */iF.collisionResolutionStrategy=Z.Arcade,/**
 ...
 */class iZ{constructor(t=new ey(-Number.MAX_VALUE,-Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE)){this.worldBounds=t,this.root=null,this.nodes={}}/**
 ...
 */class ij{constructor(){this._dynamicCollisionTree=new iZ,this._pairs=new Set,this._collisionPairCache=[],this._colliders=[]}getColliders(){return this._colliders}rayCast(t,e){var i,s,r;let n=[],o=null!==(i=null==e?void 0:e.maxDistance)&&void 0!==i?i:1/0,a=null!==(s=null==e?void 0:e.collisionGroup)&&void 0!==s?s:i$.All,h=null!==(r=null==e?void 0:e.searchAllColliders)&&void 0!==r&&r;return this._dynamicCollisionTree.rayCastQuery(t,o,e=>{var i;let s=e.owner,r=s.get(st);// Early exit if not the right group
 ...
 */class iY{constructor(){this.id=tA("collider",iY._ID++),/**
     ...
     */touching(t){let e=this.collide(t);return!!e}}iY._ID=0;class iQ extends iY{constructor(t){for(let e of(super(),this._collisionProcessor=new ij,this._dynamicAABBTree=new iZ,this._colliders=[],t))this.addCollider(e)}clearColliders(){this._colliders=[]}addCollider(t){t.events.pipe(this.events),t.__compositeColliderId=this.id,this._colliders.push(t),this._collisionProcessor.track(t),this._dynamicAABBTree.trackCollider(t)}removeCollider(t){t.events.pipe(this.events),t.__compositeColliderId=null,eC(t,this._colliders),this._collisionProcessor.untrack(t),this._dynamicAABBTree.untrackCollider(t)}getColliders(){return this._colliders}get worldPos(){var t,e;// TODO transform component world pos
...
let i=e.worldPos,s=i.sub(t.worldPos),r=s.negate(),n=new iK(t.worldPos,s),o=new iK(i,r),a=t.rayCast(n).add(n.dir.scale(.1)),h=e.rayCast(o).add(o.dir.scale(.1)),l=t.getClosestFace(a),d=e.getClosestFace(h),c=l.face.begin,u=l.face.getEdge(),p=d.face.begin,g=d.face.getEdge();return i0(c,u,p,g)},PolygonEdgeClosestLine(t,e){// Find the 2 closest faces on each polygon
...
let i=e.worldPos,s=i.sub(t.worldPos),r=t.worldPos,n=r.sub(e.worldPos),o=new iK(t.worldPos,s),a=new iK(e.worldPos,n),h=t.rayCast(o),l=e.rayCast(a);return new iJ(h,l)},CircleEdgeClosestLine(t,e){// https://math.stackexchange.com/questions/1919177/how-to-find-point-on-line-closest-to-sphere
 ...
 * @internal
 */class sZ{constructor(t){this.camera=t}/**
     * Creates and adds the [[LockCameraToActorStrategy]] on the current camera.
     * @param actor The actor to lock the camera to
     */lockToActor(t){this.camera.addStrategy(new sK(t))}/**
 ...
 */class sK{constructor(t){this.target=t,this.action=(t,e,i,s)=>{let r=t.center;return r}}}/**
 ...
 *
 */class s1{constructor(){this.events=new tS,this.transform=eP.identity(),this.inverse=eP.identity(),this._cameraStrategies=[],this.strategy=new sZ(this),/**
...
this._lastFrameContacts=new Map(this._currentFrameContacts)}getSolver(){return iF.collisionResolutionStrategy===Z.Realistic?this._realisticSolver:this._arcadeSolver}debug(t){this._processor.debug(t)}runContactStartEnd(){// Composite collider collisions may have a duplicate id because we want to treat those as a singular start/end
for(let[t,e]of this._currentFrameContacts)if(!this._lastFrameContacts.has(t)){let t=e.colliderA,i=e.colliderB;t.events.emit("collisionstart",new tQ(t,i,e)),t.events.emit("contactstart",new tZ(t,i,e)),i.events.emit("collisionstart",new tQ(i,t,e)),i.events.emit("contactstart",new tZ(i,t,e))}// find all contacts that have ceased
for(let[t,e]of this._lastFrameContacts)if(!this._currentFrameContacts.has(t)){let t=e.colliderA,i=e.colliderB;t.events.emit("collisionend",new tJ(t,i)),t.events.emit("contactend",new tK(t,i)),i.events.emit("collisionend",new tJ(i,t)),i.events.emit("contactend",new tK(i,t))}}}/**
 ...
 */class rZ{constructor(){this._handlers={},this._wiredEventDispatchers=[],this._deferedHandlerRemovals=[]}/**
 ...
 */class rK extends sz{get font(){return this._font}set font(t){this._font=t,this._text.font=t}/**
     * The text to draw.
...
})(),o.fWn,o.Ia8;var a=o.rqv;o.hLI,o.yyv,o.tX5;var h=o.vtX;o.r7K,o.lCh,o.cE4;var l=o.fwF;o.sce,o.AQ6;var d=o._c7;o.KUs,o.Ajp,o.dkO,o.RDh;var c=o._H9;o.mxs,o.OmD,o.kBf,o.C4F,o.NQt,o.JjN,o.EK_,o.V1s,o.xHm,o.Xz7,o.Cdc,o.FKn,o.SUY,o.ab2,o.GfZ,o.YMS,o.oyv,o.aUb,o.SdD,o.JUv,o.jEj,o.TFq,o.HDU,o.R_y,o.ydN,o.t50,o.s$$,o.v2G;var u=o.Ilk;o.s9i,o.dxL,o.LLX;var p=o.wA2;o.R_p,o.IQ$,o.I5F,o.X8$,o.FR6,o.U8o;var g=o.kbG;o.iS_,o.cGG,o.RPN,o.skb,o.SLU,o.RdJ,o.cNu,o.gU7,o.LSk,o.Nmp;var _=o.d1Y;o.xrL,o.sRW,o.cmV,o.qWz,o.N0Q;var m=o.q8b;o.ynB,o.jT9;var f=o.wAz,v=o.D4V;o.NLr,o.N6H,o.W1A,o.JHW,o.ZZ$,o.v2K,o.pBf,o.vpe,o.GMl,o.zW2,o.B0K,o.Nv7,o.C_p,o.MUA,o.xqU,o.pTp,o.vUK,o.j9l;var y=o.Zxw;o.v51,o.Hdx;var x=o.Z$d;o.iqV,o.o$7;var w=o.olM;o.Zm$,o.$QH,o.i78,o.nJg,o.h6u,o.hts,o.j88,o.VME,o.fy2,o.nt,o.Ukr,o.zsu,o.oA6,o.TVh,o.TwZ,o.GTT,o.xxj,o.XdK,o.Jmb;var b=o.cXo;o.Dm5,o.IIB,o.ebW,o.zI0,o.LYD,o.cEG,o.SEl,o.t9V,o.ez5,o.N1d;var C=o.R8U;o.SKZ,o.__J,o.RI$,o.x12,o.ccz;var A=o.aNw;o.XrL,o.xwn,o.dNK,o.ini,o.YdH,o.F5T,o.y3G,o.l57,o.xn0,o.t2V,o.uxB,o.cpd,o.fiy,o.$XZ,o.UG6,o.uqK,o.STE,o.y$z,o.mAD,o.sOq,o.hUw;var S=o._0G;o.Sqs,o.hpZ;var T=o.Vol;o.vYX,o.wIZ,o.cBi,o.c30;var E=o.MPV;o.RFv,o.Ux6,o.rxy,o.I$c,o.kfC,o.VjY,o.mgq,o.YVA,o.Kgp,o.HH$,o.M_d,o.rgh,o.Ra6,o.KhR,o.BS5,o.xhz,o.xOq,o.a9j,o.bHk,o.CgK,o.cuY,o.kvE,o.SBu,o.PsT,o.AE_,o.ctO,o.OLH;var P=o.kky;o.nSF,o.zHn,o.zwx,o.AeJ,o.hLz,o.D9g,o.wA,o.jhr,o.GVs,o._zO,o.LXZ,o.w6$,o.mhV,o.MOD,o.kwd,o.Lmr;var M=o.xsS;o.K5l,o.lLr,o.Z$r,o.IXb,o.Xsu,o.SGH,o.SMj,o.L34,o.exe,o.bnF,o.MFA;var I=o.$uU;o.Sap,o.jyi,o.E03;var k=o.V6q;o.rg2,o.DVW,o.nVo,o.F6N,o.xP7,o.Odq,o.Zif,o.ZGJ,o.MJk;var R=o.xvT;o.PHM,o.dpR,o.n9L,o.KwO,o.SxM,o.B7y,o.x7r,o.wx7,o.Uvn,o.OFT,o.xzN,o.CcZ,o.M5Z;var D=o.ZrN,B=o.OWs;o.dF9,o.oZy,o.rD2,o.VHo,o.ohE,o.R$E,o.xQN,o.AdJ,o.q3I,o.Pab;var F=o.uZ5;o.McK,o.F9c,o.k0b,o.hnT,o.RSJ,o.Mku,o.h90,o.rms,o.ErP,o.aVg,o.lPc,o.Z8E,o._N2,o.yFn,o.lNv,o.cu9,o.MZQ,o.FUM,o.BxR;var L=o.vdf,U=o.iaL;o.w6H,o.Q4c,o.Xxe,o.Uxb,o.Yr5;var z=o.Bhw;o.yOA;var H={};H=new URL("title.46943752.png",import.meta.url).toString();var O={};O=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var N={};N=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var W={};W=new URL("slime.e21c5065.png",import.meta.url).toString();var G={};G=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var $={};$=new URL("UISheet.2837e64f.png",import.meta.url).toString();var V={};V=new URL("TerrainSheet.e61d651c.png",import.meta.url).toString();var q={};q=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var X={};X=new URL("RedHighlightSheet.4a69e4d5.png",import.meta.url).toString();var Z={};Z=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var K={};K=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var j={};j=new URL("hit.cc332530.wav",import.meta.url).toString();var Y={};Y=new URL("move.8e8aee5f.wav",import.meta.url).toString();var Q={};Q=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();var J={};J=new URL("targetselect.05425c18.wav",import.meta.url).toString();var tt={};tt=new URL("tutorial-text.d113bd93.png",import.meta.url).toString();var te={};te=new URL("Juhani Junkala [Retro Game Music Pack] Level 3.af273cb2.wav",import.meta.url).toString();var ti={};ti=new URL("gba1complete.c6e75e6f.mp3",import.meta.url).toString();var ts={};ts=new URL("explosion.cd6dbdc9.png",import.meta.url).toString();var tr={};tr=new URL("explosion.fcafad1f.wav",import.meta.url).toString();var tn={};tn=new URL("two_left_socks.7d2f267c.ogg",import.meta.url).toString();const to={TitleImage:new b(/*@__PURE__*/t(H)),KnightSpriteSheet:new b(/*@__PURE__*/t(O)),SpiderSheet:new b(/*@__PURE__*/t(N)),SlimeSheet:new b(/*@__PURE__*/t(W)),HeartSheet:new b(/*@__PURE__*/t(G)),UISheet:new b(/*@__PURE__*/t($)),TerrainSheet:new b(/*@__PURE__*/t(V)),HighlightSheet:new b(/*@__PURE__*/t(q)),RedHighlightSheet:new b(/*@__PURE__*/t(X)),CloudSheet:new b(/*@__PURE__*/t(Z)),SmokeSheet:new b(/*@__PURE__*/t(K)),TutorialText:new b(/*@__PURE__*/t(tt)),ExplosionSheet:new b(/*@__PURE__*/t(ts)),HitSound:new I(/*@__PURE__*/t(j)),MoveSound:new I(/*@__PURE__*/t(Y)),SelectSound:new I(/*@__PURE__*/t(Q)),TargetSelectSound:new I(/*@__PURE__*/t(J)),LevelMusic1:new I(/*@__PURE__*/t(te)),LevelMusic2:new I(/*@__PURE__*/t(ti)),ExplosionSound:new I(/*@__PURE__*/t(tr)),TitleMusic:new I(/*@__PURE__*/t(tn))},ta=k.fromImageSource({image:to.TutorialText,grid:{rows:1,columns:8,spriteWidth:128,spriteHeight:64}}),th=k.fromImageSource({image:to.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),tl=l.fromSpriteSheetCoordinates({spriteSheet:th,frameCoordinates:[{x:1,y:1,duration:200},{x:2,y:1,duration:200},{x:3,y:1,duration:200},{x:3,y:1,duration:200},{x:3,y:1,duration:200},{x:2,y:1,duration:200}]}),td=k.fromImageSource({image:to.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),tc=k.fromImageSource({image:to.RedHighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),tu=l.fromSpriteSheetCoordinates({spriteSheet:td,strategy:d.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),tp=l.fromSpriteSheetCoordinates({spriteSheet:tc,strategy:d.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),tg=k.fromImageSource({image:to.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),t_=l.fromSpriteSheetCoordinates({spriteSheet:tg,strategy:d.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),tm=k.fromImageSource({image:to.SlimeSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),tf=l.fromSpriteSheetCoordinates({spriteSheet:tm,strategy:d.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),tv=k.fromImageSource({image:to.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),ty=l.fromSpriteSheetCoordinates({spriteSheet:tv,strategy:d.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),tx=k.fromImageSource({image:to.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),tw=k.fromImageSource({image:to.ExplosionSheet,grid:{rows:2,columns:5,spriteHeight:32,spriteWidth:32}}),tb=l.fromSpriteSheetCoordinates({spriteSheet:tw,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100},{x:0,y:1,duration:100},{x:1,y:1,duration:100},{x:2,y:1,duration:100}]}),tC=to.SmokeSheet.toSprite(),tA=to.TitleImage.toSprite(),tS=new A;for(let t of Object.values(to))tS.addResource(t);const tT=Date.now();console.log("Random seed:",tT),new P(tT);const tE=z(3,3);z(96,128);const tP={Knight:{graphics:{offset:z(0,12*tE.y),idle:ty},health:5,movement:3,attack:2,range:1},Spider:{graphics:{offset:z(0,8*tE.y),idle:t_},health:3,movement:3,attack:1,range:1},Slime:{graphics:{offset:z(0,8*tE.y),idle:tf},health:2,movement:1,attack:4,range:1}};class tM extends p{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=z(0,0),/**
...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=B.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const tI=tu.clone(),tk=tu.clone(),tR=tp.clone();(e=i||(i={})).Grass="G",e.Water="W",e.Sand="S",e.Stone="T";class tD extends h{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:z(t*(i.tileWidth+i.margin)*tE.x,e*(i.tileHeight+i.margin)*tE.y),anchor:B.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this._terrain="G",this.pathNode=new tM(this.pos),this.addComponent(this.pathNode),this.terrain="G",tI.scale=tE,tI.opacity=.75,tk.scale=tE,tk.opacity=.75,tk.tint=u.Green,tR.scale=tE,tR.opacity=.75,tl.scale=tE,this.graphics.add("range",tI),this.graphics.add("path",tk),this.graphics.add("attack",tR),this.graphics.add("cursor",tl)}get terrain(){return this._terrain}set terrain(t){switch(this._terrain=t,this.terrain){case"G":this.sprite=th.sprites[U(0,1)];break;case"S":this.sprite=th.sprites[U(2,3)];break;case"W":this.sprite=th.sprites[4],this.pathNode.isWalkable=!1;break;case"T":this.sprite=th.sprites[5]}this.sprite.scale=tE,this.graphics.use(this.sprite.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
this.graphics.hide("range"),this.graphics.hide("path"),this.graphics.hide("attack"),t?this.graphics.show(e):this.graphics.hide(e)}toggleCursor(t){t?this.graphics.show("cursor"):this.graphics.hide("cursor")}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     ...
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class tB{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([tM.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i,s){s>=0&&(e.push(t),t.connections.filter(t=>t.isWalkable&&!!(t.walkableMask&i)).forEach(t=>this._getRangeHelper(t,e,i,s-1)))}getRange(t,e,i){let s=[];return this._getRangeHelper(t,s,e,i),s=// dedup results
(s=s.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}/**
     ...
     * @param range 
     * @returns 
     */findPath(t,e,i,s){let r=this.query.getEntities().map(t=>t.get(tM));r.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=B.Down;let n=[t],o=[];for(;n.length>0;){// priority queue, evaluate nodes with the lowest cost
...
return[]}}class tF{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new tD(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tB(i)}getCenter(){return z(this.cols*((this.tileWidth+this.margin)*tE.x),this.rows*((this.tileHeight+this.margin)*tE.y)).scale(.5)}getUnits(){let t=[];for(let e of this.cells)e.unit&&e.unit.active&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor(t.x/*- BOARD_OFFSET.x*//((this.tileWidth+this.margin)*tE.x)),Math.floor(t.y/*- BOARD_OFFSET.y*//((this.tileHeight+this.margin)*tE.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}const tL=new T({emitterType:f.Circle,radius:16,minVel:0,maxVel:20,minAngle:0,maxAngle:6.2,isEmitting:!1,emitRate:8,opacity:.75,fadeFlag:!0,particleLife:1500,maxSize:20,minSize:1,startSize:10,endSize:.01,acceleration:z(0,-32),particleSprite:tC,randomRotation:!0,particleRotationalVelocity:Math.PI});class tU extends h{constructor(t,e){super({name:"damage",pos:t,z:10});let i=new y({family:"notjamslab14",size:16*tE.x,unit:x.Px,color:u.Yellow,baseAlign:c.Top,quality:4,shadow:{offset:z(2,2).scale(tE),color:u.Black}}),s=new R({text:e.toFixed(0),font:i});this.graphics.add(s)}}class tz{constructor(t){this.scene=t}spawnDamageNumber(t,e){let i=new tU(t,e);i.actions.easeBy(z(0,-100),1e3,m.EaseOutCubic).die(),this.scene.add(i)}}class tH{constructor(t){this.scene=t}playExplosion(t){let e=new h({name:"explosion",pos:t.add(z(16,16).scale(tE))});tb.reset(),tb.strategy=d.End,tb.scale=tE;let i=tb.events.on("frame",t=>{7===t.frameIndex&&(e.kill(),i.close())});e.graphics.use(tb),this.scene.add(e)}}class tO extends h{constructor(t,e,i,s,r){super({name:i,anchor:z(0,0),z:2}),this.player=r,this.cell=null,this.moved=!1,this.attacked=!1,this.unitConfig={...tP[i]},this.health=this.unitConfig.health,this.anim=this.unitConfig.graphics.idle.clone(),this.anim.scale=tE,this.graphics.use(this.anim),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onInitialize(t){this.damageManager=new tz(t.currentScene),this.animationManger=new tH(t.currentScene)}onPostUpdate(){this.hasActions()?this.anim.tint=u.White:this.anim.tint=u.Gray,this.health<=0&&(this.cell?.removeUnit(this),this.actions.delay(500).callMethod(()=>{this.animationManger.playExplosion(this.pos),to.ExplosionSound.play()}).callMethod(()=>{this.kill()}))}onPostDraw(t){if(this.health>0){let e=tx.getSprite(F(this.health,0,5),0);e&&(e.scale=tE,e.draw(t,10*tE.x+this.unitConfig.graphics.offset.x,10*tE.y+this.unitConfig.graphics.offset.y))}}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new a(this,t=>{t.delay(200),t.callMethod(()=>{to.MoveSound.play()})}),s=new a(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,m.EaseInOutCubic),t.callMethod(()=>{tL.pos=this.pos.add(tE.scale(16)),tL.emitParticles(5)})}),r=new S([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this),this.moved=!0}reset(){this.moved=!1,this.attacked=!1}canAttack(){return this.getPossibleTargets()?.length!==0&&!this.attacked}canMove(){return!this.moved}hasActions(){return this.canMove()||this.canAttack()}availableActions(){let t=[];return this.canMove()&&t.push("move"),this.canAttack()&&t.push("attack"),t}pass(){this.moved=!0,this.attacked=!0}getPossibleTargets(){if(this.cell){let t=this.cell.board.pathFinder.getRange(this.cell.pathNode,~this.player.mask,this.unitConfig.range),e=t.map(t=>t.owner).filter(t=>!!t.unit?.player&&t.unit.player!==this.player);return e}}async attack(t){t.health-=this.unitConfig.attack,to.HitSound.play(),this.damageManager.spawnDamageNumber(t.pos.add(t.unitConfig.graphics.offset).add(z(16*tE.x,0)),this.unitConfig.attack),await t.actions.blink(200,200,5).toPromise(),this.attacked=!0}}class tN{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=tN._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=tN._CURRENT_GROUP=tN._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}hasLost(){let t=this.board.getUnits().filter(t=>t.player===this);return 0===t.length}async turnEnd(){this.active=!1}}class tW extends tN{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new w,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this)),e.input.keyboard.on("press",this.keyboardDown.bind(this)),document.body.oncontextmenu=()=>!1}keyboardDown(t){if(!this.active)return;this.selectionManager.resetHighlight();let e=this.selectionManager.currentCursor;switch(t.key){case C.ArrowRight:case C.D:this.selectionManager.showCursor(e.x+1,e.y);break;case C.Left:case C.A:this.selectionManager.showCursor(e.x-1,e.y);break;case C.Up:case C.W:this.selectionManager.showCursor(e.x,e.y-1);break;case C.Down:case C.D:this.selectionManager.showCursor(e.x,e.y+1);break;case C.Enter:case C.NumpadEnter:let i=this.board.getCell(e.x,e.y);this.maybeSelectUnit(i)}}async pointerClick(t){if(!this.active)return;this.selectionManager.resetHighlight();let e=this.board.getCellByWorldPos(t.worldPos);if(t.button===E.Left){// a unit is currently selected
...
t?.unit&&this.hasPlayerUnitWithActions(t)?(to.SelectSound.play(),this.uiManger.showUnitMenu(t.unit,{move:()=>{this.selectionManager.selectUnit(t.unit,"move")},attack:()=>{this.selectionManager.selectUnit(t.unit,"attack")},pass:()=>{t.unit?.pass(),this.selectionManager.reset(),this.humanMove.resolve()}})):this.selectionManager.reset()}hasNonPlayerUnit(t){return t&&t.unit&&t.unit.player!==this}hasPlayerUnitWithActions(t){return t?.unit&&t?.unit?.hasActions()&&t.unit.player===this}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new w}hasMoves(){let t=this.board.getUnits().filter(t=>t.player===this).filter(t=>t.hasActions());return t.length>0&&!this.passed}async makeMove(){for(;this.hasMoves();)await this.waitForHumanMove();return!0}lose(){this.active=!1;let t=this.board.getUnits().filter(t=>t.player instanceof tW);t.forEach(t=>{t.health=0,t.cell?.removeUnit(t)}),this.humanMove.resolve()}}class tG{constructor(t){this.board=t,this.currentPlayer=null,this.currentSelectionMode="move",this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.currentCursor={x:0,y:0}}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}showCursor(t,e){let i=this.board.getCell(t,e);i&&(this.board.cells.forEach(t=>t.toggleCursor(!1)),i.toggleCursor(!0),this.currentCursor={x:t,y:e})}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentSelectionMode=e,"move"===e?(this.currentRange=this.findMovementRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range")):(this.currentRange=this.findAttackRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"attack")))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findMovementRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findAttackRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,~t.player.mask,this.currentUnitSelection.unitConfig.range):[]}findMovementRange(t){return(// if (!this.currentUnitSelection) return [];
t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,t.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[])}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}function t$(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tV=globalThis,tq=tV.ShadowRoot&&(void 0===tV.ShadyCSS||tV.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tX=Symbol(),tZ=new WeakMap;class tK{constructor(t,e,i){if(this._$cssResult$=!0,i!==tX)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(tq&&void 0===t){let i=void 0!==e&&1===e.length;i&&(t=tZ.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&tZ.set(e,t))}return t}toString(){return this.cssText}}const tj=t=>new tK("string"==typeof t?t:t+"",void 0,tX),tY=(t,...e)=>{let i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new tK(i,t,tX)},tQ=(t,e)=>{if(tq)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let i of e){let e=document.createElement("style"),s=tV.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}},tJ=tq?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return tj(e)})(t):t,{is:t0,defineProperty:t1,getOwnPropertyDescriptor:t2,getOwnPropertyNames:t5,getOwnPropertySymbols:t4,getPrototypeOf:t3}=Object,t6=globalThis,t9=t6.trustedTypes,t7=t9?t9.emptyScript:"",t8=t6.reactiveElementPolyfillSupport,et=(t,e)=>t,ee={toAttribute(t,e){switch(e){case Boolean:t=t?t7:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},ei=(t,e)=>!t0(t,e),es={attribute:!0,type:String,converter:ee,reflect:!1,hasChanged:ei};Symbol.metadata??=Symbol("metadata"),t6.litPropertyMetadata??=new WeakMap;class er extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=es){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&t1(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=t2(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get(){return s?.call(this)},set(e){let n=s?.call(this);r.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??es}static _$Ei(){if(this.hasOwnProperty(et("elementProperties")))return;let t=t3(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(et("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(et("properties"))){let t=this.properties,e=[...t5(t),...t4(t)];for(let i of e)this.createProperty(i,t[i])}let t=this[Symbol.metadata];if(null!==t){let e=litPropertyMetadata.get(t);if(void 0!==e)for(let[t,i]of e)this.elementProperties.set(t,i)}for(let[t,e]of(this._$Eh=new Map,this.elementProperties)){let i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let t of i)e.unshift(tJ(t))}else void 0!==t&&e.push(tJ(t));return e}static _$Eu(t,e){let i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$E_??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$E_?.delete(t)}_$ES(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return tQ(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$E_?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EO(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){let r=(void 0!==i.converter?.toAttribute?i.converter:ee).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){let t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:ee;this._$Em=s,this[s]=r.fromAttribute(e,t.type),this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){if(!((i??=this.constructor.getPropertyOptions(t)).hasChanged??ei)(s?r:this[t],e))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(t){Promise.reject(t)}let t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[e,i]of t)!0!==i.wrapped||this._$AL.has(e)||void 0===this[e]||this.C(e,this[e],i)}let t=!1,e=this._$AL;try{(t=this.shouldUpdate(e))?(this.willUpdate(e),this._$E_?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$ET()}catch(e){throw t=!1,this._$ET(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$E_?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach(t=>this._$EO(t,this[t])),this._$ET()}updated(t){}firstUpdated(t){}}er.elementStyles=[],er.shadowRootOptions={mode:"open"},er[et("elementProperties")]=new Map,er[et("finalized")]=new Map,t8?.({ReactiveElement:er}),(t6.reactiveElementVersions??=[]).push("2.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const en=globalThis,eo=en.trustedTypes,ea=eo?eo.createPolicy("lit-html",{createHTML:t=>t}):void 0,eh="$lit$",el=`lit$${(Math.random()+"").slice(9)}$`,ed="?"+el,ec=`<${ed}>`,eu=document,ep=()=>eu.createComment(""),eg=t=>null===t||"object"!=typeof t&&"function"!=typeof t,e_=Array.isArray,em=t=>e_(t)||"function"==typeof t?.[Symbol.iterator],ef="[ 	\n\f\r]",ev=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ey=/-->/g,ex=/>/g,ew=RegExp(`>|${ef}(?:([^\\s"'>=/]+)(${ef}*=${ef}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),eb=/'/g,eC=/"/g,eA=/^(?:script|style|textarea|title)$/i,eS=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),eT=eS(1),eE=(eS(2),Symbol.for("lit-noChange")),eP=Symbol.for("lit-nothing"),eM=new WeakMap,eI=eu.createTreeWalker(eu,129);function ek(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==ea?ea.createHTML(e):e}const eR=(t,e)=>{let i=t.length-1,s=[],r,n=2===e?"<svg>":"",o=ev;for(let e=0;e<i;e++){let i=t[e],a,h,l=-1,d=0;for(;d<i.length&&(o.lastIndex=d,null!==(h=o.exec(i)));)d=o.lastIndex,o===ev?"!--"===h[1]?o=ey:void 0!==h[1]?o=ex:void 0!==h[2]?(eA.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=ew):void 0!==h[3]&&(o=ew):o===ew?">"===h[0]?(o=r??ev,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,a=h[1],o=void 0===h[3]?ew:'"'===h[3]?eC:eb):o===eC||o===eb?o=ew:o===ey||o===ex?o=ev:(o=ew,r=void 0);let c=o===ew&&t[e+1].startsWith("/>")?" ":"";n+=o===ev?i+ec:l>=0?(s.push(a),i.slice(0,l)+eh+i.slice(l)+el+c):i+el+(-2===l?e:c)}return[ek(t,n+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class eD{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,a=this.parts,[h,l]=eR(t,e);if(this.el=eD.createElement(h,i),eI.currentNode=this.el.content,2===e){let t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=eI.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(let t of s.getAttributeNames())if(t.endsWith(eh)){let e=l[n++],i=s.getAttribute(t).split(el),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?ez:"?"===o[1]?eH:"@"===o[1]?eO:eU}),s.removeAttribute(t)}else t.startsWith(el)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(eA.test(s.tagName)){let t=s.textContent.split(el),e=t.length-1;if(e>0){s.textContent=eo?eo.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],ep()),eI.nextNode(),a.push({type:2,index:++r});s.append(t[e],ep())}}}else if(8===s.nodeType){if(s.data===ed)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(el,t+1));)a.push({type:7,index:r}),t+=el.length-1}}r++}}static createElement(t,e){let i=eu.createElement("template");return i.innerHTML=t,i}}function eB(t,e,i=t,s){if(e===eE)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl,n=eg(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t))._$AT(t,i,s),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=eB(t,r._$AS(t,e.values),r,s)),e}class eF{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??eu).importNode(e,!0);eI.currentNode=s;let r=eI.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new eL(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new eN(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=eI.nextNode(),n++)}return eI.currentNode=eu,s}p(t){let e=0;for(let i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class eL{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=eP,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){eg(t=eB(this,t,e))?t===eP||null==t||""===t?(this._$AH!==eP&&this._$AR(),this._$AH=eP):t!==this._$AH&&t!==eE&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):em(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==eP&&eg(this._$AH)?this._$AA.nextSibling.data=t:this.$(eu.createTextNode(t)),this._$AH=t}g(t){let{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=eD.createElement(ek(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let t=new eF(s,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=eM.get(t.strings);return void 0===e&&eM.set(t.strings,e=new eD(t)),e}T(t){e_(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new eL(this.k(ep()),this.k(ep()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class eU{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=eP,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=eP}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(void 0===r)(n=!eg(t=eB(this,t,e,0))||t!==this._$AH&&t!==eE)&&(this._$AH=t);else{let s,o;let a=t;for(t=r[0],s=0;s<r.length-1;s++)(o=eB(this,a[i+s],e,s))===eE&&(o=this._$AH[s]),n||=!eg(o)||o!==this._$AH[s],o===eP?t=eP:t!==eP&&(t+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!s&&this.O(t)}O(t){t===eP?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class ez extends eU{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===eP?void 0:t}}class eH extends eU{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==eP)}}class eO extends eU{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=eB(this,t,e,0)??eP)===eE)return;let i=this._$AH,s=t===eP&&i!==eP||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==eP&&(i===eP||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class eN{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){eB(this,t)}}const eW=en.litHtmlPolyfillSupport;eW?.(eD,eL),(en.litHtmlVersions??=[]).push("3.1.0");const eG=(t,e,i)=>{let s=i?.renderBefore??e,r=s._$litPart$;if(void 0===r){let t=i?.renderBefore??null;s._$litPart$=r=new eL(e.insertBefore(ep(),t),t,void 0,i??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class e$ extends er{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=eG(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return eE}}e$._$litElement$=!0,e$.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:e$});const eV=globalThis.litElementPolyfillSupport;eV?.({LitElement:e$}),(globalThis.litElementVersions??=[]).push("4.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eq=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},eX={attribute:!0,type:String,converter:ee,reflect:!1,hasChanged:ei},eZ=(t=eX,e,i)=>{let{kind:s,metadata:r}=i,n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(i.name,t),"accessor"===s){let{name:s}=i;return{set(i){let r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t),e}}}if("setter"===s){let{name:s}=i;return function(i){let r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};function eK(t){return(e,i)=>"object"==typeof i?eZ(t,e,i):((t,e,i)=>{let s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ej=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i),eY={ATTRIBUTE:1},eQ=t=>(...e)=>({_$litDirective$:t,values:e});class eJ{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e0="important",e1=" !"+e0,e2=eQ(class extends eJ{constructor(t){if(super(t),t.type!==eY.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(e1);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?e0:""):i[t]=s}}return eE}}),e5=eQ(class extends eJ{constructor(t){if(super(t),t.type!==eY.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return eE}});let e4=class extends e${static #t=this.styles=tY`
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),this.clearEvents())}render(){let t=this._show?eT`<div class="overlay" @click=${this.hide}></div>`:eP;return eT`
        ${t}
        <div class=${e5({menu:!0,show:this._show})} style=${e2({left:`${this.left}px`,top:`${this.top}px`})}>
            <div class="title-bar"></div>
            <div class="options">
                <button style=${e2({display:this.unit?.canMove()?"block":"none"})} @click="${this.sendEvent("move")}">Move</button>
                <button style=${e2({display:this.unit?.canAttack()?"block":"none"})} @click="${this.sendEvent("attack")}">Attack</button>
...
await this.maybeAttack(e,s)}this.selectionManger.reset()}}return!0}lose(){this.active=!1;let t=this.board.getUnits().filter(t=>t.player instanceof e6);t.forEach(t=>{t.health=0,t.cell?.removeUnit(t)})}}class e9{constructor(t,e,i,s,r){if(this.engine=t,this.level=e,this.players=i,this.maxTurns=r,this.currentTurn=1,this.currentPlayerIndex=0,this.topScreen=z(400,-2e3),this.centerScreen=z(400,400),this.bottomScreen=z(400,2e3),0===i.length)throw Error("Players should be non-zero in length");this.currentPlayer=i[this.currentPlayerIndex],this.selectionManager=s,this.turnText=new R({text:`Turn ${this.currentTurn}`,font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})});let n=t.screen.resolution.width;this.turnActor=new h({name:"turn text",pos:this.topScreen,coordPlane:g.Screen,color:new u(240,50,50,.4),width:n,height:100,z:10}),this.turnActor.graphics.opacity=0,this.turnActor.graphics.add("text",this.turnText),this.turnActor.graphics.show("text"),t.add(this.turnActor);let o=new R({text:"Victory!",font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})});this.victory=new h({name:"victory text",pos:this.topScreen,coordPlane:g.Screen,color:new u(50,240,50,.4),width:n,height:100,z:10}),this.victory.graphics.opacity=0,this.victory.graphics.add("text",o),this.victory.graphics.show("text"),t.add(this.victory);let a=new R({text:"Click to proceed!",font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})});this.victoryDirections=new h({name:"directions",pos:this.topScreen,coordPlane:g.Screen,color:new u(50,240,50,.4),width:n,height:100,z:10}),this.victoryDirections.graphics.opacity=0,this.victoryDirections.graphics.add("text",a),this.victoryDirections.graphics.show("text"),t.add(this.victoryDirections);let l=new R({text:"Failure!",font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})}),d=new R({text:"Click to try again!",font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})});this.failure=new h({name:"failure text",pos:this.topScreen,coordPlane:g.Screen,color:new u(240,50,50,.4),width:n,height:250,z:10}),this.failure.graphics.opacity=0,this.failure.graphics.add("text1",l),this.failure.graphics.add("text2",d),this.failure.graphics.show("text1",{offset:z(0,-50)}),this.failure.graphics.show("text2",{offset:z(0,50)}),t.add(this.failure)}async showTurnDisplay(){0===this.currentPlayerIndex&&(this.turnText.text=`Turn ${this.currentTurn}`,await this.turnActor.actions.runAction(new S([new a(this.turnActor,t=>t.easeTo(this.centerScreen,1200,m.EaseInOutCubic).delay(700).easeTo(this.bottomScreen,1200,m.EaseInOutCubic)),new a(this.turnActor,t=>t.fade(1,1200).delay(700).fade(0,1200))])).toPromise(),this.turnActor.pos=this.topScreen)}async showGameOver(){await this.failure.actions.runAction(new S([new a(this.failure,t=>t.easeTo(this.centerScreen,1200,m.EaseInOutCubic)),new a(this.failure,t=>t.fade(1,1200))])).toPromise()}async showVictory(){await this.victory.actions.runAction(new S([new a(this.victory,t=>t.easeTo(this.centerScreen,1200,m.EaseInOutCubic)),new a(this.victory,t=>t.fade(1,1200))])).toPromise(),await this.victoryDirections.actions.runAction(new S([new a(this.victoryDirections,t=>t.easeTo(this.centerScreen.add(z(0,150)),1200,m.EaseInOutCubic)),new a(this.victoryDirections,t=>t.fade(1,1200))])).toPromise()}async start(){// TODO win condition
for(;this.maxTurns>0;){if(console.log("Current player turn:",this.currentPlayer.name),this.currentPlayer.hasLost()){if(console.log("Player lost!",this.currentPlayer.name),this.currentPlayer instanceof tW){await this.showGameOver(),this.engine.input.pointers.once("down",()=>{to.LevelMusic2.stop(),this.engine.goToScene(this.level.levelData.name)});return}if(this.currentPlayer instanceof e6){await this.showVictory(),this.engine.input.pointers.once("down",()=>{setTimeout(()=>{this.engine.goToScene(this.level.levelData.nextLevel)})});return}}this.selectionManager.selectPlayer(this.currentPlayer),this.showTurnDisplay(),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayerIndex=this.currentPlayerIndex%this.players.length,this.currentPlayer=this.players[this.currentPlayerIndex],0===this.currentPlayerIndex&&this.currentTurn++}}class e7 extends h{constructor(t){super({name:"cloud",pos:t,vel:z(L(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=to.CloudSheet.toSprite(),this.cloudSprite.scale=tE,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}const e8={K:"Knight",S:"Spider",M:"Slime"};class it extends M{constructor(t,e){super(),this.levelData=t,this.name=e,this._subscriptions=[]}onInitialize(t){this.engine=t}resetAndLoad(){let t=this.entities;for(let e=t.length-1;e>=0;e--)this.world.remove(t[e],!1);to.LevelMusic2.stop(),this.add(new e7(z(800,0))),this.add(new e7(z(400,300))),this.add(new e7(z(700,700))),this.board=this.parse(this.levelData),this.add(tL),this.camera.pos=this.board.getCenter()}onActivate(){this.resetAndLoad(),this.turnManager.start(),to.LevelMusic2.loop=!0,to.LevelMusic2.play(),this._subscriptions.push(this.engine.input.keyboard.once("press",t=>{t.key===C.W&&this.players[1].lose(),t.key===C.L&&this.players[0].lose()}))}onDeactivate(){to.LevelMusic2.instances.forEach(t=>t.stop()),to.LevelMusic2.stop(),this._subscriptions.forEach(t=>t.close())}parse(t){let e=new tF(t.height,t.width,this);this.selectionManager=new tG(e),this.selectionManager.showCursor(0,0),this.uiManager=new e3(this.engine),// TODO support arbitrary players
this.players=[new tW(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new e6(t.players[1],this.selectionManager,e)],this.turnManager=new e9(this.engine,this,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t=e8[r.charAt(1)],n=+r.charAt(2)-1;o=new tO(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}const ie={name:"tutorial",displayName:"Gentle Plains",nextLevel:"level1",width:6,height:3,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G"]};class ii{static #t=this.levels=new Map([[to.HitSound,1],[to.MoveSound,1],[to.SelectSound,1],[to.TargetSelectSound,1],[to.LevelMusic1,.05],[to.LevelMusic2,.05],[to.ExplosionSound,1],[to.TitleMusic,.05]]);static init(){for(let t of Object.values(to))t instanceof I&&(t.volume=ii.levels.get(t)??1)}static toggleMute(t){for(let e of Object.values(to))e instanceof I&&(e.volume=t?0:ii.levels.get(e)??1)}}let is=class extends e${static #t=this.styles=tY`
        :host {
            position: absolute;
            left: 0;
            bottom: 0;
    ...
    `;toggleSound(){this.soundOn=!this.soundOn,ii.toggleMute(!this.soundOn)}render(){// material symbols
...
return this.soundOn?eT`<button @click=${this.toggleSound} class="material-symbols-outlined">volume_up</button>`:eT`<button @click=${this.toggleSound} class="material-symbols-outlined">volume_off</button>`}constructor(...t){super(...t),this.soundOn=!0}};t$([eK()],is.prototype,"soundOn",void 0),is=t$([eq("audio-menu")],is);const ir=new v({width:800,height:800,displayMode:_.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}});ii.init();const io=new class extends M{onInitialize(t){this.engine=t,this.add(new e7(z(800,0))),this.add(new e7(z(400,300))),this.add(new e7(z(700,700))),this.title=new h({name:"title",pos:z(400,400),coordPlane:g.Screen}),this.title.scale=tE,this.title.graphics.use(tA),this.title.actions.repeatForever(t=>{t.easeBy(z(0,-30*tE.y),1e3,m.EaseInOutQuad).easeBy(z(0,30*tE.y),1e3,m.EaseInOutQuad)}),this.add(this.title),this.instructions=new h({name:"instructions",pos:z(400,600),coordPlane:g.Screen});let e=new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4,shadow:{offset:z(10,10).scale(tE),color:u.Black}}),i=new R({text:"Click to Play!",font:e});this.instructions.graphics.use(i),this.instructions.actions.repeatForever(t=>{t.rotateTo(Math.PI/32,.2),t.rotateTo(-Math.PI/32,.2)}),this.add(this.instructions)}onActivate(){console.log("activate start screen"),to.TitleMusic.loop=!0,to.TitleMusic.play(),this._subscriptions.push(this.engine.input.pointers.primary.once("down",()=>{this.engine.goToScene("tutorial")})),this._subscriptions.push(this.engine.input.keyboard.once("press",()=>{this.engine.goToScene("tutorial")}))}onDeactivate(){to.TitleMusic.stop(),this._subscriptions.forEach(t=>t.close())}constructor(...t){super(...t),this._subscriptions=[]}};ir.addScene("start",io);const ia=new class extends it{constructor(){super(ie,"tutorial"),this.bottomScreen=z(400,2e3),this.centerScreen=z(400,700),this._subs=[]}onInitialize(t){super.onInitialize(t),this.resetAndLoad();let e=this.board.cells[0].unit;e&&(this.focus=new h({name:"focus",pos:e.pos.add(z(16,16).scale(tE)),width:32,height:32,anchor:z(0,1),z:10}),this.focus.graphics.opacity=0,this.engine.add(this.focus));let i=t.screen.resolution.width,s=new R({text:"S or Tap to Skip!",font:new y({family:"notjamslab14",size:32*tE.x,unit:x.Px,color:u.White,baseAlign:c.Top,quality:4})});this.tutorialDirections=new h({name:"directions",pos:this.bottomScreen,coordPlane:g.Screen,color:new u(50,240,50,.4),width:i,height:100,z:10}),this.tutorialDirections.graphics.opacity=0,this.tutorialDirections.graphics.add("text",s),this.tutorialDirections.graphics.show("text"),t.add(this.tutorialDirections)}async showSkip(){await this.tutorialDirections.actions.runAction(new S([new a(this.tutorialDirections,t=>t.easeTo(this.centerScreen,1200,m.EaseInOutCubic)),new a(this.tutorialDirections,t=>t.fade(1,1200))])).toPromise()}async moveToUnit1(){let t=this.board.getCell(0,0).unit.pos.add(z(16,16).scale(tE));await this.focus.actions.easeTo(t,1e3,m.EaseInOutCubic).toPromise()}async selectUnit1(){this.selectionManager.selectPlayer(this.players[0]);let t=this.board.getCell(0,0).unit,e=this.uiManager.showUnitMenu(t,{move:()=>{},attack:()=>{},pass:()=>{}});await D.delay(1e3),e.hide(),this.selectionManager.selectUnit(t,"move");let i=this.selectionManager.findMovementRange(t),s=this.board.getCell(2,0),r=this.selectionManager.findPath(s,i);this.selectionManager.showHighlight(r,"path"),await D.delay(1e3),await this.selectionManager.selectDestinationAndMove(t,s),e.show(),await D.delay(2e3),this.selectionManager.selectUnit(t,"attack");let n=this.selectionManager.findAttackRange(t);this.selectionManager.showHighlight(n,"attack"),await D.delay(1e3);let o=this.board.getCell(2,1);this.selectionManager.showHighlight([o.pathNode],"path"),e.hide(),this.selectionManager.reset();let a=this.board.getCell(2,1).unit;t.attack(a),await D.delay(2e3)}async highlightEnemyRange(){let t=this.players[0],e=this.board.getCell(2,1);await t.highlightUnitRange(e),await D.delay(1e3),this.selectionManager.reset()}async moveToUnit2(){let t=this.board.getCell(0,1).unit.pos.add(z(16,16).scale(tE));await this.focus.actions.easeTo(t,1e3,m.EaseInOutCubic).toPromise()}async showText(t){let e=ta.getSprite(t,0);e.scale=tE,this.focus.graphics.use(e),await this.focus.actions.fade(1,200).toPromise()}async hideText(){await this.focus.actions.fade(0,200).toPromise()}async onActivate(){this.showSkip(),console.log("activate tutorial"),this._subs.push(this.engine.input.keyboard.on("press",t=>{t.key===C.S&&this.engine.goToScene("level1")})),this._subs.push(this.engine.input.pointers.primary.on("down",t=>{this.engine.goToScene("level1")})),to.LevelMusic2.loop=!0,to.LevelMusic2.play(),this.camera.strategy.lockToActor(this.focus),this.camera.zoomOverTime(1.25,1e3,m.EaseInOutCubic),this.selectionManager.showCursor(0,0),await D.delay(1e3),// hey look at all these spiders!
...
await this.moveToUnit2(),await this.showText(5),await this.focus.actions.delay(1e3),await this.hideText(),await this.highlightEnemyRange(),await this.showText(6),await this.focus.actions.delay(2e3),await this.hideText(),await this.showText(7),await this.focus.actions.delay(3e3),await this.hideText(),this.camera.zoomOverTime(1,1e3,m.EaseInOutCubic),this.engine.goToScene("level1")}onDeactivate(){to.LevelMusic2.stop(),this._subs.forEach(t=>t.close())}};ir.addScene(ia.name,ia);const ih=new it({displayName:"Gentle Plains",name:"level1",nextLevel:"level2",width:6,height:3,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G"]},"level1");ir.addScene(ih.name,ih);const il=new it({displayName:"Gentle Plains 2",name:"level2",nextLevel:"start",width:6,height:6,maxTurns:100,players:["human","computer"],data:["GK1","G","GM2","G","G","GS2","GK1","G","G","G","G","GS2","GK1","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","GM2","GM2","W","W","GS2","GS2"]},"level2");ir.addScene(il.name,il),ir.start(tS).then(()=>{ir.goToScene("start")});//# sourceMappingURL=index.3db162c1.js.map

//# sourceMappingURL=index.3db162c1.js.map
