...
})(),r.fWn,r.Ia8,r.rqv,r.hLI,r.yyv,r.tX5;var n=r.vtX;r.r7K,r.lCh,r.cE4;var o=r.fwF;r.sce,r.AQ6;var a=r._c7;r.KUs,r.Ajp,r.dkO,r.RDh,r._H9,r.mxs,r.OmD,r.kBf,r.C4F,r.NQt,r.JjN,r.EK_,r.V1s,r.xHm,r.Xz7,r.Cdc,r.FKn,r.SUY,r.ab2,r.GfZ,r.YMS,r.oyv,r.aUb,r.SdD,r.JUv,r.jEj,r.TFq,r.HDU,r.R_y,r.ydN,r.t50,r.s$$,r.v2G;var h=r.Ilk;r.s9i,r.dxL,r.LLX;var l=r.wA2;r.R_p,r.IQ$,r.I5F,r.X8$,r.FR6,r.U8o;var d=r.kbG;r.iS_,r.cGG,r.RPN,r.skb,r.SLU,r.RdJ,r.cNu,r.gU7,r.LSk,r.Nmp;var c=r.d1Y;r.xrL,r.sRW,r.cmV,r.qWz,r.N0Q;var u=r.q8b;r.ynB,r.jT9,r.wAz;var p=r.D4V;r.NLr,r.N6H,r.W1A,r.JHW,r.ZZ$,r.v2K,r.pBf,r.vpe,r.GMl,r.zW2,r.B0K,r.Nv7,r.C_p,r.MUA,r.xqU,r.pTp,r.vUK,r.j9l,r.Zxw,r.v51,r.Hdx,r.Z$d,r.iqV,r.o$7,r.olM,r.Zm$,r.$QH,r.i78,r.nJg,r.h6u,r.hts,r.j88,r.VME,r.fy2,r.nt,r.Ukr,r.zsu,r.oA6,r.TVh,r.TwZ,r.GTT,r.xxj,r.XdK,r.Jmb;var _=r.cXo;r.Dm5,r.IIB,r.ebW,r.zI0,r.LYD,r.cEG,r.SEl,r.t9V,r.ez5,r.N1d,r.R8U,r.SKZ,r.__J,r.RI$,r.x12,r.ccz;var g=r.aNw;r.XrL,r.xwn,r.dNK,r.ini,r.YdH,r.F5T,r.y3G,r.l57,r.xn0,r.t2V,r.uxB,r.cpd,r.fiy,r.$XZ,r.UG6,r.uqK,r.STE,r.y$z,r.mAD,r.sOq,r.hUw,r._0G,r.Sqs,r.hpZ,r.Vol,r.vYX,r.wIZ,r.cBi,r.c30,r.MPV,r.RFv,r.Ux6,r.rxy,r.I$c,r.kfC,r.VjY,r.mgq,r.YVA,r.Kgp,r.HH$,r.M_d,r.rgh,r.Ra6,r.KhR,r.BS5,r.xhz,r.xOq,r.a9j,r.bHk,r.CgK,r.cuY,r.kvE,r.SBu,r.AE_,r.ctO,r.OLH,r.kky,r.nSF,r.zHn,r.zwx,r.AeJ,r.hLz,r.D9g,r.wA,r.jhr,r.GVs,r._zO,r.LXZ,r.w6$,r.mhV,r.MOD,r.kwd,r.Lmr,r.xsS,r.K5l,r.lLr,r.Z$r,r.IXb,r.SGH,r.SMj,r.L34,r.exe,r.bnF,r.MFA;var m=r.$uU;r.Sap,r.jyi,r.E03;var f=r.V6q;r.rg2,r.DVW,r.nVo,r.F6N,r.xP7,r.Odq,r.Zif,r.ZGJ,r.MJk,r.xvT,r.PHM,r.dpR,r.n9L,r.KwO,r.SxM,r.B7y,r.x7r,r.wx7,r.Uvn,r.OFT,r.xzN,r.CcZ,r.M5Z,r.ZrN;var v=r.OWs;r.dF9,r.oZy,r.rD2,r.VHo,r.ohE,r.R$E,r.xQN,r.AdJ,r.q3I,r.Pab;var x=r.uZ5;r.McK,r.F9c,r.k0b,r.hnT,r.RSJ,r.Mku,r.h90,r.rms,r.ErP,r.aVg,r.lPc,r.Z8E,r._N2,r.yFn,r.lNv,r.cu9,r.MZQ,r.FUM,r.BxR;var y=r.vdf,w=r.iaL;r.w6H,r.Q4c,r.Xxe,r.Uxb,r.Yr5;var b=r.Bhw;r.yOA;var C={};C=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var A={};A=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var S={};S=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var T={};T=new URL("UISheet.2837e64f.png",import.meta.url).toString();var E={};E=new URL("TerrainSheet.720a833c.png",import.meta.url).toString();var P={};P=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var I={};I=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var F={};F=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var B={};B=new URL("hit.cc332530.wav",import.meta.url).toString();var D={};D=new URL("move.8e8aee5f.wav",import.meta.url).toString();var R={};R=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();const k={KnightSpriteSheet:new _(/*@__PURE__*/t(C)),SpiderSheet:new _(/*@__PURE__*/t(A)),HeartSheet:new _(/*@__PURE__*/t(S)),UISheet:new _(/*@__PURE__*/t(T)),TerrainSheet:new _(/*@__PURE__*/t(E)),HighlightSheet:new _(/*@__PURE__*/t(P)),CloudSheet:new _(/*@__PURE__*/t(I)),Smoke:new _(/*@__PURE__*/t(F)),HitSound:new m(/*@__PURE__*/t(B)),MoveSound:new m(/*@__PURE__*/t(D)),SelectSound:new m(/*@__PURE__*/t(R))},M=f.fromImageSource({image:k.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),L=f.fromImageSource({image:k.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),z=o.fromSpriteSheetCoordinates({spriteSheet:L,strategy:a.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),U=f.fromImageSource({image:k.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),O=o.fromSpriteSheetCoordinates({spriteSheet:U,strategy:a.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),H=f.fromImageSource({image:k.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),N=o.fromSpriteSheetCoordinates({spriteSheet:H,strategy:a.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),W=f.fromImageSource({image:k.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),G=new g;for(let t of Object.values(k))G.addResource(t);const V=b(3,3),q=b(96,128),X={Knight:{graphics:{offset:b(0,12*V.y),idle:N},health:5,range:4,attack:2},Spider:{graphics:{offset:b(0,8*V.y),idle:O},health:3,range:3,attack:1}};class Z extends n{constructor(t){super({pos:t,coordPlane:d.Screen,vel:b(y(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=k.CloudSheet.toSprite(),this.cloudSprite.scale=V,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class K extends l{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=b(0,0),this.gScore=1/0,this.hScore=1/0,this.weight=1,this.isWalkable=!0,this.direction=v.Zero,this.connections=[],this.previousNode=null,this.pos=t}}class Y extends n{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:b(t*(i.tileWidth+i.margin)*V.x,e*(i.tileHeight+i.margin)*V.y).add(q),anchor:v.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this.pathNode=new K(this.pos),this.addComponent(this.pathNode),this.sprite=M.sprites[w(0,5)],this.sprite.scale=V,this.graphics.use(this.sprite.clone()),z.scale=V,this.graphics.add("range",z.clone()),this.graphics.add("path",z.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.isWalkable=!1}toggleHighlight(t,e,i){if(i&&t){let t=this.graphics.getGraphic(e);t&&(t.tint=i)}t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     * Returns the orthogonal neighbors (up, down, left, right)
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class ${constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([K.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i){i>=0&&(e.push(t),t.connections.forEach(t=>{this._getRangeHelper(t,e,i-1)}))}getRange(t,e){let i=[];return this._getRangeHelper(t,i,e),// dedup results
i=i.filter((t,e,i)=>i.indexOf(t)===e)}findPath(t,e){let i=this.query.getEntities().map(t=>t.get(K));i.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=v.Down;let s=[t],r=[];for(;s.length>0;){// priority queue, evaluate nodes with the lowest cost
...
return[]}}class j extends n{constructor(t,e,i,s){super({anchor:b(0,0)}),this.cell=null,this.unitConfig={...X[i]};let r=this.unitConfig.graphics.idle;r.scale=V,this.graphics.use(r),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onPostDraw(t){let e=W.getSprite(x(this.unitConfig.health,0,5),0);e&&(e.scale=V,e.draw(t,10*V.x,16*V.y))}async move(t){this.cell&&(this.cell.unit=null,this.cell.pathNode.isWalkable=!0);let e=null;for(let i of t)e=i.owner,await this.actions.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,u.EaseInOutCubic).toPromise();e&&(e.addUnit(this),this.cell=e)}}const Q=new p({width:800,height:800,displayMode:c.FitScreenAndFill});// TODO move to level
// Add clouds :3
Q.add(new Z(b(800,0))),Q.add(new Z(b(400,300))),Q.add(new Z(b(700,700)));const J=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new Y(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new $(i)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-q.x)/((this.tileWidth+this.margin)*V.x)),Math.floor((t.y-q.y)/((this.tileHeight+this.margin)*V.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,Q.currentScene);new class{constructor(t,e){this.engine=t,this.board=e,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.active=!0,t.input.pointers.on("down",this.pointerclick.bind(this)),t.input.pointers.on("move",this.pointermove.bind(this))}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}pointerclick(t){if(this.active){if(this.currentUnitSelection)0===this.currentPath.length&&this.showAndFindPath(t.worldPos),this.currentPath.length>1&&(this.currentUnitSelection.move(this.currentPath).then(()=>{this.reset()}),this.resetHighlight(),this.currentUnitSelection=null),this.reset();else{// no unit selected
...
let t=this.board.pathFinder.findPath(e,i?.pathNode);t.forEach(t=>{let e=t.owner;e.toggleHighlight(!0,"path",h.Green)}),this.currentPath=t}}pointermove(t){this.active&&this.currentUnitSelection&&(this.resetHighlight(),this.showAndFindRange(this.currentUnitSelection),this.showAndFindPath(t.worldPos))}}(Q,J),new $(Q.currentScene);const tt=new j(0,0,"Spider",J);Q.add(tt);const te=new j(4,5,"Spider",J);Q.add(te);const ti=new j(1,1,"Knight",J);Q.add(ti),Q.onInitialize=()=>{// const cell = board.getCell(2, 2);
...
//     }
// })
},Q.start(G).then(()=>{});//# sourceMappingURL=index.e05b4d08.js.map

//# sourceMappingURL=index.e05b4d08.js.map
