...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],x=this._context.getTransform(),y=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=x.multiply(b),C=x.multiply(C),A=x.multiply(A),S=x.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let T=this._context.tint,E=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,B=e/P,F=i/I,D=(e+f-.01)/P,R=(i+v-.01)/I,k=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
k[this._vertexIndex++]=b.x,k[this._vertexIndex++]=b.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=B,k[this._vertexIndex++]=F,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (0, 1) - 1
k[this._vertexIndex++]=A.x,k[this._vertexIndex++]=A.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=B,k[this._vertexIndex++]=R,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (1, 0) - 2
k[this._vertexIndex++]=C.x,k[this._vertexIndex++]=C.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=D,k[this._vertexIndex++]=F,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (1, 1) - 3
...
for(let t in this._warningTest)this._warningTest[t]()||t7.getInstance().warn("Warning browser feature missing, Excalibur will have reduced performance:",t);return!0}}/**
     ...
     * collision events.
     */p.Fixed="Fixed";let iI=5,iB={},iF=()=>{for(let t in iB)iB[t]=0},iD=(t,e)=>{let i=tC.isEnabled("suppress-obsolete-message");iB[t]<iI&&!i&&(t7.getInstance().warn(t),console.trace&&e.showStackTrace&&console.trace()),iB[t]++};/**
...
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new $(i)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-q.x)/((this.tileWidth+this.margin)*V.x)),Math.floor((t.y-q.y)/((this.tileHeight+this.margin)*V.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,Q.currentScene);new class{constructor(t,e){this.engine=t,this.board=e,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.active=!0,t.input.pointers.on("down",this.pointerclick.bind(this)),t.input.pointers.on("move",this.pointermove.bind(this))}pointerclick(t){if(this.active){if(this.currentUnitSelection)this.currentUnitSelection.move(this.currentPath),this.resetHighlight(),this.currentUnitSelection=null;else{let e=this.board.getCellByWorldPos(t.worldPos);e?.unit&&(this.currentUnitSelection=e.unit,// TODO unit controlled?
this.showRange(this.currentUnitSelection))}}}showRange(t){if(!this.currentUnitSelection||!t.cell)return;let e=this.board.pathFinder.getRange(t.cell.pathNode,this.currentUnitSelection.unitConfig.range);e.forEach(t=>{let e=t.owner;e.toggleHighlight(!0,"range")}),this.currentRange=e}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path")})}pointermove(t){if(!this.active||!this.currentUnitSelection)return;let e=this.currentUnitSelection.cell?.pathNode,i=this.board.getCellByWorldPos(t.worldPos);if(this.resetHighlight(),this.showRange(this.currentUnitSelection),i&&this.currentRange.includes(i.pathNode)){// todo limit path by range
let t=this.board.pathFinder.findPath(e,i?.pathNode);t.forEach(t=>{let e=t.owner;e.toggleHighlight(!0,"path",h.Green)}),this.currentPath=t}}}(Q,J),new $(Q.currentScene);const tt=new j(0,0,"Spider",J);Q.add(tt);const te=new j(4,5,"Spider",J);Q.add(te);const ti=new j(1,1,"Knight",J);Q.add(ti),Q.onInitialize=()=>{// const cell = board.getCell(2, 2);
...
//     }
// })
},Q.start(G).then(()=>{});//# sourceMappingURL=index.fbc4ef3b.js.map

//# sourceMappingURL=index.fbc4ef3b.js.map
