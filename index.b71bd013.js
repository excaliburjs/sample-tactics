 ...
 * @param milliseconds
 * @param clock
 */function eT(t,e){var i;let s=new ex,r=null!==(i=null==e?void 0:e.schedule.bind(e))&&void 0!==i?i:setTimeout;return r(()=>{s.resolve()},t),s.promise}(d=V||(V={}))[d.X=12]="X",d[d.Y=13]="Y";/**
...
let n=null!=e?e:eL.filtering;return s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,n===G.Pixel?s.NEAREST:s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,n===G.Pixel?s.NEAREST:s.LINEAR),s.texImage2D(s.TEXTURE_2D,0,s.RGBA,s.RGBA,s.UNSIGNED_BYTE,t),this._textureMap.set(t,r),r}delete(t){// Ignore loading if webgl is not registered
 ...
 */eL.filtering=G.Blended,eL._MAX_TEXTURE_SIZE=4096;class ez{/**
 ...
 * @param gl
 * @param type
 */function eG(t,e){switch(e){case t.LOW_FLOAT:case t.HIGH_FLOAT:case t.FLOAT:return 1;case t.FLOAT_VEC2:return 2;case t.FLOAT_VEC3:return 3;case t.FLOAT_VEC4:return 4;case t.BYTE:case t.UNSIGNED_BYTE:case t.UNSIGNED_SHORT:case t.SHORT:default:return 1}}/**
...
`;return i.replace("%%texture_picker%%",s)}_addImageAsTexture(t){let e=t.getAttribute("filtering"),i=null;(e===G.Blended||e===G.Pixel)&&(i=e);let s="true"===t.getAttribute("forceUpload"),r=this._context.textureLoader.load(t,i,s);// remove force attribute after upload
...
p.drawElements(p.TRIANGLES,6,this._quads.bufferGlType,0)}_addImageAsTexture(t){let e=t.getAttribute("filtering"),i=null;(e===G.Blended||e===G.Pixel)&&(i=e);let s="true"===t.getAttribute("forceUpload"),r=this._context.textureLoader.load(t,i,s);return(// remove force attribute after upload
 ...
 */class iT{get _image(){return this._imageElement||(this._imageElement=new Image,this._imageElement.src=this.logo),this._imageElement}get playButtonRootElement(){return this._playButtonRootElement}get playButtonElement(){return this._playButtonElement}get _playButton(){let t=document.getElementById("excalibur-play-root");return t&&(this._playButtonRootElement=t),this._playButtonRootElement||(this._playButtonRootElement=document.createElement("div"),this._playButtonRootElement.id="excalibur-play-root",this._playButtonRootElement.style.position="absolute",document.body.appendChild(this._playButtonRootElement)),this._styleBlock||(this._styleBlock=document.createElement("style"),this._styleBlock.textContent=this._playButtonStyles,document.head.appendChild(this._styleBlock)),this._playButtonElement||(this._playButtonElement=this.startButtonFactory(),this._playButtonRootElement.appendChild(this._playButtonElement)),this._playButtonElement}/**
     ...
     */constructor(t){this.events=new tS,this.canvas=new ig({filtering:G.Blended,smoothing:!0,cache:!0,draw:this.draw.bind(this)}),this._resourceList=[],this._index=0,this._playButtonShown=!1,this._resourceCount=0,this._numLoaded=0,this._progressCounts={},this._totalCounts={},// logo drawing stuff
 ...
 */class iG{constructor(t,e){this.min=t,this.max=e}overlaps(t){return this.max>t.min&&t.max>this.min}getOverlap(t){return this.overlaps(t)?this.max>t.max?t.max-this.min:this.max-t.min:0}}/**
...
l.pos=l.pos.add(l.dir.scale(-2*iB.surfaceEpsilon));let d=new eg(1/0,1/0);if(this._dynamicCollisionTree.rayCastQuery(l,s+2*iB.surfaceEpsilon,e=>{if(!this._pairExists(t,e)&&iV.canCollide(t,e)){let t=e.rayCast(l,s+10*iB.surfaceEpsilon);if(t){let i=t.sub(h);i.size<d.size&&(d=i,r=e)}}return!1}),r&&eg.isValid(d)){let s=new iV(t,r);this._pairs.has(s.id)||(this._pairs.add(s.id),this._collisionPairCache.push(s));// move the fast moving object to the other body
...
let i=this.center,s=t.dir,r=t.pos,n=Math.sqrt(Math.pow(s.dot(r.sub(i)),2)-Math.pow(r.sub(i).distance(),2)+Math.pow(this.radius,2));if(n<0)return null;{let o=0;if(0===n)return(o=-s.dot(r.sub(i)))>0&&o<e?t.getPoint(o):null;{let o=-s.dot(r.sub(i))+n,a=-s.dot(r.sub(i))-n,h=[];o>=0&&h.push(o),a>=0&&h.push(a);let l=Math.min(...h);return l<=e?t.getPoint(l):null}}}getClosestLineBetween(t){if(t instanceof i1)return i0.CircleCircleClosestLine(this,t);if(t instanceof i9)return i0.PolygonCircleClosestLine(t,this).flip();if(t instanceof i4)return i0.CircleEdgeClosestLine(this,t).flip();throw Error(`Polygon could not collide with unknown CollisionShape ${typeof t}`)}/**
     ...
     */project(t){let e=[],i=this.center,s=i.dot(t);return e.push(s),e.push(s+this.radius),e.push(s-this.radius),new iG(Math.min.apply(Math,e),Math.max.apply(Math,e))}debug(t,e){var i,s,r,n;let o=this._transform,a=null!==(i=null==o?void 0:o.globalScale)&&void 0!==i?i:eg.One,h=null!==(s=null==o?void 0:o.globalRotation)&&void 0!==s?s:0,l=null!==(r=null==o?void 0:o.globalPos)&&void 0!==r?r:eg.Zero;t.save(),t.translate(l.x,l.y),t.rotate(h),t.scale(a.x,a.y),t.drawCircle(null!==(n=this.offset)&&void 0!==n?n:eg.Zero,this._naturalRadius,ef.Transparent,e,2),t.restore()}}/**
...
return new ey(Math.min(t.x,e.x)-i,Math.min(t.y,e.y)-i,Math.max(t.x,e.x)+i,Math.max(t.y,e.y)+i)}/**
     ...
     */project(t){let e=[],i=[this._getTransformedBegin(),this._getTransformedEnd()],s=i.length;for(let r=0;r<s;r++)e.push(i[r].dot(t));return new iG(Math.min.apply(Math,e),Math.max.apply(Math,e))}debug(t,e){let i=this._getTransformedBegin(),s=this._getTransformedEnd();t.drawLine(i,s,e,2),t.drawCircle(i,2,e),t.drawCircle(s,2,e)}}/**
...
n>=0?t.getPoint(r):null)}/**
     ...
     */project(t){let e=this.getTransformedPoints(),i=e.length,s=Number.MAX_VALUE,r=-Number.MAX_VALUE;for(let n=0;n<i;n++){let i=e[n].dot(t);s=Math.min(s,i),r=Math.max(r,i)}return new iG(s,r)}debug(t,e){let i=this.getTransformedPoints()[0],s=[i,...this.getTransformedPoints(),i];for(let i=0;i<s.length-1;i++)t.drawLine(s[i],s[i+1],e,2),t.drawCircle(s[i],2,e),t.drawCircle(s[i+1],2,e)}}/**
...
this.padding=null!==(i=t.padding)&&void 0!==i?i:2+r/2,this.radius=t.radius,this.filtering=null!==(s=t.filtering)&&void 0!==s?s:G.Blended,this.rasterize()}clone(){return new sc({radius:this.radius,...this.cloneGraphicOptions(),...this.cloneRasterOptions()})}execute(t){this.radius>0&&(t.beginPath(),t.arc(this.radius,this.radius,this.radius,0,2*Math.PI),this.color&&t.fill(),this.strokeColor&&t.stroke())}}/**
 ...
 */class sG extends sn{// private _transform: TransformComponent;
/**
 ...
 */class rS{/**
     ...
     */get tileMaps(){return this.world.entityManager.entities.filter(t=>t instanceof sV)}get timers(){return this._timers}constructor(){// Initialize systems
 ...
 */class rW{constructor(t){this.inputs=t,this._handlers=new Map}/**
     ...
     */on(t,e){this._handlers.set(t,e)}}tb();let rV={FallbackGraphicsContext:"fallbackgraphicscontext",Initialize:"initialize",Visible:"visible",Hidden:"hidden",Start:"start",Stop:"stop",PreUpdate:"preupdate",PostUpdate:"postupdate",PreFrame:"preframe",PostFrame:"postframe",PreDraw:"predraw",PostDraw:"postdraw"};/**
 ...
 */class rG{/**
     ...
     */constructor(t){var e,i,s,r,n,o;/**
         ...
         */this.currentFrameLagMs=0,this._lagMs=0,this._screenShotRequests=[],t={...rG._DEFAULT_ENGINE_OPTIONS,...t},this._originalOptions=t,tC.freeze(),// Initialize browser events facade
 ...
 */class nr extends i_{get points(){return this._points}set points(t){this._points=t;let e=this.minPoint;this.width=this._points.reduce((t,e)=>Math.max(e.x,t),0)-e.x,this.height=this._points.reduce((t,e)=>Math.max(e.y,t),0)-e.y,this.flagDirty()}get minPoint(){let t=this._points.reduce((t,e)=>Math.min(e.x,t),1/0),e=this._points.reduce((t,e)=>Math.min(e.y,t),1/0);return em(t,e)}constructor(t){super(t),this.points=t.points,this.filtering=G.Blended,this.rasterize()}clone(){return new nr({points:this.points.map(t=>t.clone()),...this.cloneGraphicOptions(),...this.cloneRasterOptions()})}execute(t){if(this.points&&this.points.length){t.beginPath();// Iterate through the supplied points and construct a 'polygon'
...
})(),n.fWn,n.Ia8;var o=n.rqv;n.hLI,n.yyv,n.tX5;var a=n.vtX;n.r7K,n.lCh,n.cE4;var h=n.fwF;n.sce,n.AQ6;var l=n._c7;n.KUs,n.Ajp,n.dkO,n.RDh;var d=n._H9;n.mxs,n.OmD,n.kBf,n.C4F,n.NQt,n.JjN,n.EK_,n.V1s,n.xHm,n.Xz7,n.Cdc,n.FKn,n.SUY,n.ab2,n.GfZ,n.YMS,n.oyv,n.aUb,n.SdD,n.JUv,n.jEj,n.TFq,n.HDU,n.R_y,n.ydN,n.t50,n.s$$,n.v2G;var c=n.Ilk;n.s9i,n.dxL,n.LLX;var u=n.wA2;n.R_p,n.IQ$,n.I5F,n.X8$,n.FR6,n.U8o;var p=n.kbG;n.iS_,n.cGG,n.RPN,n.skb,n.SLU,n.RdJ,n.cNu,n.gU7,n.LSk,n.Nmp;var _=n.d1Y;n.xrL,n.sRW,n.cmV,n.qWz,n.N0Q;var g=n.q8b;n.ynB,n.jT9;var m=n.wAz,f=n.D4V;n.NLr,n.N6H,n.W1A,n.JHW,n.ZZ$,n.v2K,n.pBf,n.vpe,n.GMl,n.zW2,n.B0K,n.Nv7,n.C_p,n.MUA,n.xqU,n.pTp,n.vUK,n.j9l;var v=n.Zxw;n.v51,n.Hdx;var y=n.Z$d;n.iqV,n.o$7;var x=n.olM;n.Zm$,n.$QH,n.i78,n.nJg,n.h6u,n.hts,n.j88,n.VME,n.fy2,n.nt,n.Ukr,n.zsu,n.oA6,n.TVh,n.TwZ,n.GTT,n.xxj,n.XdK,n.Jmb;var w=n.cXo;n.Dm5,n.IIB,n.ebW,n.zI0,n.LYD,n.cEG,n.SEl,n.t9V,n.ez5,n.N1d,n.R8U,n.SKZ,n.__J,n.RI$,n.x12,n.ccz;var b=n.aNw;n.XrL,n.xwn,n.dNK,n.ini,n.YdH,n.F5T,n.y3G,n.l57,n.xn0,n.t2V,n.uxB,n.cpd,n.fiy,n.$XZ,n.UG6,n.uqK,n.STE,n.y$z,n.mAD,n.sOq,n.hUw;var C=n._0G;n.Sqs,n.hpZ;var A=n.Vol;n.vYX,n.wIZ,n.cBi,n.c30,n.MPV,n.RFv,n.Ux6,n.rxy,n.I$c,n.kfC,n.VjY,n.mgq,n.YVA,n.Kgp,n.HH$,n.M_d,n.rgh,n.Ra6,n.KhR,n.BS5,n.xhz,n.xOq,n.a9j,n.bHk,n.CgK,n.cuY,n.kvE,n.SBu,n.AE_,n.ctO,n.OLH;var S=n.kky;n.nSF,n.zHn,n.zwx,n.AeJ,n.hLz,n.D9g,n.wA,n.jhr,n.GVs,n._zO,n.LXZ,n.w6$,n.mhV,n.MOD,n.kwd,n.Lmr,n.xsS,n.K5l,n.lLr,n.Z$r,n.IXb,n.SGH,n.SMj,n.L34,n.exe,n.bnF,n.MFA;var T=n.$uU;n.Sap,n.jyi,n.E03;var E=n.V6q;n.rg2,n.DVW,n.nVo,n.F6N,n.xP7,n.Odq,n.Zif,n.ZGJ,n.MJk;var P=n.xvT;n.PHM,n.dpR,n.n9L,n.KwO,n.SxM,n.B7y,n.x7r,n.wx7,n.Uvn,n.OFT,n.xzN,n.CcZ,n.M5Z;var I=n.ZrN,M=n.OWs;n.dF9,n.oZy,n.rD2,n.VHo,n.ohE,n.R$E,n.xQN,n.AdJ,n.q3I,n.Pab;var k=n.uZ5;n.McK,n.F9c,n.k0b,n.hnT,n.RSJ,n.Mku,n.h90,n.rms,n.ErP,n.aVg,n.lPc,n.Z8E,n._N2,n.yFn,n.lNv,n.cu9,n.MZQ,n.FUM,n.BxR;var R=n.vdf,D=n.iaL;n.w6H,n.Q4c,n.Xxe,n.Uxb,n.Yr5;var B=n.Bhw;n.yOA;var F={};F=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var U={};U=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var L={};L=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var z={};z=new URL("UISheet.2837e64f.png",import.meta.url).toString();var O={};O=new URL("TerrainSheet.720a833c.png",import.meta.url).toString();var H={};H=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var N={};N=new URL("RedHighlightSheet.4a69e4d5.png",import.meta.url).toString();var $={};$=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var W={};W=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var V={};V=new URL("hit.cc332530.wav",import.meta.url).toString();var G={};G=new URL("move.8e8aee5f.wav",import.meta.url).toString();var q={};q=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();const X={KnightSpriteSheet:new w(/*@__PURE__*/t(F)),SpiderSheet:new w(/*@__PURE__*/t(U)),HeartSheet:new w(/*@__PURE__*/t(L)),UISheet:new w(/*@__PURE__*/t(z)),TerrainSheet:new w(/*@__PURE__*/t(O)),HighlightSheet:new w(/*@__PURE__*/t(H)),RedHighlightSheet:new w(/*@__PURE__*/t(N)),CloudSheet:new w(/*@__PURE__*/t($)),SmokeSheet:new w(/*@__PURE__*/t(W)),HitSound:new T(/*@__PURE__*/t(V)),MoveSound:new T(/*@__PURE__*/t(G)),SelectSound:new T(/*@__PURE__*/t(q))},Z=E.fromImageSource({image:X.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),K=E.fromImageSource({image:X.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),Y=E.fromImageSource({image:X.RedHighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),j=h.fromSpriteSheetCoordinates({spriteSheet:K,strategy:l.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),Q=h.fromSpriteSheetCoordinates({spriteSheet:Y,strategy:l.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),J=E.fromImageSource({image:X.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),tt=h.fromSpriteSheetCoordinates({spriteSheet:J,strategy:l.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),te=E.fromImageSource({image:X.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),ti=h.fromSpriteSheetCoordinates({spriteSheet:te,strategy:l.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),ts=E.fromImageSource({image:X.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),tr=X.SmokeSheet.toSprite(),tn=new b;for(let t of Object.values(X))tn.addResource(t);const to=performance.now();console.log("Random seed:",to);const ta=new S(to),th=B(3,3),tl=B(96,128),td={Knight:{graphics:{offset:B(0,12*th.y),idle:ti},health:5,movement:4,attack:2,range:1},Spider:{graphics:{offset:B(0,8*th.y),idle:tt},health:3,movement:3,attack:1,range:1}};class tc extends a{constructor(t){super({pos:t,coordPlane:p.Screen,vel:B(R(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=X.CloudSheet.toSprite(),this.cloudSprite.scale=th,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class tu extends u{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=B(0,0),/**
...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=M.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const tp=j.clone(),t_=j.clone(),tg=Q.clone();class tm extends a{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:B(t*(i.tileWidth+i.margin)*th.x,e*(i.tileHeight+i.margin)*th.y).add(tl),anchor:M.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this.pathNode=new tu(this.pos),this.addComponent(this.pathNode),this.sprite=Z.sprites[D(0,5)],this.sprite.scale=th,this.graphics.use(this.sprite.clone()),tp.scale=th,tp.opacity=.75,t_.scale=th,t_.opacity=.75,t_.tint=c.Green,tg.scale=th,tg.opacity=.75,// AttackHighlightAnimation.tint = ex.Color.Red;
this.graphics.add("range",tp),this.graphics.add("path",t_),this.graphics.add("attack",tg)}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
this.graphics.hide("range"),this.graphics.hide("path"),this.graphics.hide("attack"),t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     ...
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class tf{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([tu.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i,s){s>=0&&(e.push(t),t.connections.filter(t=>t.isWalkable&&!!(t.walkableMask&i)).forEach(t=>this._getRangeHelper(t,e,i,s-1)))}getRange(t,e,i){let s=[];return this._getRangeHelper(t,s,e,i),s=// dedup results
(s=s.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}/**
     ...
     * @param range 
     * @returns 
     */findPath(t,e,i,s){let r=this.query.getEntities().map(t=>t.get(tu));r.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=M.Down;let n=[t],o=[];for(;n.length>0;){// priority queue, evaluate nodes with the lowest cost
...
return[]}}const tv=new A({emitterType:m.Circle,radius:16,minVel:0,maxVel:20,minAngle:0,maxAngle:6.2,isEmitting:!1,emitRate:8,opacity:.75,fadeFlag:!0,particleLife:1500,maxSize:20,minSize:1,startSize:10,endSize:.01,acceleration:B(0,-32),particleSprite:tr,randomRotation:!0,particleRotationalVelocity:Math.PI});class ty extends a{constructor(t,e,i,s,r){super({anchor:B(0,0),z:2}),this.player=r,this.cell=null,this.moved=!1,this.attacked=!1,this.unitConfig={...td[i]},this.health=this.unitConfig.health,this.anim=this.unitConfig.graphics.idle.clone(),this.anim.scale=th,this.graphics.use(this.anim),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onPostUpdate(){this.attacked?this.anim.tint=c.Gray:this.anim.tint=c.White,this.health<=0&&(this.cell?.removeUnit(this),// TODO better death animation
this.actions.runAction(new C([new o(this,t=>t.rotateBy(2e3,.5)),new o(this,t=>t.easeBy(B(0,-1e3),300,g.EaseInQuad))])).die())}onPostDraw(t){if(this.health>0){let e=ts.getSprite(k(this.health,0,5),0);e&&(e.scale=th,e.draw(t,10*th.x+this.unitConfig.graphics.offset.x,10*th.y+this.unitConfig.graphics.offset.y))}}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new o(this,t=>{t.delay(200),t.callMethod(()=>{X.MoveSound.play()})}),s=new o(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,g.EaseInOutCubic),t.callMethod(()=>{tv.pos=this.pos.add(th.scale(16)),tv.emitParticles(5)})}),r=new C([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this),this.moved=!0}reset(){this.moved=!1,this.attacked=!1}canAttack(){return!this.attacked}canMove(){return!this.moved}hasActions(){return this.canMove()||this.canAttack()}pass(){this.moved=!0,this.attacked=!0}getPossibleTargets(){if(this.cell){let t=this.cell.board.pathFinder.getRange(this.cell.pathNode,~this.player.mask,this.unitConfig.range);return t.filter(t=>t.owner)}}async attack(t){t.health-=this.unitConfig.attack,X.HitSound.play(),await t.actions.blink(200,200,5).toPromise(),this.attacked=!0;// TODO handle enemy death
}}class tx{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=tx._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=tx._CURRENT_GROUP=tx._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}async turnEnd(){this.active=!1}}function tw(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tb=globalThis,tC=tb.ShadowRoot&&(void 0===tb.ShadyCSS||tb.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tA=Symbol(),tS=new WeakMap;class tT{constructor(t,e,i){if(this._$cssResult$=!0,i!==tA)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(tC&&void 0===t){let i=void 0!==e&&1===e.length;i&&(t=tS.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&tS.set(e,t))}return t}toString(){return this.cssText}}const tE=t=>new tT("string"==typeof t?t:t+"",void 0,tA),tP=(t,...e)=>{let i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new tT(i,t,tA)},tI=(t,e)=>{if(tC)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let i of e){let e=document.createElement("style"),s=tb.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}},tM=tC?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return tE(e)})(t):t,{is:tk,defineProperty:tR,getOwnPropertyDescriptor:tD,getOwnPropertyNames:tB,getOwnPropertySymbols:tF,getPrototypeOf:tU}=Object,tL=globalThis,tz=tL.trustedTypes,tO=tz?tz.emptyScript:"",tH=tL.reactiveElementPolyfillSupport,tN=(t,e)=>t,t$={toAttribute(t,e){switch(e){case Boolean:t=t?tO:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},tW=(t,e)=>!tk(t,e),tV={attribute:!0,type:String,converter:t$,reflect:!1,hasChanged:tW};Symbol.metadata??=Symbol("metadata"),tL.litPropertyMetadata??=new WeakMap;class tG extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=tV){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&tR(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=tD(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get(){return s?.call(this)},set(e){let n=s?.call(this);r.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??tV}static _$Ei(){if(this.hasOwnProperty(tN("elementProperties")))return;let t=tU(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(tN("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tN("properties"))){let t=this.properties,e=[...tB(t),...tF(t)];for(let i of e)this.createProperty(i,t[i])}let t=this[Symbol.metadata];if(null!==t){let e=litPropertyMetadata.get(t);if(void 0!==e)for(let[t,i]of e)this.elementProperties.set(t,i)}for(let[t,e]of(this._$Eh=new Map,this.elementProperties)){let i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let t of i)e.unshift(tM(t))}else void 0!==t&&e.push(tM(t));return e}static _$Eu(t,e){let i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$E_??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$E_?.delete(t)}_$ES(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return tI(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$E_?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EO(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){let r=(void 0!==i.converter?.toAttribute?i.converter:t$).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){let t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:t$;this._$Em=s,this[s]=r.fromAttribute(e,t.type),this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){if(!((i??=this.constructor.getPropertyOptions(t)).hasChanged??tW)(s?r:this[t],e))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(t){Promise.reject(t)}let t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[e,i]of t)!0!==i.wrapped||this._$AL.has(e)||void 0===this[e]||this.C(e,this[e],i)}let t=!1,e=this._$AL;try{(t=this.shouldUpdate(e))?(this.willUpdate(e),this._$E_?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$ET()}catch(e){throw t=!1,this._$ET(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$E_?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach(t=>this._$EO(t,this[t])),this._$ET()}updated(t){}firstUpdated(t){}}tG.elementStyles=[],tG.shadowRootOptions={mode:"open"},tG[tN("elementProperties")]=new Map,tG[tN("finalized")]=new Map,tH?.({ReactiveElement:tG}),(tL.reactiveElementVersions??=[]).push("2.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tq=globalThis,tX=tq.trustedTypes,tZ=tX?tX.createPolicy("lit-html",{createHTML:t=>t}):void 0,tK="$lit$",tY=`lit$${(Math.random()+"").slice(9)}$`,tj="?"+tY,tQ=`<${tj}>`,tJ=document,t0=()=>tJ.createComment(""),t1=t=>null===t||"object"!=typeof t&&"function"!=typeof t,t2=Array.isArray,t5=t=>t2(t)||"function"==typeof t?.[Symbol.iterator],t3="[ 	\n\f\r]",t4=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,t9=/-->/g,t6=/>/g,t7=RegExp(`>|${t3}(?:([^\\s"'>=/]+)(${t3}*=${t3}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),t8=/'/g,et=/"/g,ee=/^(?:script|style|textarea|title)$/i,ei=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),es=ei(1),er=(ei(2),Symbol.for("lit-noChange")),en=Symbol.for("lit-nothing"),eo=new WeakMap,ea=tJ.createTreeWalker(tJ,129);function eh(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==tZ?tZ.createHTML(e):e}const el=(t,e)=>{let i=t.length-1,s=[],r,n=2===e?"<svg>":"",o=t4;for(let e=0;e<i;e++){let i=t[e],a,h,l=-1,d=0;for(;d<i.length&&(o.lastIndex=d,null!==(h=o.exec(i)));)d=o.lastIndex,o===t4?"!--"===h[1]?o=t9:void 0!==h[1]?o=t6:void 0!==h[2]?(ee.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=t7):void 0!==h[3]&&(o=t7):o===t7?">"===h[0]?(o=r??t4,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,a=h[1],o=void 0===h[3]?t7:'"'===h[3]?et:t8):o===et||o===t8?o=t7:o===t9||o===t6?o=t4:(o=t7,r=void 0);let c=o===t7&&t[e+1].startsWith("/>")?" ":"";n+=o===t4?i+tQ:l>=0?(s.push(a),i.slice(0,l)+tK+i.slice(l)+tY+c):i+tY+(-2===l?e:c)}return[eh(t,n+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class ed{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,a=this.parts,[h,l]=el(t,e);if(this.el=ed.createElement(h,i),ea.currentNode=this.el.content,2===e){let t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=ea.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(let t of s.getAttributeNames())if(t.endsWith(tK)){let e=l[n++],i=s.getAttribute(t).split(tY),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?eg:"?"===o[1]?em:"@"===o[1]?ef:e_}),s.removeAttribute(t)}else t.startsWith(tY)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(ee.test(s.tagName)){let t=s.textContent.split(tY),e=t.length-1;if(e>0){s.textContent=tX?tX.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],t0()),ea.nextNode(),a.push({type:2,index:++r});s.append(t[e],t0())}}}else if(8===s.nodeType){if(s.data===tj)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(tY,t+1));)a.push({type:7,index:r}),t+=tY.length-1}}r++}}static createElement(t,e){let i=tJ.createElement("template");return i.innerHTML=t,i}}function ec(t,e,i=t,s){if(e===er)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl,n=t1(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t))._$AT(t,i,s),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=ec(t,r._$AS(t,e.values),r,s)),e}class eu{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??tJ).importNode(e,!0);ea.currentNode=s;let r=ea.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new ep(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new ev(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=ea.nextNode(),n++)}return ea.currentNode=tJ,s}p(t){let e=0;for(let i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class ep{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=en,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t1(t=ec(this,t,e))?t===en||null==t||""===t?(this._$AH!==en&&this._$AR(),this._$AH=en):t!==this._$AH&&t!==er&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):t5(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==en&&t1(this._$AH)?this._$AA.nextSibling.data=t:this.$(tJ.createTextNode(t)),this._$AH=t}g(t){let{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ed.createElement(eh(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let t=new eu(s,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=eo.get(t.strings);return void 0===e&&eo.set(t.strings,e=new ed(t)),e}T(t){t2(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new ep(this.k(t0()),this.k(t0()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class e_{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=en,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=en}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(void 0===r)(n=!t1(t=ec(this,t,e,0))||t!==this._$AH&&t!==er)&&(this._$AH=t);else{let s,o;let a=t;for(t=r[0],s=0;s<r.length-1;s++)(o=ec(this,a[i+s],e,s))===er&&(o=this._$AH[s]),n||=!t1(o)||o!==this._$AH[s],o===en?t=en:t!==en&&(t+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!s&&this.O(t)}O(t){t===en?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class eg extends e_{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===en?void 0:t}}class em extends e_{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==en)}}class ef extends e_{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=ec(this,t,e,0)??en)===er)return;let i=this._$AH,s=t===en&&i!==en||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==en&&(i===en||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ev{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){ec(this,t)}}const ey=tq.litHtmlPolyfillSupport;ey?.(ed,ep),(tq.litHtmlVersions??=[]).push("3.1.0");const ex=(t,e,i)=>{let s=i?.renderBefore??e,r=s._$litPart$;if(void 0===r){let t=i?.renderBefore??null;s._$litPart$=r=new ep(e.insertBefore(t0(),t),t,void 0,i??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ew extends tG{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ex(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return er}}ew._$litElement$=!0,ew.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:ew});const eb=globalThis.litElementPolyfillSupport;eb?.({LitElement:ew}),(globalThis.litElementVersions??=[]).push("4.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eC={attribute:!0,type:String,converter:t$,reflect:!1,hasChanged:tW},eA=(t=eC,e,i)=>{let{kind:s,metadata:r}=i,n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(i.name,t),"accessor"===s){let{name:s}=i;return{set(i){let r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t),e}}}if("setter"===s){let{name:s}=i;return function(i){let r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};function eS(t){return(e,i)=>"object"==typeof i?eA(t,e,i):((t,e,i)=>{let s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eT=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i),eE={ATTRIBUTE:1},eP=t=>(...e)=>({_$litDirective$:t,values:e});class eI{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eM="important",ek=" !"+eM,eR=eP(class extends eI{constructor(t){if(super(t),t.type!==eE.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(ek);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?eM:""):i[t]=s}}return er}}),eD=eP(class extends eI{constructor(t){if(super(t),t.type!==eE.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return er}});let eB=class extends ew{static #t=this.styles=tP`
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),this.clearEvents())}render(){let t=this._show?es`<div class="overlay" @click=${this.hide}></div>`:en;return es`
        ${t}
        <div class=${eD({menu:!0,show:this._show})} style=${eR({left:`${this.left}px`,top:`${this.top}px`})}>
            <div class="title-bar"></div>
            <div class="options">
                <button style=${eR({display:this.unit?.canMove()?"block":"none"})} @click="${this.sendEvent("move")}">Move</button>
                <button style=${eR({display:this.unit?.canAttack()?"block":"none"})} @click="${this.sendEvent("attack")}">Attack</button>
...
this._debounce=0}};tw([eS({type:Number})],eB.prototype,"left",void 0),tw([eS({type:Number})],eB.prototype,"top",void 0),tw([eS({type:Number})],eB.prototype,"fontSize",void 0),tw([eS({type:Number})],eB.prototype,"width",void 0),tw([eS({attribute:!1})],eB.prototype,"unit",void 0),tw([eS({type:Number})],eB.prototype,"pixelConversion",void 0),tw([eS({state:!0,attribute:!1})],eB.prototype,"_show",void 0),tw([(t,e,i)=>{let s=t=>t.renderRoot?.querySelector(".menu")??null;return eT(t,e,{get(){return s(this)}})}],eB.prototype,"menuHtml",void 0),eB=tw([(e="unit-menu",(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})],eB);const eF=new f({width:800,height:800,displayMode:_.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}});// TODO move to level
// Add clouds :3
eF.add(new tc(B(800,0))),eF.add(new tc(B(400,300))),eF.add(new tc(B(700,700)));const eU=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new tm(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tf(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&e.unit.active&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-tl.x)/((this.tileWidth+this.margin)*th.x)),Math.floor((t.y-tl.y)/((this.tileHeight+this.margin)*th.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,eF.currentScene),eL=new class{constructor(t){this.engine=t,this.uiToWorldPos=new Map,this.unitMenu=new eB,document.body.appendChild(this.unitMenu),document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString()),window.addEventListener("resize",()=>{document.documentElement.style.setProperty("--pixel-conversion",this.worldDistanceToPage(1).toString());let t=this.uiToWorldPos.get(this.unitMenu);if(t){let e=this.engine.screen.worldToPageCoordinates(t);this.unitMenu.left=e.x+this.worldDistanceToPage(32),this.unitMenu.top=e.y}})}worldDistanceToPage(t){let e=this.engine.screen.worldToPageCoordinates(M.Zero),i=this.engine.screen.worldToPageCoordinates(B(t*th.x,0)).sub(e);return i.x}showUnitMenu(t,e){let i=this.unitMenu,s=this.engine.screen.worldToPageCoordinates(t.pos);i.left=s.x+this.worldDistanceToPage(32),i.top=s.y,i.unit=t;let r=()=>{e.move(),a()},n=()=>{e.attack(),a()},o=()=>{e.pass(),a()};i.addEventListener("move",r),i.addEventListener("attack",n),i.addEventListener("pass",o);let a=()=>{i.removeEventListener("move",r),i.removeEventListener("attack",n),i.removeEventListener("pass",o)};return i.clearEvents=a,i.show(),this.uiToWorldPos.set(i,t.pos),i}}(eF),ez=new class{constructor(t){this.board=t,this.currentPlayer=null,this.currentSelectionMode="move",this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentSelectionMode=e,"move"===e?(this.currentRange=this.findMovementRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range")):(this.currentRange=this.findAttackRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"attack")))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findMovementRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findAttackRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,~t.player.mask,this.currentUnitSelection.unitConfig.range):[]}findMovementRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}(eU),eO=new class extends tx{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await I.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.movement));let i=ta.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e,"move"),await I.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await I.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await I.delay(1e3)}return!0}}("Monsters of the Forest",ez,eU),eH=new class extends tx{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new x,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this))}pointerMove(t){if(this.active&&this.selectionManager.currentUnitSelection){// move
...
}else this.maybeSelectUnit(e)}hasNonPlayerUnit(t){return t&&t.unit&&t.unit.player!==this}hasPlayerUnitWithActions(t){return t?.unit&&t?.unit?.hasActions()&&t.unit.player===this}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new x}hasMoves(){let t=this.board.getUnits().filter(t=>t.player===this).filter(t=>t.hasActions());return t.length>0&&!this.passed}async makeMove(){// TODO while there are moves to make or the player has not passed their turn wait
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}("Knights of the Round Table",eF,ez,eL,eU),eN=new class{constructor(t,e,i,s){if(this.engine=t,this.players=e,this.maxTurns=s,this.currentTurn=1,this.currentPlayerIndex=0,this.topScreen=B(400,-2e3),this.centerScreen=B(400,400),this.bottomScreen=B(400,2e3),0===e.length)throw Error("Players should be non-zero in length");this.currentPlayer=e[this.currentPlayerIndex],this.selectionManager=i,this.turnText=new P({text:`Turn ${this.currentTurn}`,font:new v({family:"notjamslab14",size:32*th.x,unit:y.Px,color:c.White,baseAlign:d.Top,quality:4})});let r=t.screen.resolution.width;this.turnActor=new a({pos:this.topScreen,coordPlane:p.Screen,color:new c(240,50,50,.4),width:r,height:100}),this.turnActor.graphics.opacity=0,this.turnActor.graphics.add("text",this.turnText),this.turnActor.graphics.show("text"),t.add(this.turnActor)}async showTurnDisplay(){0===this.currentPlayerIndex&&(this.turnText.text=`Turn ${this.currentTurn}`,await this.turnActor.actions.runAction(new C([new o(this.turnActor,t=>t.easeTo(this.centerScreen,1200,g.EaseInOutCubic).delay(700).easeTo(this.bottomScreen,1200,g.EaseInOutCubic)),new o(this.turnActor,t=>t.fade(1,1200).delay(700).fade(0,1200))])).toPromise(),this.turnActor.pos=this.topScreen)}async start(){// TODO win condition
for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),this.showTurnDisplay(),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayerIndex=this.currentPlayerIndex%this.players.length,this.currentPlayer=this.players[this.currentPlayerIndex],0===this.currentPlayerIndex&&this.currentTurn++}}(eF,[eH,eO],ez,10),e$=new ty(0,0,"Spider",eU,eO);eF.add(e$);const eW=new ty(4,5,"Spider",eU,eO);eF.add(eW);const eV=new ty(1,1,"Knight",eU,eH);eF.add(eV);const eG=new ty(2,1,"Knight",eU,eH);eF.add(eG),eF.add(tv),eF.start(tn).then(()=>{eN.start()});//# sourceMappingURL=index.b71bd013.js.map

//# sourceMappingURL=index.b71bd013.js.map
