...
this.engine.goToScene(this.level.levelData.nextLevel)});return}}this.selectionManager.selectPlayer(this.currentPlayer),this.showTurnDisplay(),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayerIndex=this.currentPlayerIndex%this.players.length,this.currentPlayer=this.players[this.currentPlayerIndex],0===this.currentPlayerIndex&&this.currentTurn++}}class e4 extends l{constructor(t){super({name:"cloud",pos:t,vel:H(L(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=to.CloudSheet.toSprite(),this.cloudSprite.scale=tS,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class e9 extends I{constructor(t,e){super(),this.levelData=t,this.name=e}onInitialize(t){this.engine=t}resetAndLoad(){let t=this.entities;for(let e=t.length-1;e>=0;e--)this.world.remove(t[e],!1);to.LevelMusic2.stop(),this.add(new e4(H(800,0))),this.add(new e4(H(400,300))),this.add(new e4(H(700,700))),this.board=this.parse(this.levelData),this.add(tB),this.camera.pos=this.board.getCenter()}onActivate(){this.resetAndLoad(),this.turnManager.start(),to.LevelMusic2.loop=!0,to.LevelMusic2.volume=.05,to.LevelMusic2.play(),this.engine.input.keyboard.on("press",t=>{t.key===A.W&&this.players[1].lose(),t.key===A.L&&this.players[0].lose()})}onDeactivate(){to.LevelMusic2.stop()}parse(t){let e=new tD(t.height,t.width,this);this.selectionManager=new tN(e),this.selectionManager.showCursor(0,0),this.uiManager=new e2(this.engine),// TODO support arbitrary players
this.players=[new tO(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new e5(t.players[1],this.selectionManager,e)],this.turnManager=new e3(this.engine,this,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t="K"===r.charAt(1)?"Knight":"Spider",n=+r.charAt(2)-1;o=new tz(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}const e6={name:"Gentle Plains",nextLevel:"level",width:6,height:3,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G"]},e7=new y({width:800,height:800,displayMode:m.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}}),e8=new class extends I{onInitialize(t){t.input.pointers.primary.once("down",()=>{t.goToScene("tutorial")}),t.input.keyboard.once("press",()=>{t.goToScene("tutorial")}),this.add(new e4(H(800,0))),this.add(new e4(H(400,300))),this.add(new e4(H(700,700))),this.title=new l({name:"title",pos:H(400,400),coordPlane:_.Screen}),this.title.scale=tS,this.title.graphics.use(tb),this.title.actions.repeatForever(t=>{t.easeBy(H(0,-30*tS.y),1e3,f.EaseInOutQuad).easeBy(H(0,30*tS.y),1e3,f.EaseInOutQuad)}),this.add(this.title),this.instructions=new l({name:"instructions",pos:H(400,600),coordPlane:_.Screen});let e=new x({family:"notjamslab14",size:32*tS.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4,shadow:{offset:H(10,10).scale(tS),color:p.Black}}),i=new D({text:"Click to Play!",font:e});this.instructions.graphics.use(i),this.instructions.actions.repeatForever(t=>{// ctx.blink(300, 300, 2);
...
await this.moveToUnit2(),await this.showText(5),await this.focus.actions.delay(1e3),await this.hideText(),await this.highlightEnemyRange(),await this.showText(6),await this.focus.actions.delay(2e3),await this.hideText(),await this.showText(7),await this.focus.actions.delay(7e3),await this.hideText(),this.camera.zoomOverTime(1,1e3,f.EaseInOutCubic),this.engine.goToScene("level1")}onDeactivate(){to.LevelMusic2.stop()}};e7.addScene(it.name,it);const ie=new e9({name:"Gentle Plains",nextLevel:"level2",width:6,height:3,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G"]},"level1");e7.addScene(ie.name,ie);const ii=new e9({name:"Gentle Plains 2",nextLevel:"start",width:6,height:6,maxTurns:100,players:["human","computer"],data:["GK1","G","GS2","G","G","GS2","GK1","G","G","G","G","GS2","GK1","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","GS2","W","W","GS2","GS2"]},"level2");e7.addScene(ii.name,ii),e7.start(tC).then(()=>{e7.goToScene("start")});//# sourceMappingURL=index.c8bfcfef.js.map

//# sourceMappingURL=index.c8bfcfef.js.map
