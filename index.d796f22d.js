 ...
 * @preserve
 *//******/var e,i,s={/***/4662:/***/(t,e,i)=>{i(3430);var s=i(8791);t.exports=s("Array","sort");/***/},/***/8343:/***/(t,e,i)=>{i(4769);var s=i(9276);t.exports=s.Object.keys;/***/},/***/7111:/***/(t,e,i)=>{var s=i(6733),r=i(9821),n=TypeError;// `Assert: IsCallable(argument) is true`
...
await this.moveToUnit2(),await this.showText(5),await this.focus.actions.delay(1e3),await this.hideText(),await this.highlightEnemyRange(),await this.showText(6),await this.focus.actions.delay(2e3),await this.hideText(),await this.showText(7),await this.focus.actions.delay(7e3),await this.hideText(),this.camera.zoomOverTime(1,1e3,m.EaseInOutCubic),this.engine.goToScene("level1")}onDeactivate(){tn.LevelMusic2.stop()}};it.addScene(ii.name,ii);const is=new e9({displayName:"Gentle Plains",name:"level1",nextLevel:"level2",width:6,height:3,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G"]},"level1");it.addScene(is.name,is);const ir=new e9({displayName:"Gentle Plains 2",name:"level2",nextLevel:"start",width:6,height:6,maxTurns:100,players:["human","computer"],data:["GK1","G","GS2","G","G","GS2","GK1","G","G","G","G","GS2","GK1","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","GS2","W","W","GS2","GS2"]},"level2");it.addScene(ir.name,ir),it.start(tb).then(()=>{it.goToScene("start")});//# sourceMappingURL=index.d796f22d.js.map
