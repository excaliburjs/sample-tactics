 ...
 * transform so that all drawing takes place with the actor as the origin.
 *
 */class tB extends tE{constructor(t,e,i){super(),this.ctx=t,this.delta=e,this.target=i}}/**
 * The 'predebugdraw' event is emitted on actors, scenes, and engine before debug drawing starts.
 */class tD extends tE{constructor(t,e){super(),this.ctx=t,this.target=e}}/**
 ...
 */function eB(t,e){return t&&void 0===t.__isProxy?new Proxy(t,{set:(t,i,s)=>(t[i]!==s&&(t[i]=s,"string"==typeof i&&"_"!==i[0]&&e(t)),!0),get:(t,e)=>"__isProxy"===e||t[e]}):t}/**
 * Watch an object with a proxy, fires change on any property value change
 */function eD(t,e){return t&&void 0===t.__isProxy?new Proxy(t,{set:(t,i,s)=>(// The default behavior to store the value
 ...
 */class eF{isStale(){return this._transformStale}/**
     ...
     */get scale(){return this._scale}set scale(t){this._scale=eB(t,()=>{this._transformStale=!0}),this._transformStale=!0}/**
     * Gets or sets the origin of the graphic, if not set the center of the graphic is the origin
     */get origin(){return this._origin}set origin(t){this._origin=eB(t,()=>{this._transformStale=!0}),this._transformStale=!0}constructor(t){var e,i,s,r,n,o;this.id=eF._ID++,this.transform=eP.identity(),this.tint=null,this._transformStale=!0,/**
...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],y=this._context.getTransform(),x=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=y.multiply(b),C=y.multiply(C),A=y.multiply(A),S=y.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let E=this._context.tint,T=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,M=e/P,R=i/I,k=(e+f-.01)/P,B=(i+v-.01)/I,D=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
D[this._vertexIndex++]=b.x,D[this._vertexIndex++]=b.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=M,D[this._vertexIndex++]=R,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a,// (0, 1) - 1
D[this._vertexIndex++]=A.x,D[this._vertexIndex++]=A.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=M,D[this._vertexIndex++]=B,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a,// (1, 0) - 2
D[this._vertexIndex++]=C.x,D[this._vertexIndex++]=C.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=k,D[this._vertexIndex++]=R,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a,// (1, 1) - 3
D[this._vertexIndex++]=S.x,D[this._vertexIndex++]=S.y,D[this._vertexIndex++]=x,D[this._vertexIndex++]=k,D[this._vertexIndex++]=B,D[this._vertexIndex++]=T,D[this._vertexIndex++]=E.r/255,D[this._vertexIndex++]=E.g/255,D[this._vertexIndex++]=E.b/255,D[this._vertexIndex++]=E.a}hasPendingDraws(){return 0!==this._imageCount}flush(){// nothing to draw early exit
...
let c=null!==(l=null==t?void 0:t.width)&&void 0!==l?l:this._bitmap.width,u=null!==(d=null==t?void 0:t.height)&&void 0!==d?d:this._bitmap.height;this.width=c,this.height=u;let p=this._bitmap.getContext("2d");if(p)this._ctx=p;else /* istanbul ignore next */throw Error("Browser does not support 2d canvas drawing, cannot create Raster graphic")}cloneRasterOptions(){return{color:this.color?this.color.clone():null,strokeColor:this.strokeColor?this.strokeColor.clone():null,smoothing:this.smoothing,lineWidth:this.lineWidth,lineDash:this.lineDash,lineCap:this.lineCap,quality:this.quality,padding:this.padding}}/**
     ...
     */get color(){return this._color}set color(t){this.flagDirty(),this._color=eB(t,()=>this.flagDirty())}/**
     * Gets or sets the strokeStyle of the Raster graphic. Setting the strokeStyle will cause the raster to be
     * flagged dirty causing a re-raster on the next draw.
     */get strokeColor(){return this._strokeColor}set strokeColor(t){this.flagDirty(),this._strokeColor=eB(t,()=>this.flagDirty())}/**
 ...
 *//* istanbul ignore next */class iD{static get gravity(){return iD.acc}static set gravity(t){iD.acc=t}/**
     * Configures Excalibur to use "arcade" physics. Arcade physics which performs simple axis aligned arcade style physics.
     */static useArcadePhysics(){iD.collisionResolutionStrategy=Z.Arcade}/**
     * Configures Excalibur to use rigid body physics. Rigid body physics allows for complicated
     * simulated physical interactions.
     */static useRealisticPhysics(){iD.collisionResolutionStrategy=Z.Realistic}static get dynamicTreeVelocityMultiplyer(){return iD.dynamicTreeVelocityMultiplier}static set dynamicTreeVelocityMultiplyer(t){iD.dynamicTreeVelocityMultiplier=t}}/**
 ...
 */iD.broadphaseStrategy=K.DynamicAABBTree,/**
 ...
 * simulated physical interactions.
 */iD.collisionResolutionStrategy=Z.Arcade,/**
 * The default mass to use if none is specified
 */iD.defaultMass=10,/**
 * Gets or sets the position and velocity positional integrator, currently only Euler is supported.
 */iD.integrator=Y.Euler,/**
 * Factor to add to the RigidBody BoundingBox, bounding box (dimensions += vel * dynamicTreeVelocityMultiplier);
 */iD.dynamicTreeVelocityMultiplier=2,/**
 * Pad RigidBody BoundingBox by a constant amount
 */iD.boundsPadding=5,/**
 * Number of position iterations (overlap) to run in the solver
 */iD.positionIterations=3,/**
 * Number of velocity iteration (response) to run in the solver
 */iD.velocityIterations=8,/**
 ...
 */iD.bodiesCanSleepByDefault=!1,/**
 * Surface epsilon is used to help deal with surface penetration
 */iD.surfaceEpsilon=.1,iD.sleepEpsilon=.07,iD.wakeThreshold=3*iD.sleepEpsilon,iD.sleepBias=.9,/**
 * Enable fast moving body checking, this enables checking for collision pairs via raycast for fast moving objects to prevent
 * bodies from tunneling through one another.
 */iD.checkForFastBodies=!0,/**
 ...
 */iD.disableMinimumSpeedForFastBody=!1,function(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);n>3&&o&&Object.defineProperty(e,i,o)}([iB({message:"Alias for incorrect spelling used in older versions, will be removed in v0.25.0",alternateMethod:"dynamicTreeVelocityMultiplier"})],iD,"dynamicTreeVelocityMultiplyer",null),/**
...
if(this._remove(i),s.left-=iD.boundsPadding,s.top-=iD.boundsPadding,s.right+=iD.boundsPadding,s.bottom+=iD.boundsPadding,t.owner){let i=null===(e=t.owner)||void 0===e?void 0:e.get(i8);if(i){let t=32*i.vel.x/1e3*iD.dynamicTreeVelocityMultiplier,e=32*i.vel.y/1e3*iD.dynamicTreeVelocityMultiplier;t<0?s.left+=t:s.right+=t,e<0?s.top+=e:s.bottom+=e}}return i.bounds=s,this._insert(i),!0}/**
...
if(i&&(i.physics.pairs=this._collisionPairCache.length),iD.checkForFastBodies)for(let t of n){let e=t.owner.get(i8);// Skip non-active objects. Does not make sense on other collision types
...
if(iD.disableMinimumSpeedForFastBody||s>n/2){let r;i&&i.physics.fastBodies++;// start with the oldPos because the integration for actors has already happened
...
l.pos=l.pos.add(l.dir.scale(-2*iD.surfaceEpsilon));let d=new eg(1/0,1/0);if(this._dynamicCollisionTree.rayCastQuery(l,s+2*iD.surfaceEpsilon,e=>{if(!this._pairExists(t,e)&&iG.canCollide(t,e)){let t=e.rayCast(l,s+10*iD.surfaceEpsilon);if(t){let i=t.sub(h);i.size<d.size&&(d=i,r=e)}}return!1}),r&&eg.isValid(d)){let s=new iG(t,r);this._pairs.has(s.id)||(this._pairs.add(s.id),this._collisionPairCache.push(s));// move the fast moving object to the other body
// need to push into the surface by ex.Physics.surfaceEpsilon
let n=o.sub(a);e.globalPos=h.add(n).add(d).add(l.dir.scale(10*iD.surfaceEpsilon)),t.update(e.transform.get()),i&&i.physics.fastBodyCollisions++}}}// return cache
 ...
 */class i8 extends iz{constructor(t){var e,i,s;super(),this.type="ex.body",this.dependencies=[iN,i$],this.id=tA("body",i8._ID++),this.events=new tS,this._oldTransform=new iU,/**
         ...
         */this._mass=iD.defaultMass,/**
         * Amount of "motion" the body has before sleeping. If below [[Physics.sleepEpsilon]] it goes to "sleep"
         */this.sleepMotion=5*iD.sleepEpsilon,/**
         * Can this body sleep, by default bodies do not sleep
         */this.canSleep=iD.bodiesCanSleepByDefault,this._sleeping=!1,/**
     ...
     * @param sleeping
     */setSleeping(t){this._sleeping=t,t?(this.vel=eg.Zero,this.acc=eg.Zero,this.angularVelocity=0,this.sleepMotion=0):this.sleepMotion=5*iD.sleepEpsilon}/**
     * Update body's [[BodyComponent.sleepMotion]] for the purpose of sleeping
     */updateMotion(){this._sleeping&&this.setSleeping(!0);let t=this.vel.size*this.vel.size+Math.abs(this.angularVelocity*this.angularVelocity),e=iD.sleepBias;this.sleepMotion=e*this.sleepMotion+(1-e)*t,this.sleepMotion=eh(this.sleepMotion,0,10*iD.sleepEpsilon),this.canSleep&&this.sleepMotion<iD.sleepEpsilon&&this.setSleeping(!0)}/**
 ...
 */class sk{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sB extends iz{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,i$]}onAdd(t){this._ctx=new sk(t)}onRemove(){this._ctx=null}/**
...
i[t]=s,i[t+1]=r}}return this._chachedText=t,this._chachedLines=i,this._cachedRenderWidth=e,i}}class sF{static measureText(t,e,i){let s=sD.getHashCode(e,t);if(sF._MEASURE_CACHE.has(s))return sF._MEASURE_CACHE.get(s);sF._LOGGER.debug("Font text measurement cache miss");let r=e.measureTextWithoutCache(t,i);return sF._MEASURE_CACHE.set(s,r),r}static getTextInstance(t,e,i){let s=sD.getHashCode(e,t,i),r=sF._TEXT_CACHE.get(s);return r||(r=new sD(e,t,i),sF._TEXT_CACHE.set(s,r),sF._LOGGER.debug("Font text instance cache miss")),// Cache the bitmap for certain amount of time
 ...
 */class sU extends sn{/**
     ...
     */set angularVelocity(t){this.motion.angularVelocity=t}get scale(){return this.get(iN).scale}set scale(t){this.get(iN).scale=t}get anchor(){return this._anchor}set anchor(t){this._anchor=eB(t,t=>this._handleAnchorChange(t)),this._handleAnchorChange(t)}_handleAnchorChange(t){this.graphics&&(this.graphics.anchor=t)}/**
...
let r=i[s];if(r){so(r)&&(null==r||r.tick(e,this._token));let i=this.renderFromTopOfGraphic?0:r.height-this.tileHeight;r.draw(t,a*this.tileWidth,l*this.tileHeight-i)}}l=0}this.emit("postdraw",new tB(t,e,this))}debug(t){let e=this.tileWidth*this.columns,i=this.tileHeight*this.rows,s=eg.Zero;for(let i=0;i<this.rows+1;i++){let r=em(0,i*this.tileHeight);t.drawLine(s.add(r),s.add(em(e,r.y)),ef.Red,2)}for(let e=0;e<this.columns+1;e++){let r=em(e*this.tileWidth,0);t.drawLine(s.add(r),s.add(em(r.x,i)),ef.Red,2)}let r=this._composite.getColliders();for(let e of r){let i=ef.Gray;i.a=.5;let s=e.localBounds,r=e.worldPos.sub(this.pos);t.drawRectangle(r,s.width,s.height,i)}}}/**
 * TileMap Tile
 *
 ...
 */class sJ{constructor(){this.events=new tS,this.transform=eP.identity(),this.inverse=eP.identity(),this._cameraStrategies=[],this.strategy=new sq(this),/**
         ...
         */this._posChanged=!1,this._pos=eD(eg.Zero,()=>this._posChanged=!0),/**
...
this._isShaking=!1,this._shakeMagnitudeX=0,this._shakeMagnitudeY=0,this._shakeDuration=0,this._elapsedShakeTime=0,this._xShake=0,this._yShake=0,this._isZooming=!1,this._zoomStart=1,this._zoomEnd=1,this._currentZoomTime=0,this._zoomDuration=0,this._zoomEasing=sp.EaseInOutCubic,this._easing=sp.EaseInOutCubic,this._halfWidth=0,this._halfHeight=0,this._viewport=null,this._isInitialized=!1}get zoom(){return this._z}set zoom(t){this._z=t,this._engine&&(this._halfWidth=this._engine.halfDrawWidth,this._halfHeight=this._engine.halfDrawHeight)}/**
     ...
     */get angularVelocity(){return this._angularVelocity}set angularVelocity(t){this._angularVelocity=t}get pos(){return this._pos}set pos(t){this._pos=eD(t,()=>this._posChanged=!0),this._posChanged=!0}/**
...
if(iD.warmStart)this.warmStart(t);else for(let e of t){let t=this.getContactConstraints(e.id);for(let e of t)e.normalImpulse=0,e.tangentImpulse=0}}postSolve(t){for(let e of t){let t=e.colliderA.owner.get(i8),i=e.colliderB.owner.get(i8);if(t&&i){// Skip post solve for active+passive collisions
...
this.lastFrameContacts.clear(),t))this.lastFrameContacts.set(e.id,e)}/**
     ...
     * @param contacts
     */warmStart(t){var e,i,s;for(let r of t){let t=null===(e=r.colliderA.owner)||void 0===e?void 0:e.get(i8),n=null===(i=r.colliderB.owner)||void 0===i?void 0:i.get(i8);if(t&&n){let e=null!==(s=this.idToContactConstraint.get(r.id))&&void 0!==s?s:[];for(let i of e)if(iD.warmStart){let e=r.normal.scale(i.normalImpulse),s=r.tangent.scale(i.tangentImpulse),o=e.add(s);t.applyImpulse(i.point,o.negate()),n.applyImpulse(i.point,o)}else i.normalImpulse=0,i.tangentImpulse=0}}}/**
     * Iteratively solve the position overlap constraint
     * @param contacts
     */solvePosition(t){var e,i,s;for(let r=0;r<iD.positionIterations;r++)for(let r of t){let t=null===(e=r.colliderA.owner)||void 0===e?void 0:e.get(i8),n=null===(i=r.colliderB.owner)||void 0===i?void 0:i.get(i8);if(t&&n){// Skip solving active+passive
if(t.collisionType===X.Passive||n.collisionType===X.Passive)continue;let e=null!==(s=this.idToContactConstraint.get(r.id))&&void 0!==s?s:[];for(let i of e){let e=r.normal,s=i3.FindContactSeparation(r,i.local),o=iD.steeringFactor,a=iD.slop,h=eh(o*(s+a),-5,0),l=e.scale(-h*i.normalMass);// This is a pseudo impulse, meaning we aren't doing a real impulse calculation
// We adjust position and rotation instead of doing the velocity
if(t.collisionType===X.Active){// TODO make applyPseudoImpulse function?
let e=l.negate().scale(t.inverseMass);t.limitDegreeOfFreedom.includes(Q.X)&&(e.x=0),t.limitDegreeOfFreedom.includes(Q.Y)&&(e.y=0),t.globalPos=t.globalPos.add(e),t.limitDegreeOfFreedom.includes(Q.Rotation)||(t.rotation-=i.aToContact.cross(l)*t.inverseInertia)}if(n.collisionType===X.Active){let t=l.scale(n.inverseMass);n.limitDegreeOfFreedom.includes(Q.X)&&(t.x=0),n.limitDegreeOfFreedom.includes(Q.Y)&&(t.y=0),n.globalPos=n.globalPos.add(t),n.limitDegreeOfFreedom.includes(Q.Rotation)||(n.rotation+=i.bToContact.cross(l)*n.inverseInertia)}}}}}solveVelocity(t){var e,i,s;for(let r=0;r<iD.velocityIterations;r++)for(let r of t){let t=null===(e=r.colliderA.owner)||void 0===e?void 0:e.get(i8),n=null===(i=r.colliderB.owner)||void 0===i?void 0:i.get(i8);if(t&&n){// Skip solving active+passive
...
this._lastFrameContacts=new Map(this._currentFrameContacts)}getSolver(){return iD.collisionResolutionStrategy===Z.Realistic?this._realisticSolver:this._arcadeSolver}debug(t){this._processor.debug(t)}runContactStartEnd(){// Composite collider collisions may have a duplicate id because we want to treat those as a singular start/end
...
this.onInitialize.call(this,t),this._initializeChildren(),this._logger.debug("Scene.onInitialize",this,t),this.events.emit("initialize",new t0(t,this)),this._isInitialized=!0)}/**
     ...
     *
     * @internal
     */_postdraw(t,e){this.emit("postdraw",new tB(t,e,this)),this.onPostDraw(t,e)}/**
...
for(let t of(this._cancelQueue.length=0,this._timers))t.update(e);this.world.update(to.Update,e),this.camera&&this.camera.update(t,e),this._collectActorStats(t),this._postupdate(t,e)}/**
     ...
     * @param ctx  The current rendering context
     *//* istanbul ignore next */debugDraw(t){this.emit("predebugdraw",new tD(t,this)),// pass
...
this.browser=new rB(window,document);// Check compatibility
...
this.graphicsContext.flush(),this.graphicsContext.endDrawLifecycle(),this._checkForScreenShots()}/**
     ...
     * @internal
     */_postdraw(t,e){this.emit("postdraw",new tB(t,e,this)),this.onPostDraw(t,e)}onPostDraw(t,e){// Override me
}/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eg={ATTRIBUTE:1},em=t=>(...e)=>({_$litDirective$:t,values:e});class ef{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ev="important",ey=" !"+ev,ex=em(class extends ef{constructor(t){if(super(t),t.type!==eg.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(ey);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?ev:""):i[t]=s}}return t5}}),ew=em(class extends ef{constructor(t){if(super(t),t.type!==eg.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return t5}});let eb=class extends ed{static #t=this.styles=tf`
        .menu {
            position: absolute;
            top: 0;
            left: 0;
    ...
    `;sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.show=!1,this.requestUpdate()}}hide(){this.show=!1}render(){let t=this.show?t2`<div class="overlay" @click=${this.hide}></div>`:t3;return t2`
        ${t}
        <div class=${ew({menu:!0,hide:!this.show})} style=${ex({left:`${this.left}px`,top:`${this.top}px`})}>
        ...
        `}constructor(...t){super(...t),this.left=0,this.top=0,this.show=!1}};td([e_({type:Number})],eb.prototype,"left",void 0),td([e_({type:Number})],eb.prototype,"top",void 0),td([e_({type:Boolean})],eb.prototype,"show",void 0),eb=td([(e="unit-menu",(t,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})],eb);const eC=new g({width:800,height:800,displayMode:p.FitScreenAndFill,antialiasing:!1});// TODO move to level
// Add clouds :3
eC.add(new te(P(800,0))),eC.add(new te(P(400,300))),eC.add(new te(P(700,700)));const eA=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new to(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new ta(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-J.x)/((this.tileWidth+this.margin)*Q.x)),Math.floor((t.y-J.y)/((this.tileHeight+this.margin)*Q.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,eC.currentScene),eS=new class{constructor(t){this.engine=t,this.unitMenu=new eb,document.body.appendChild(this.unitMenu)}showUnitMenu(t,e){let i=this.engine.screen.worldToPageCoordinates(t.pos),s=this.unitMenu;s.left=i.x+48*Q.x,s.top=i.y;let r=()=>{e.move(),a()},n=()=>{e.attack(),a()},o=()=>{e.pass(),a()};s.addEventListener("move",r),s.addEventListener("attack",n),s.addEventListener("pass",o);let a=()=>{s.removeEventListener("move",r),s.removeEventListener("attack",n),s.removeEventListener("pass",o)};return s.show=!0,s}}(eC),eE=new class{constructor(t){this.board=t,this.currentPlayer=null,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentRange=this.findRange(this.currentUnitSelection),"move"===e?this.showHighlight(this.currentRange,"range"):this.showHighlight(this.currentRange,"attack"))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}(eA),eT=new class extends tl{constructor(t,e,i){super(t,i),this.selectionManger=e,this.active=!1}async turnStart(){this.active=!0}async turnEnd(){this.active=!1}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await C.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.movement));let i=j.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e,"move"),await C.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await C.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await C.delay(1e3)}return!0}}("Monsters of the Forest",eE,eA),eP=new class extends tl{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new m,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this))}pointerMove(t){if(!this.active||!this.selectionManager.currentUnitSelection)return;this.selectionManager.resetHighlight();let e=this.selectionManager.findRange(this.selectionManager.currentUnitSelection);this.selectionManager.showHighlight(e,"range");let i=this.board.getCellByWorldPos(t.worldPos);if(i){let t=this.selectionManager.findPath(i,e);this.selectionManager.showHighlight(t,"path")}}async pointerClick(t){if(!this.active)return;let e=this.board.getCellByWorldPos(t.worldPos);// a unit is currently selected
this.selectionManager.currentUnitSelection?e?(this.active=!1,await this.selectionManager.selectDestinationAndMove(this.selectionManager.currentUnitSelection,e),this.humanMove.resolve()):this.selectionManager.reset():e?.unit&&e?.unit?.canMove()?this.uiManger.showUnitMenu(e.unit,{move:()=>{this.selectionManager.selectUnit(e.unit,"move")},attack:()=>{},pass:()=>{e.unit?.pass(),this.selectionManager.reset(),this.humanMove.resolve()}}):this.selectionManager.reset()}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new m}hasMoves(){let t=this.board.getUnits().filter(t=>t.player===this).filter(t=>t.canMove());return t.length>0&&!this.passed}async makeMove(){// TODO while there are moves to make or the player has not passed their turn wait
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}("Knights of the Round Table",eC,eE,eS,eA),eI=new class{constructor(t,e,i){if(this.players=t,this.maxTurns=i,this.currentPlayerIndex=0,0===t.length)throw Error("Players should be non-zero in length");this.currentPlayer=t[this.currentPlayerIndex],this.selectionManager=e}// todo generator??
async start(){for(;this.maxTurns>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer),await this.currentPlayer.turnStart();let t=!0;do t=await this.currentPlayer.makeMove();while(!t)await this.currentPlayer.turnEnd(),this.nextTurn(),this.maxTurns--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayer=this.players[this.currentPlayerIndex%this.players.length]}}([eP,eT],eE,10),eM=new th(0,0,"Spider",eA,eT);eC.add(eM);const eR=new th(4,5,"Spider",eA,eT);eC.add(eR);const ek=new th(1,1,"Knight",eA,eP);eC.add(ek);const eB=new th(2,1,"Knight",eA,eP);eC.add(eB),eC.start(K).then(()=>{eI.start();// const uiManager = new UIManager(game);
// uiManager.showUnitMenu(knight1, knight1.pos);
// // uiManager.showMenu(spider2.pos);
});//# sourceMappingURL=index.29ee9a07.js.map
