...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],x=this._context.getTransform(),y=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=x.multiply(b),C=x.multiply(C),A=x.multiply(A),S=x.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let T=this._context.tint,E=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,B=e/P,D=i/I,F=(e+f-.01)/P,R=(i+v-.01)/I,k=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
k[this._vertexIndex++]=b.x,k[this._vertexIndex++]=b.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=B,k[this._vertexIndex++]=D,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (0, 1) - 1
...
k[this._vertexIndex++]=C.x,k[this._vertexIndex++]=C.y,k[this._vertexIndex++]=y,k[this._vertexIndex++]=F,k[this._vertexIndex++]=D,k[this._vertexIndex++]=E,k[this._vertexIndex++]=T.r/255,k[this._vertexIndex++]=T.g/255,k[this._vertexIndex++]=T.b/255,k[this._vertexIndex++]=T.a,// (1, 1) - 3
 ...
 */class sF{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sR extends iU{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,iW]}onAdd(t){this._ctx=new sF(t)}onRemove(){this._ctx=null}/**
...
this.graphics.hide("range"),this.graphics.hide("path"),t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     ...
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class tt{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([$.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i){i>=0&&(e.push(t),t.connections.filter(t=>t.isWalkable).forEach(t=>this._getRangeHelper(t,e,i-1)))}getRange(t,e){let i=[];return this._getRangeHelper(t,i,e),i=// dedup results
(i=i.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}findPath(t,e,i){let s=this.query.getEntities().map(t=>t.get($));s.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=y.Down;let r=[t],n=[];for(;r.length>0;){// priority queue, evaluate nodes with the lowest cost
let t=r.sort((t,e)=>t.hScore-e.hScore),s=t[0];// Done!
if(s===e)return this._buildPath(s);// Remove current from the open node set
let o=r.indexOf(s);r.splice(o,1),n.push(s);// Find the neighbors that haven't been explored
let a=s.connections.filter(t=>t.isWalkable).filter(t=>-1===n.indexOf(t));i&&(a=a.filter(t=>i.indexOf(t)>-1));// Current direction!
let h=s.direction;a.forEach(t=>{if(-1===r.indexOf(t)){t.previousNode=s,t.gScore=t.weight+s.gScore,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight;// Turn penalty if direction is not straight
let i=t.pos.sub(s.pos).normalize();t.direction=i;let n=h.dot(i);0===n&&(t.hScore+=130),r.push(t)}})}// error case
return[]}}class te extends o{constructor(t,e,i,s){super({anchor:A(0,0)}),this.cell=null,this.unitConfig={...K[i]};let r=this.unitConfig.graphics.idle;r.scale=X,this.graphics.use(r),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onPostDraw(t){let e=V.getSprite(w(this.unitConfig.health,0,5),0);e&&(e.scale=X,e.draw(t,10*X.x,16*X.y))}async move(t){this.cell&&(this.cell.unit=null,this.cell.pathNode.isWalkable=!0);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new n(this,t=>{t.delay(200),t.callMethod(()=>{L.MoveSound.play()})}),s=new n(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,p.EaseInOutCubic)}),r=new f([t,s]);await this.actions.runAction(r).toPromise()}e&&(e.addUnit(this),this.cell=e)}}const ti=new _({width:800,height:800,displayMode:u.FitScreenAndFill});// TODO move to level
// Add clouds :3
ti.add(new Y(A(800,0))),ti.add(new Y(A(400,300))),ti.add(new Y(A(700,700)));const ts=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new J(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tt(i)}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-Z.x)/((this.tileWidth+this.margin)*X.x)),Math.floor((t.y-Z.y)/((this.tileHeight+this.margin)*X.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,ti.currentScene);new class{constructor(t,e){this.engine=t,this.board=e,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.active=!0,t.input.pointers.on("down",this.pointerClick.bind(this)),t.input.pointers.on("move",this.pointerMove.bind(this))}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}pointerMove(t){if(!this.active||!this.currentUnitSelection)return;this.resetHighlight();let e=this.findRange(this.currentUnitSelection);this.showHighlight(e,"range");let i=this.board.getCellByWorldPos(t.worldPos);if(i){let t=this.findPath(i,this.currentRange);this.showHighlight(t,"path")}}selectUnit(t){this.currentUnitSelection=t,this.currentRange=this.findRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range")}async selectDestinationAndMove(t,e){let i=this.findRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&(this.active=!1,await t.move(this.currentPath),this.active=!0),this.reset()}async pointerClick(t){if(!this.active)return;let e=this.board.getCellByWorldPos(t.worldPos);// a unit is currently selected
this.currentUnitSelection?e?this.selectDestinationAndMove(this.currentUnitSelection,e):this.reset():e?.unit?this.selectUnit(e.unit):this.reset()}findRange(t){if(!this.currentUnitSelection||!t.cell)return[];let e=this.board.pathFinder.getRange(t.cell.pathNode,this.currentUnitSelection.unitConfig.range);return e}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,e);return s}return[]}}(ti,ts);const tr=new te(0,0,"Spider",ts);ti.add(tr);const tn=new te(4,5,"Spider",ts);ti.add(tn);const to=new te(1,1,"Knight",ts);ti.add(to);const ta=new te(2,1,"Knight",ts);ti.add(ta),ti.start(q).then(()=>{});//# sourceMappingURL=index.07ce03a1.js.map

//# sourceMappingURL=index.07ce03a1.js.map
