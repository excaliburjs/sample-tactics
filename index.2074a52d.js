...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=B.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const ty=tr.clone(),tx=tr.clone(),tw=tn.clone();(e=s||(s={})).Grass="G",e.Water="W",e.Sand="S",e.Stone="T";class tb extends l{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:L(t*(i.tileWidth+i.margin)*t_.x,e*(i.tileHeight+i.margin)*t_.y).add(tm),anchor:B.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this._terrain="G",this.pathNode=new tv(this.pos),this.addComponent(this.pathNode),this.terrain="G",ty.scale=t_,ty.opacity=.75,tx.scale=t_,tx.opacity=.75,tx.tint=p.Green,tw.scale=t_,tw.opacity=.75,this.graphics.add("range",ty),this.graphics.add("path",tx),this.graphics.add("attack",tw)}get terrain(){return this._terrain}set terrain(t){switch(this._terrain=t,this.terrain){case"G":this.sprite=te.sprites[z(0,1)];break;case"S":this.sprite=te.sprites[z(2,3)];break;case"W":this.sprite=te.sprites[4],this.pathNode.isWalkable=!1;break;case"T":this.sprite=te.sprites[5]}this.sprite.scale=t_,this.graphics.use(this.sprite.clone())}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
this.graphics.hide("range"),this.graphics.hide("path"),this.graphics.hide("attack"),t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     * Returns the orthogonal neighbors (up, down, left, right)
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class tC{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([tv.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i,s){s>=0&&(e.push(t),t.connections.filter(t=>t.isWalkable&&!!(t.walkableMask&i)).forEach(t=>this._getRangeHelper(t,e,i,s-1)))}getRange(t,e,i){let s=[];return this._getRangeHelper(t,s,e,i),s=// dedup results
(s=s.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}/**
     ...
     * @param range 
     * @returns 
     */findPath(t,e,i,s){let r=this.query.getEntities().map(t=>t.get(tv));r.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=B.Down;let n=[t],o=[];for(;n.length>0;){// priority queue, evaluate nodes with the lowest cost
...
return[]}}class tA{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new tb(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tC(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&e.unit.active&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-tm.x)/((this.tileWidth+this.margin)*t_.x)),Math.floor((t.y-tm.y)/((this.tileHeight+this.margin)*t_.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}const tS=new T({emitterType:v.Circle,radius:16,minVel:0,maxVel:20,minAngle:0,maxAngle:6.2,isEmitting:!1,emitRate:8,opacity:.75,fadeFlag:!0,particleLife:1500,maxSize:20,minSize:1,startSize:10,endSize:.01,acceleration:L(0,-32),particleSprite:tc,randomRotation:!0,particleRotationalVelocity:Math.PI});class tT extends l{constructor(t,e){super({pos:t,z:10});let i=new x({family:"notjamslab14",size:16*t_.x,unit:w.Px,color:p.Yellow,baseAlign:u.Top,quality:4,shadow:{offset:L(2,2).scale(t_),color:p.Black}}),s=new R({text:e.toFixed(0),font:i});this.graphics.add(s)}}class tE{constructor(t){this.scene=t}spawnDamageNumber(t,e){let i=new tT(t,e);i.actions.easeBy(L(0,-100),1e3,f.EaseOutCubic).die(),this.scene.add(i)}}class tP extends l{constructor(t,e,i,s,r){super({name:i,anchor:L(0,0),z:2}),this.player=r,this.cell=null,this.moved=!1,this.attacked=!1,this.unitConfig={...tf[i]},this.health=this.unitConfig.health,this.anim=this.unitConfig.graphics.idle.clone(),this.anim.scale=t_,this.graphics.use(this.anim),this.graphics.onPostDraw=this.onPostDraw.bind(this);let n=s.getCell(t,e);n&&(this.pos=n.pos.sub(this.unitConfig.graphics.offset),n.addUnit(this))}onInitialize(t){this.damageManager=new tE(t.currentScene)}onPostUpdate(){this.attacked?this.anim.tint=p.Gray:this.anim.tint=p.White,this.health<=0&&(this.cell?.removeUnit(this),// TODO better death animation
this.actions.runAction(new S([new h(this,t=>t.rotateBy(2e3,.5)),new h(this,t=>t.easeBy(L(0,-1e3),300,f.EaseInQuad))])).die())}onPostDraw(t){if(this.health>0){let e=td.getSprite(F(this.health,0,5),0);e&&(e.scale=t_,e.draw(t,10*t_.x+this.unitConfig.graphics.offset.x,10*t_.y+this.unitConfig.graphics.offset.y))}}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new h(this,t=>{t.delay(200),t.callMethod(()=>{J.MoveSound.play()})}),s=new h(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,f.EaseInOutCubic),t.callMethod(()=>{tS.pos=this.pos.add(t_.scale(16)),tS.emitParticles(5)})}),r=new S([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this),this.moved=!0}reset(){this.moved=!1,this.attacked=!1}canAttack(){return!this.attacked}canMove(){return!this.moved}hasActions(){return this.canMove()||this.canAttack()}pass(){this.moved=!0,this.attacked=!0}getPossibleTargets(){if(this.cell){let t=this.cell.board.pathFinder.getRange(this.cell.pathNode,~this.player.mask,this.unitConfig.range);return t.filter(t=>t.owner)}}async attack(t){t.health-=this.unitConfig.attack,J.HitSound.play(),this.damageManager.spawnDamageNumber(t.pos.add(t.unitConfig.graphics.offset).add(L(16*t_.x,0)),this.unitConfig.attack),await t.actions.blink(200,200,5).toPromise(),this.attacked=!0}}class tI{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=tI._STARTING_BIT;constructor(t,e){this.name=t,this.board=e,this.active=!1,this.mask=tI._CURRENT_GROUP=tI._CURRENT_GROUP<<1|0}async turnStart(){this.active=!0;let t=this.board.getUnits().filter(t=>t.player===this);t.forEach(t=>t.reset())}async turnEnd(){this.active=!1}}class tM extends tI{constructor(t,e,i,s,r){super(t,r),this.engine=e,this.selectionManager=i,this.uiManger=s,this.passed=!1,this.humanMove=new b,e.input.pointers.on("down",this.pointerClick.bind(this)),e.input.pointers.on("move",this.pointerMove.bind(this)),document.body.oncontextmenu=()=>!1}async pointerClick(t){if(!this.active)return;this.selectionManager.resetHighlight();let e=this.board.getCellByWorldPos(t.worldPos);if(t.button===E.Left){// a unit is currently selected
...
}else this.maybeSelectUnit(e)}t.button===E.Right&&this.highlightUnitRange(e)}pointerMove(t){if(this.active&&this.selectionManager.currentUnitSelection){// move
...
for(this.board.getUnits().filter(t=>t.player===this);this.hasMoves();)await this.waitForHumanMove();return!0}}class tk{constructor(t){this.board=t,this.currentPlayer=null,this.currentSelectionMode="move",this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[]}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}selectPlayer(t){this.currentPlayer=t}selectUnit(t,e){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentSelectionMode=e,"move"===e?(this.currentRange=this.findMovementRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range")):(this.currentRange=this.findAttackRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"attack")))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findMovementRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&await t.move(this.currentPath),this.reset()}findAttackRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,~t.player.mask,this.currentUnitSelection.unitConfig.range):[]}findMovementRange(t){return(// if (!this.currentUnitSelection) return [];
t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,t.unitConfig.movement).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[])}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path"),t.toggleHighlight(!1,"attack")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}function tR(t,e,i,s){var r,n=arguments.length,o=n<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tD=globalThis,tB=tD.ShadowRoot&&(void 0===tD.ShadyCSS||tD.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,tF=Symbol(),tU=new WeakMap;class tz{constructor(t,e,i){if(this._$cssResult$=!0,i!==tF)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(tB&&void 0===t){let i=void 0!==e&&1===e.length;i&&(t=tU.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&tU.set(e,t))}return t}toString(){return this.cssText}}const tL=t=>new tz("string"==typeof t?t:t+"",void 0,tF),tO=(t,...e)=>{let i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new tz(i,t,tF)},tH=(t,e)=>{if(tB)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let i of e){let e=document.createElement("style"),s=tD.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}},tN=tB?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return tL(e)})(t):t,{is:tG,defineProperty:tW,getOwnPropertyDescriptor:t$,getOwnPropertyNames:tV,getOwnPropertySymbols:tq,getPrototypeOf:tX}=Object,tZ=globalThis,tK=tZ.trustedTypes,tY=tK?tK.emptyScript:"",tj=tZ.reactiveElementPolyfillSupport,tQ=(t,e)=>t,tJ={toAttribute(t,e){switch(e){case Boolean:t=t?tY:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},t0=(t,e)=>!tG(t,e),t1={attribute:!0,type:String,converter:tJ,reflect:!1,hasChanged:t0};Symbol.metadata??=Symbol("metadata"),tZ.litPropertyMetadata??=new WeakMap;class t2 extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=t1){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&tW(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=t$(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get(){return s?.call(this)},set(e){let n=s?.call(this);r.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??t1}static _$Ei(){if(this.hasOwnProperty(tQ("elementProperties")))return;let t=tX(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(tQ("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tQ("properties"))){let t=this.properties,e=[...tV(t),...tq(t)];for(let i of e)this.createProperty(i,t[i])}let t=this[Symbol.metadata];if(null!==t){let e=litPropertyMetadata.get(t);if(void 0!==e)for(let[t,i]of e)this.elementProperties.set(t,i)}for(let[t,e]of(this._$Eh=new Map,this.elementProperties)){let i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let t of i)e.unshift(tN(t))}else void 0!==t&&e.push(tN(t));return e}static _$Eu(t,e){let i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$Eg=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$ES(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$E_??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$E_?.delete(t)}_$ES(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return tH(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$E_?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$E_?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EO(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){let r=(void 0!==i.converter?.toAttribute?i.converter:tJ).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){let t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:tJ;this._$Em=s,this[s]=r.fromAttribute(e,t.type),this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){if(!((i??=this.constructor.getPropertyOptions(t)).hasChanged??t0)(s?r:this[t],e))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$Eg=this._$EP())}C(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$EP(){this.isUpdatePending=!0;try{await this._$Eg}catch(t){Promise.reject(t)}let t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[e,i]of t)!0!==i.wrapped||this._$AL.has(e)||void 0===this[e]||this.C(e,this[e],i)}let t=!1,e=this._$AL;try{(t=this.shouldUpdate(e))?(this.willUpdate(e),this._$E_?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$ET()}catch(e){throw t=!1,this._$ET(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$E_?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$ET(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Eg}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach(t=>this._$EO(t,this[t])),this._$ET()}updated(t){}firstUpdated(t){}}t2.elementStyles=[],t2.shadowRootOptions={mode:"open"},t2[tQ("elementProperties")]=new Map,t2[tQ("finalized")]=new Map,tj?.({ReactiveElement:t2}),(tZ.reactiveElementVersions??=[]).push("2.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const t5=globalThis,t3=t5.trustedTypes,t4=t3?t3.createPolicy("lit-html",{createHTML:t=>t}):void 0,t9="$lit$",t6=`lit$${(Math.random()+"").slice(9)}$`,t7="?"+t6,t8=`<${t7}>`,et=document,ee=()=>et.createComment(""),ei=t=>null===t||"object"!=typeof t&&"function"!=typeof t,es=Array.isArray,er=t=>es(t)||"function"==typeof t?.[Symbol.iterator],en="[ 	\n\f\r]",eo=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ea=/-->/g,eh=/>/g,el=RegExp(`>|${en}(?:([^\\s"'>=/]+)(${en}*=${en}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ed=/'/g,ec=/"/g,eu=/^(?:script|style|textarea|title)$/i,ep=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),eg=ep(1),e_=(ep(2),Symbol.for("lit-noChange")),em=Symbol.for("lit-nothing"),ef=new WeakMap,ev=et.createTreeWalker(et,129);function ey(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==t4?t4.createHTML(e):e}const ex=(t,e)=>{let i=t.length-1,s=[],r,n=2===e?"<svg>":"",o=eo;for(let e=0;e<i;e++){let i=t[e],a,h,l=-1,d=0;for(;d<i.length&&(o.lastIndex=d,null!==(h=o.exec(i)));)d=o.lastIndex,o===eo?"!--"===h[1]?o=ea:void 0!==h[1]?o=eh:void 0!==h[2]?(eu.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=el):void 0!==h[3]&&(o=el):o===el?">"===h[0]?(o=r??eo,l=-1):void 0===h[1]?l=-2:(l=o.lastIndex-h[2].length,a=h[1],o=void 0===h[3]?el:'"'===h[3]?ec:ed):o===ec||o===ed?o=el:o===ea||o===eh?o=eo:(o=el,r=void 0);let c=o===el&&t[e+1].startsWith("/>")?" ":"";n+=o===eo?i+t8:l>=0?(s.push(a),i.slice(0,l)+t9+i.slice(l)+t6+c):i+t6+(-2===l?e:c)}return[ey(t,n+(t[i]||"<?>")+(2===e?"</svg>":"")),s]};class ew{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,a=this.parts,[h,l]=ex(t,e);if(this.el=ew.createElement(h,i),ev.currentNode=this.el.content,2===e){let t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=ev.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(let t of s.getAttributeNames())if(t.endsWith(t9)){let e=l[n++],i=s.getAttribute(t).split(t6),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?eT:"?"===o[1]?eE:"@"===o[1]?eP:eS}),s.removeAttribute(t)}else t.startsWith(t6)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(eu.test(s.tagName)){let t=s.textContent.split(t6),e=t.length-1;if(e>0){s.textContent=t3?t3.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],ee()),ev.nextNode(),a.push({type:2,index:++r});s.append(t[e],ee())}}}else if(8===s.nodeType){if(s.data===t7)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(t6,t+1));)a.push({type:7,index:r}),t+=t6.length-1}}r++}}static createElement(t,e){let i=et.createElement("template");return i.innerHTML=t,i}}function eb(t,e,i=t,s){if(e===e_)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl,n=ei(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t))._$AT(t,i,s),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=eb(t,r._$AS(t,e.values),r,s)),e}class eC{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??et).importNode(e,!0);ev.currentNode=s;let r=ev.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new eA(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new eI(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=ev.nextNode(),n++)}return ev.currentNode=et,s}p(t){let e=0;for(let i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class eA{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=em,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){ei(t=eb(this,t,e))?t===em||null==t||""===t?(this._$AH!==em&&this._$AR(),this._$AH=em):t!==this._$AH&&t!==e_&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):er(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==em&&ei(this._$AH)?this._$AA.nextSibling.data=t:this.$(et.createTextNode(t)),this._$AH=t}g(t){let{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ew.createElement(ey(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let t=new eC(s,this),i=t.u(this.options);t.p(e),this.$(i),this._$AH=t}}_$AC(t){let e=ef.get(t.strings);return void 0===e&&ef.set(t.strings,e=new ew(t)),e}T(t){es(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new eA(this.k(ee()),this.k(ee()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class eS{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=em,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=em}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(void 0===r)(n=!ei(t=eb(this,t,e,0))||t!==this._$AH&&t!==e_)&&(this._$AH=t);else{let s,o;let a=t;for(t=r[0],s=0;s<r.length-1;s++)(o=eb(this,a[i+s],e,s))===e_&&(o=this._$AH[s]),n||=!ei(o)||o!==this._$AH[s],o===em?t=em:t!==em&&(t+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!s&&this.O(t)}O(t){t===em?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class eT extends eS{constructor(){super(...arguments),this.type=3}O(t){this.element[this.name]=t===em?void 0:t}}class eE extends eS{constructor(){super(...arguments),this.type=4}O(t){this.element.toggleAttribute(this.name,!!t&&t!==em)}}class eP extends eS{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=eb(this,t,e,0)??em)===e_)return;let i=this._$AH,s=t===em&&i!==em||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==em&&(i===em||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class eI{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){eb(this,t)}}const eM=t5.litHtmlPolyfillSupport;eM?.(ew,eA),(t5.litHtmlVersions??=[]).push("3.1.0");const ek=(t,e,i)=>{let s=i?.renderBefore??e,r=s._$litPart$;if(void 0===r){let t=i?.renderBefore??null;s._$litPart$=r=new eA(e.insertBefore(ee(),t),t,void 0,i??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class eR extends t2{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ek(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return e_}}eR._$litElement$=!0,eR.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:eR});const eD=globalThis.litElementPolyfillSupport;eD?.({LitElement:eR}),(globalThis.litElementVersions??=[]).push("4.0.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eB={attribute:!0,type:String,converter:tJ,reflect:!1,hasChanged:t0},eF=(t=eB,e,i)=>{let{kind:s,metadata:r}=i,n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(i.name,t),"accessor"===s){let{name:s}=i;return{set(i){let r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t),e}}}if("setter"===s){let{name:s}=i;return function(i){let r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};function eU(t){return(e,i)=>"object"==typeof i?eF(t,e,i):((t,e,i)=>{let s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ez=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i),eL={ATTRIBUTE:1},eO=t=>(...e)=>({_$litDirective$:t,values:e});class eH{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eN="important",eG=" !"+eN,eW=eO(class extends eH{constructor(t){if(super(t),t.type!==eL.ATTRIBUTE||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let s=t[i];return null==s?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){let{style:i}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(let t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(let t in e){let s=e[t];if(null!=s){this.ut.add(t);let e="string"==typeof s&&s.endsWith(eG);t.includes("-")||e?i.setProperty(t,e?s.slice(0,-11):s,e?eN:""):i[t]=s}}return e_}}),e$=eO(class extends eH{constructor(t){if(super(t),t.type!==eL.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.it){for(let i in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[i]&&!this.st?.has(i)&&this.it.add(i);return this.render(e)}let i=t.element.classList;for(let t of this.it)t in e||(i.remove(t),this.it.delete(t));for(let t in e){let s=!!e[t];s===this.it.has(t)||this.st?.has(t)||(s?(i.add(t),this.it.add(t)):(i.remove(t),this.it.delete(t)))}return e_}});let eV=class extends eR{static #t=this.styles=tO`
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    `;firstUpdated(){this.menuHtml?.addEventListener("animationend",t=>{"fadeOut"===t.animationName&&(this._show=!1,this.menuHtml?.classList.remove("hide"),this.requestUpdate())})}sendEvent(t){return()=>{this.dispatchEvent(new Event(t)),this.hide(),this.requestUpdate()}}show(){this._show=!0,this._debounce=Date.now()}hide(){let t=Date.now();t-this._debounce>200&&(this.menuHtml?.classList.add("hide"),this.clearEvents())}render(){let t=this._show?eg`<div class="overlay" @click=${this.hide}></div>`:em;return eg`
        ${t}
        <div class=${e$({menu:!0,show:this._show})} style=${eW({left:`${this.left}px`,top:`${this.top}px`})}>
            <div class="title-bar"></div>
            <div class="options">
                <button style=${eW({display:this.unit?.canMove()?"block":"none"})} @click="${this.sendEvent("move")}">Move</button>
                <button style=${eW({display:this.unit?.canAttack()?"block":"none"})} @click="${this.sendEvent("attack")}">Attack</button>
...
// }
this.selectionManger.reset()}}return!0}}class eK extends l{constructor(t){super({pos:t,vel:L(U(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=J.CloudSheet.toSprite(),this.cloudSprite.scale=t_,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class eY extends I{constructor(t){super(),this.levelData=t}onInitialize(t){this.engine=t,this.add(new eK(L(800,0))),this.add(new eK(L(400,300))),this.add(new eK(L(700,700))),this.board=this.parse(this.levelData),this.add(tS)}onActivate(){this.turnManager.start()}onDeactivate(){// TODO deactivate event handlers on types that have them!!
}parse(t){let e=new tA(t.height,t.width,this);this.selectionManager=new tk(e),this.uiManager=new eq(this.engine),// TODO support arbitrary players
this.players=[new tM(t.players[0],this.engine,this.selectionManager,this.uiManager,e),new eZ(t.players[1],this.selectionManager,e)],this.turnManager=new eX(this.engine,this.players,this.selectionManager,10);for(let i=0;i<t.height;i++)for(let s=0;s<t.width;s++){let r=t.data[s+i*t.width],n=r.charAt(0),o=null;if(3===r.length){let t="K"===r.charAt(1)?"Knight":"Spider",n=+r.charAt(2)-1;o=new tP(s,i,t,e,this.players[n]),this.add(o)}let a=e.getCell(s,i);a&&(a.terrain=n,o&&a.addUnit(o))}return e}}const ej={name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","GS2","G","GS2","GK1","G","GS2","G","G","GS2","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","G","G","G","G"]},eQ=new y({width:800,height:800,displayMode:m.FitScreenAndFill,antialiasing:!1,suppressHiDPIScaling:!0,configurePerformanceCanvas2DFallback:{allow:!1}}),eJ=new class extends I{onInitialize(t){t.input.pointers.primary.once("down",()=>{t.goToScene("tutorial")}),this.add(new eK(L(800,0))),this.add(new eK(L(400,300))),this.add(new eK(L(700,700))),this.title=new l({pos:L(400,400),coordPlane:_.Screen}),this.title.scale=t_,this.title.graphics.use(tu),this.title.actions.repeatForever(t=>{t.easeBy(L(0,-30*t_.y),1e3,f.EaseInOutQuad).easeBy(L(0,30*t_.y),1e3,f.EaseInOutQuad)}),this.add(this.title),this.instructions=new l({pos:L(400,600),coordPlane:_.Screen});let e=new x({family:"notjamslab14",size:32*t_.x,unit:w.Px,color:p.White,baseAlign:u.Top,quality:4,shadow:{offset:L(10,10).scale(t_),color:p.Black}}),i=new R({text:"Click to Play!",font:e});this.instructions.graphics.use(i),this.instructions.actions.repeatForever(t=>{// ctx.blink(300, 300, 2);
t.rotateTo(Math.PI/32,.2),t.rotateTo(-Math.PI/32,.2)}),this.add(this.instructions)}};eQ.addScene("start",eJ);const e0=new class extends eY{// TODO cinematic?
constructor(){super(ej)}onInitialize(t){super.onInitialize(t);let e=this.board.cells[0].unit;e&&(this.focus=new l({pos:e.pos.add(L(16,16).scale(t_)),width:32,height:32,anchor:L(0,1),z:10}),this.focus.graphics.opacity=0,this.engine.add(this.focus))}async moveToUnit1(){let t=this.board.getCell(0,0).unit.pos.add(L(16,16).scale(t_));await this.focus.actions.easeTo(t,1e3,f.EaseInOutCubic).toPromise()}async selectUnit1(){this.selectionManager.selectPlayer(this.players[0]);let t=this.board.getCell(0,0).unit,e=this.uiManager.showUnitMenu(t,{move:()=>{},attack:()=>{},pass:()=>{}});await D.delay(1e3),e.hide(),this.selectionManager.selectUnit(t,"move");let i=this.selectionManager.findMovementRange(t),s=this.board.getCell(2,0),r=this.selectionManager.findPath(s,i);this.selectionManager.showHighlight(r,"path"),await D.delay(1e3),await this.selectionManager.selectDestinationAndMove(t,s),e.show(),await D.delay(2e3),this.selectionManager.selectUnit(t,"attack");let n=this.selectionManager.findAttackRange(t);this.selectionManager.showHighlight(n,"attack"),await D.delay(1e3);let o=this.board.getCell(2,1);this.selectionManager.showHighlight([o.pathNode],"path"),e.hide(),this.selectionManager.reset();let a=this.board.getCell(2,1).unit;t.attack(a),await D.delay(2e3)}async highlightEnemyRange(){let t=this.players[0],e=this.board.getCell(2,1);await t.highlightUnitRange(e),await D.delay(1e3),this.selectionManager.reset()}async moveToUnit2(){let t=this.board.getCell(0,1).unit.pos.add(L(16,16).scale(t_));await this.focus.actions.easeTo(t,1e3,f.EaseInOutCubic).toPromise()}async showText(t){let e=tt.getSprite(t,0);e.scale=t_,this.focus.graphics.use(e),await this.focus.actions.fade(1,200).toPromise()}async hideText(){await this.focus.actions.fade(0,200).toPromise()}async onActivate(){this.camera.strategy.lockToActor(this.focus),this.camera.zoomOverTime(1.25,1e3,f.EaseInOutCubic),await D.delay(1e3),// hey look at all these spiders!
...
await this.moveToUnit2(),await this.showText(5),await this.focus.actions.delay(1e3),await this.hideText(),await this.highlightEnemyRange(),await this.showText(6),await this.focus.actions.delay(2e3),await this.hideText(),await this.showText(7),await this.focus.actions.delay(7e3),await this.hideText(),this.camera.zoomOverTime(1,1e3,f.EaseInOutCubic),this.engine.goToScene("level1")}};eQ.addScene("tutorial",e0);const e1=new eY({name:"Gentle Plains",width:6,height:6,maxTurns:10,players:["human","computer"],data:["GK1","G","G","G","G","GK1","G","G","G","G","G","G","G","G","W","W","G","G","G","G","W","W","G","G","G","G","W","W","G","G","GS2","GS2","GS2","GS2","GS2","GS2"]});eQ.addScene("level1",e1),eQ.start(tp).then(()=>{eQ.goToScene("start")});//# sourceMappingURL=index.2074a52d.js.map

//# sourceMappingURL=index.2074a52d.js.map
