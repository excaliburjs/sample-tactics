 ...
 * @preserve
 *//******/var e={/***/4662:/***/(t,e,i)=>{i(3430);var s=i(8791);t.exports=s("Array","sort");/***/},/***/8343:/***/(t,e,i)=>{i(4769);var s=i(9276);t.exports=s.Object.keys;/***/},/***/7111:/***/(t,e,i)=>{var s=i(6733),r=i(9821),n=TypeError;// `Assert: IsCallable(argument) is true`
...
/******/function s(t){/******/// Check if module is in cache
/******/var r=i[t];/******/if(void 0!==r)/******/return r.exports;/******/// Create a new module (and put it into the cache)
/******/var n=i[t]={/******/id:t,/******/// no module.loaded needed
/******/exports:{}};/******//******/// Return the exports of the module
/******/return(/******//******/// Execute the module function
/******/e[t].call(n.exports,n,n.exports,s),n.exports);/******/}/******/// getDefaultExport function for compatibility with non-harmony modules
/******/s.n=t=>{/******/var e=t&&t.__esModule?/******/()=>t.default:/******/()=>t;/******/return /******/s.d(e,{a:e}),e;/******/},/******/// define getter functions for harmony exports
/******/s.d=(t,e)=>{/******/for(var i in e)/******/s.o(e,i)&&!s.o(t,i)&&/******/Object.defineProperty(t,i,{enumerable:!0,get:e[i]});/******/},/******/s.g=function(){/******/if("object"==typeof globalThis)return globalThis;/******/try{/******/return this||Function("return this")();/******/}catch(t){/******/if("object"==typeof window)return window;/******/}/******/}(),/******/s.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e),/******/// define __esModule on exports
/******/s.r=t=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&/******/Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),/******/Object.defineProperty(t,"__esModule",{value:!0});/******/};/******//************************************************************************/var r={};// This entry need to be wrapped in an IIFE because it need to be isolated against other modules in the chunk.
(()=>{// EXPORTS
s.d(r,{fWn:()=>/* reexport */sB,Ia8:()=>/* reexport */s_,rqv:()=>/* reexport */r$,hLI:()=>/* reexport */sM,yyv:()=>/* reexport */rx,tX5:()=>/* reexport */t1,vtX:()=>/* reexport */sz,r7K:()=>/* reexport */st,lCh:()=>/* reexport */s3,cE4:()=>/* reexport */eP,fwF:()=>/* reexport */Animation,sce:()=>/* reexport */ta,AQ6:()=>/* reexport */rd,_c7:()=>/* reexport */th,KUs:()=>/* reexport */ro,Ajp:()=>/* reexport */io,dkO:()=>/* reexport */O,RDh:()=>/* reexport */tn,_H9:()=>/* reexport */ti,mxs:()=>/* reexport */sT,OmD:()=>/* reexport */i8,kBf:()=>/* reexport */ex,C4F:()=>/* reexport */Y,NQt:()=>/* reexport */rB,JjN:()=>/* reexport */rM,EK_:()=>/* reexport */U,V1s:()=>/* reexport */sJ,xHm:()=>/* reexport */sQ,Xz7:()=>/* reexport */ig,Cdc:()=>/* reexport */sc,FKn:()=>/* reexport */i1,SUY:()=>/* reexport */rU,ab2:()=>/* reexport */iJ,GfZ:()=>/* reexport */i0,YMS:()=>/* reexport */i$,oyv:()=>/* reexport */i7,aUb:()=>/* reexport */i2,SdD:()=>/* reexport */tJ,JUv:()=>/* reexport */iG,jEj:()=>/* reexport */rQ,TFq:()=>/* reexport */i3,HDU:()=>/* reexport */tj,R_y:()=>/* reexport */t$,ydN:()=>/* reexport */K,t50:()=>/* reexport */tQ,s$$:()=>/* reexport */rl,v2G:()=>/* reexport */Z,Ilk:()=>/* reexport */ef,s9i:()=>/* reexport */rP,dxL:()=>/* reexport */tc,LLX:()=>/* reexport */rE,wA2:()=>/* reexport */iU,R_p:()=>/* reexport */ij,IQ$:()=>/* reexport */ru,I5F:()=>/* reexport */t8,X8$:()=>/* reexport */ra,FR6:()=>/* reexport */tY,U8o:()=>/* reexport */tK,kbG:()=>/* reexport */j,iS_:()=>/* reexport */t2,cGG:()=>/* reexport */rI,RPN:()=>/* reexport */sW,skb:()=>/* reexport */rf,SLU:()=>/* reexport */eN,RdJ:()=>/* reexport */Q,cNu:()=>/* reexport */sP,gU7:()=>/* reexport */iP,LSk:()=>/* reexport */sI,Nmp:()=>/* reexport */tr,d1Y:()=>/* reexport */X,xrL:()=>/* reexport */iZ,sRW:()=>/* reexport */iY,cmV:()=>/* binding */na,qWz:()=>/* reexport */sS,N0Q:()=>/* reexport */sA,q8b:()=>/* reexport */sp,ynB:()=>/* reexport */i4,jT9:()=>/* reexport */sY,wAz:()=>/* reexport */tl,D4V:()=>/* reexport */rq,NLr:()=>/* reexport */rV,N6H:()=>/* reexport */t4,W1A:()=>/* reexport */t3,JHW:()=>/* reexport */sn,ZZ$:()=>/* reexport */sr,v2K:()=>/* reexport */s7,pBf:()=>/* reexport */rX,vpe:()=>/* reexport */tS,GMl:()=>/* reexport */z,zW2:()=>/* reexport */tf,B0K:()=>/* reexport */im,Nv7:()=>/* reexport */is,C_p:()=>/* reexport */ie,MUA:()=>/* reexport */t9,xqU:()=>/* reexport */t5,pTp:()=>/* reexport */sE,vUK:()=>/* reexport */tC,j9l:()=>/* reexport */sR,Zxw:()=>/* reexport */sL,v51:()=>/* reexport */sk,Hdx:()=>/* reexport */ts,Z$d:()=>/* reexport */tt,iqV:()=>/* reexport */rz,o$7:()=>/* reexport */rR,olM:()=>/* reexport */ey,Zm$:()=>/* reexport */tT,$QH:()=>/* reexport */tR,i78:()=>/* reexport */tF,nJg:()=>/* reexport */Gamepad,h6u:()=>/* reexport */tG,hts:()=>/* reexport */tW,j88:()=>/* reexport */tH,VME:()=>/* reexport */tN,fy2:()=>/* reexport */t6,nt:()=>/* reexport */r6,Ukr:()=>/* reexport */rD,zsu:()=>/* reexport */ek,oA6:()=>/* reexport */sl,TVh:()=>/* reexport */rc,TwZ:()=>/* reexport */sa,GTT:()=>/* reexport */sh,xxj:()=>/* reexport */rm,XdK:()=>/* reexport */tq,Jmb:()=>/* reexport */q,cXo:()=>/* reexport */eU,Dm5:()=>/* reexport */t0,IIB:()=>/* reexport */ty,ebW:()=>/* reexport */rG,zI0:()=>/* reexport */$,LYD:()=>/* reexport */ry,cEG:()=>/* reexport */rw,SEl:()=>/* reexport */rY,t9V:()=>/* reexport */rK,ez5:()=>/* reexport */ei,N1d:()=>/* reexport */es,R8U:()=>/* reexport */N,SKZ:()=>/* reexport */tE,__J:()=>/* reexport */rZ,RI$:()=>/* reexport */sj,x12:()=>/* reexport */ns,ccz:()=>/* reexport */iQ,aNw:()=>/* reexport */iT,XrL:()=>/* reexport */iS,xwn:()=>/* reexport */sK,dNK:()=>/* reexport */sZ,ini:()=>/* reexport */H,YdH:()=>/* reexport */t7,F5T:()=>/* reexport */e6,y3G:()=>/* reexport */eE,l57:()=>/* reexport */V,xn0:()=>/* reexport */iy,t2V:()=>/* reexport */sF,uxB:()=>/* reexport */iW,cpd:()=>/* reexport */rn,fiy:()=>/* reexport */sf,$XZ:()=>/* reexport */sv,UG6:()=>/* reexport */tp,uqK:()=>/* reexport */iw,STE:()=>/* reexport */ib,y$z:()=>/* reexport */iH,mAD:()=>/* reexport */rb,sOq:()=>/* reexport */iV,hUw:()=>/* reexport */sN,_0G:()=>/* reexport */rj,Sqs:()=>/* reexport */ni,hpZ:()=>/* reexport */r_,Vol:()=>/* reexport */rg,vYX:()=>/* reexport */td,wIZ:()=>/* reexport */iD,cBi:()=>/* reexport */rF,c30:()=>/* reexport */rC,MPV:()=>/* reexport */t_,RFv:()=>/* reexport */su,Ux6:()=>/* reexport */PointerEvent,rxy:()=>/* reexport */rL,I$c:()=>/* reexport */W,kfC:()=>/* reexport */rv,VjY:()=>/* reexport */tg,mgq:()=>/* reexport */nr,YVA:()=>/* reexport */i9,Kgp:()=>/* reexport */e3,HH$:()=>/* reexport */tZ,M_d:()=>/* reexport */tk,rgh:()=>/* reexport */tM,Ra6:()=>/* reexport */tO,KhR:()=>/* reexport */tI,BS5:()=>/* reexport */tz,xhz:()=>/* reexport */tX,xOq:()=>/* reexport */tD,a9j:()=>/* reexport */tB,bHk:()=>/* reexport */tU,CgK:()=>/* reexport */tP,cuY:()=>/* reexport */tL,kvE:()=>/* reexport */iq,SBu:()=>/* reexport */e0,AE_:()=>/* reexport */rt,ctO:()=>/* reexport */re,OLH:()=>/* reexport */s$,kky:()=>/* reexport */er,nSF:()=>/* reexport */i_,zHn:()=>/* reexport */iK,zwx:()=>/* reexport */rh,AeJ:()=>/* reexport */sd,hLz:()=>/* reexport */si,D9g:()=>/* reexport */s9,wA:()=>/* reexport */sg,jhr:()=>/* reexport */sm,GVs:()=>/* reexport */ir,_zO:()=>/* reexport */eB,LXZ:()=>/* reexport */eF,w6$:()=>/* reexport */sy,mhV:()=>/* reexport */sx,MOD:()=>/* reexport */J,kwd:()=>/* reexport */sb,Lmr:()=>/* reexport */sw,xsS:()=>/* reexport */rS,K5l:()=>/* reexport */rA,lLr:()=>/* reexport */Screen,Z$r:()=>/* reexport */et,IXb:()=>/* reexport */sO,SGH:()=>/* reexport */rT,SMj:()=>/* reexport */tm,L34:()=>/* reexport */no,exe:()=>/* reexport */eZ,bnF:()=>/* reexport */i6,MFA:()=>/* reexport */G,$uU:()=>/* reexport */iA,Sap:()=>/* reexport */iC,jyi:()=>/* reexport */eL,E03:()=>/* reexport */eH,V6q:()=>/* reexport */eO,rg2:()=>/* reexport */rO,DVW:()=>/* reexport */iv,nVo:()=>/* reexport */sX,F6N:()=>/* reexport */nt,xP7:()=>/* reexport */s5,Odq:()=>/* reexport */ri,Zif:()=>/* reexport */to,ZGJ:()=>/* reexport */iO,MJk:()=>/* reexport */rH,xvT:()=>/* reexport */Text,PHM:()=>/* reexport */te,dpR:()=>/* reexport */ez,n9L:()=>/* reexport */sq,KwO:()=>/* reexport */sV,SxM:()=>/* reexport */sG,B7y:()=>/* reexport */sH,x7r:()=>/* reexport */rW,wx7:()=>/* reexport */iz,Uvn:()=>/* reexport */iN,OFT:()=>/* reexport */iX,xzN:()=>/* reexport */s2,CcZ:()=>/* reexport */s0,M5Z:()=>/* reexport */en,ZrN:()=>/* reexport */tw,OWs:()=>/* reexport */eg,dF9:()=>/* reexport */ik,oZy:()=>/* reexport */eK,rD2:()=>/* reexport */eY,VHo:()=>/* reexport */tV,ohE:()=>/* reexport */ia,R$E:()=>/* reexport */ix,xQN:()=>/* reexport */tu,AdJ:()=>/* reexport */WheelEvent,q3I:()=>/* reexport */rs,Pab:()=>/* reexport */el,uZ5:()=>/* reexport */eh,McK:()=>/* reexport */tA,F9c:()=>/* reexport */eo,k0b:()=>/* reexport */so,hnT:()=>/* reexport */r0,RSJ:()=>/* reexport */r3,Mku:()=>/* reexport */r2,h90:()=>/* reexport */r9,rms:()=>/* reexport */r4,ErP:()=>/* reexport */rJ,aVg:()=>/* reexport */r5,lPc:()=>/* reexport */r1,Z8E:()=>/* reexport */se,_N2:()=>/* reexport */s4,yFn:()=>/* reexport */s6,lNv:()=>/* reexport */ss,cu9:()=>/* reexport */sU,MZQ:()=>/* reexport */iI,FUM:()=>/* reexport */iM,BxR:()=>/* reexport */e8,vdf:()=>/* reexport */ep,iaL:()=>/* reexport */e_,w6H:()=>/* reexport */eu,Q4c:()=>/* reexport */iF,Xxe:()=>/* reexport */ea,Uxb:()=>/* reexport */ed,Yr5:()=>/* reexport */ec,Bhw:()=>/* reexport */em,yOA:()=>/* reexport */tv});// NAMESPACE OBJECT: ./Events.ts
var t,e,i,n,o,a,h,l,d,c,u,p,_,g,m,f,v,x,y,w,b,C,A,S,T,E,P,I,R,F,B,M,D,k,L,z,U,O,H,N,W,G,V,q,X,Z,K,Y,$,j,Q,J,tt,te,ti,ts,tr,tn,to,ta,th,tl,td,tc,tu,tp,t_,tg,tm,tf={};s.r(tf),s.d(tf,{ActivateEvent:()=>t1,CollisionEndEvent:()=>tJ,CollisionPostSolveEvent:()=>tj,CollisionPreSolveEvent:()=>t$,CollisionStartEvent:()=>tQ,ContactEndEvent:()=>tY,ContactStartEvent:()=>tK,DeactivateEvent:()=>t2,EnterTriggerEvent:()=>t4,EnterViewPortEvent:()=>t3,EventTypes:()=>z,ExitTriggerEvent:()=>t9,ExitViewPortEvent:()=>t5,GameEvent:()=>tT,GameStartEvent:()=>tR,GameStopEvent:()=>tF,GamepadAxisEvent:()=>tG,GamepadButtonEvent:()=>tW,GamepadConnectEvent:()=>tH,GamepadDisconnectEvent:()=>tN,HiddenEvent:()=>tq,InitializeEvent:()=>t0,KillEvent:()=>tE,PostCollisionEvent:()=>tZ,PostDebugDrawEvent:()=>tk,PostDrawEvent:()=>tM,PostFrameEvent:()=>tO,PostKillEvent:()=>tI,PostUpdateEvent:()=>tz,PreCollisionEvent:()=>tX,PreDebugDrawEvent:()=>tD,PreDrawEvent:()=>tB,PreFrameEvent:()=>tU,PreKillEvent:()=>tP,PreUpdateEvent:()=>tL,VisibleEvent:()=>tV});// NAMESPACE OBJECT: ./Graphics/Context/webgl-util.ts
var tv={};s.r(tv),s.d(tv,{getAttributeComponentSize:()=>eq,getAttributePointerType:()=>eX,getGlTypeSizeBytes:()=>eV});// NAMESPACE OBJECT: ./Util/DrawUtil.ts
var tx={};s.r(tx),s.d(tx,{circle:()=>iu,line:()=>ih,point:()=>il,roundRect:()=>ic,vector:()=>id});// NAMESPACE OBJECT: ./Input/Index.ts
var ty={};s.r(ty),s.d(ty,{Axes:()=>O,Buttons:()=>U,Gamepad:()=>Gamepad,Gamepads:()=>t6,KeyEvent:()=>ei,Keyboard:()=>es,Keys:()=>N,NativePointerButton:()=>tp,PointerButton:()=>t_,PointerComponent:()=>su,PointerEvent:()=>PointerEvent,PointerEventReceiver:()=>rL,PointerScope:()=>W,PointerSystem:()=>rv,PointerType:()=>tg,WheelDeltaMode:()=>tu,WheelEvent:()=>WheelEvent});// NAMESPACE OBJECT: ./Util/Index.ts
var tw={};/**
 * Polyfill adding function
 */function tb(){/* istanbul ignore next */if("undefined"==typeof window&&(window={audioContext:function(){}}),"undefined"==typeof window||window.requestAnimationFrame||(window.requestAnimationFrame=window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(t){window.setInterval(t,1e3/60)}),"undefined"==typeof window||window.cancelAnimationFrame||(window.cancelAnimationFrame=window.webkitCancelAnimationFrame||window.mozCancelAnimationFrame||function(){}),"undefined"!=typeof window&&!window.AudioContext){if(window.webkitAudioContext){let t=window.webkitAudioContext,e=t.prototype.decodeAudioData;window.webkitAudioContext.prototype.decodeAudioData=function(t){return new Promise((i,s)=>{e.call(this,t,i,s)})}}window.AudioContext=window.AudioContext||window.webkitAudioContext||window.mozAudioContext||window.msAudioContext||window.oAudioContext}"undefined"==typeof window||window.devicePixelRatio||(window.devicePixelRatio=window.devicePixelRatio||1)}s.r(tw),s.d(tw,{ConsoleAppender:()=>t8,DrawUtil:()=>tx,EasingFunctions:()=>sp,LogLevel:()=>H,Logger:()=>t7,Observable:()=>iH,ScreenAppender:()=>et,addItemToArray:()=>eb,contains:()=>eA,delay:()=>eT,fail:()=>eS,getPosition:()=>ew,removeItemFromArray:()=>eC}),s(4662),s(8343);/**
 ...
 */class tR extends tT{constructor(t){super(),this.target=t}}/**
 * The 'stop' event is emitted on engine when has been stopped and will no longer take input, update or draw.
 */class tF extends tT{constructor(t){super(),this.target=t}}/**
 * The 'predraw' event is emitted on actors, scenes, and engine before drawing starts. Actors' predraw happens inside their graphics
 * transform so that all drawing takes place with the actor as the origin.
 *
 */class tB extends tT{constructor(t,e,i){super(),this.ctx=t,this.delta=e,this.target=i}}/**
 * The 'postdraw' event is emitted on actors, scenes, and engine after drawing finishes. Actors' postdraw happens inside their graphics
 * transform so that all drawing takes place with the actor as the origin.
 *
 */class tM extends tT{constructor(t,e,i){super(),this.ctx=t,this.delta=e,this.target=i}}/**
 * The 'predebugdraw' event is emitted on actors, scenes, and engine before debug drawing starts.
 */class tD extends tT{constructor(t,e){super(),this.ctx=t,this.target=e}}/**
...
this._buttonsDown=Array(16),this._buttonsUp=Array(16)}/**
     ...
     */i[i.RightStickY=3]="RightStickY",(n=H||(H={}))[n.Debug=0]="Debug",n[n.Info=1]="Info",n[n.Warn=2]="Warn",n[n.Error=3]="Error",n[n.Fatal=4]="Fatal";/**
 ...
 * @param milliseconds
 * @param clock
 */function eT(t,e){var i;let s=new ey,r=null!==(i=null==e?void 0:e.schedule.bind(e))&&void 0!==i?i:setTimeout;return r(()=>{s.resolve()},t),s.promise}(d=V||(V={}))[d.X=12]="X",d[d.Y=13]="Y";/**
 ...
 */class ek{isStale(){return this._transformStale}/**
     ...
     */get origin(){return this._origin}set origin(t){this._origin=eM(t,()=>{this._transformStale=!0}),this._transformStale=!0}constructor(t){var e,i,s,r,n,o;this.id=ek._ID++,this.transform=eP.identity(),this.tint=null,this._transformStale=!0,/**
 ...
 */ez.filtering=q.Blended,ez._MAX_TEXTURE_SIZE=4096;class eU{/**
     ...
     */constructor(t,e=!1,i){this.path=t,this._logger=t7.getInstance(),/**
         ...
         */this.ready=this._readyFuture.promise,this._resource=new eB(t,"blob",e),this.filtering=i,(t.endsWith(".svg")||t.endsWith(".gif"))&&this._logger.warn(`Image type is not fully supported, you may have mixed results ${t}. Fully supported: jpg, bmp, and png`)}/**
...
this._addImageAsTexture(t);let p=(null==t?void 0:t.width)||s||0,_=(null==t?void 0:t.height)||r||0,g=[0,0,null!==(l=null!=s?s:null==t?void 0:t.width)&&void 0!==l?l:0,null!==(d=null!=r?r:null==t?void 0:t.height)&&void 0!==d?d:0],m=[null!=e?e:1,null!=i?i:1];void 0!==n&&void 0!==o&&void 0!==a&&void 0!==h&&(g=[null!=e?e:1,null!=i?i:1,null!==(c=null!=s?s:null==t?void 0:t.width)&&void 0!==c?c:0,null!==(u=null!=r?r:null==t?void 0:t.height)&&void 0!==u?u:0],m=[n,o],p=a,_=h),e=g[0],i=g[1];let f=g[2],v=g[3],x=this._context.getTransform(),y=this._context.opacity,w=this._context.snapToPixel,b=em(m[0],m[1]),C=em(m[0]+p,m[1]),A=em(m[0],m[1]+_),S=em(m[0]+p,m[1]+_);b=x.multiply(b),C=x.multiply(C),A=x.multiply(A),S=x.multiply(S),w&&(b.x=~~(b.x+e8),b.y=~~(b.y+e8),C.x=~~(C.x+e8),C.y=~~(C.y+e8),A.x=~~(A.x+e8),A.y=~~(A.y+e8),S.x=~~(S.x+e8),S.y=~~(S.y+e8));let T=this._context.tint,E=this._getTextureIdForImage(t),P=t.width||p,I=t.height||_,R=e/P,F=i/I,B=(e+f-.01)/P,M=(i+v-.01)/I,D=this._layout.vertexBuffer.bufferData;// (0, 0) - 0
D[this._vertexIndex++]=b.x,D[this._vertexIndex++]=b.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=R,D[this._vertexIndex++]=F,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (0, 1) - 1
D[this._vertexIndex++]=A.x,D[this._vertexIndex++]=A.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=R,D[this._vertexIndex++]=M,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (1, 0) - 2
D[this._vertexIndex++]=C.x,D[this._vertexIndex++]=C.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=B,D[this._vertexIndex++]=F,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a,// (1, 1) - 3
D[this._vertexIndex++]=S.x,D[this._vertexIndex++]=S.y,D[this._vertexIndex++]=y,D[this._vertexIndex++]=B,D[this._vertexIndex++]=M,D[this._vertexIndex++]=E,D[this._vertexIndex++]=T.r/255,D[this._vertexIndex++]=T.g/255,D[this._vertexIndex++]=T.b/255,D[this._vertexIndex++]=T.a}hasPendingDraws(){return 0!==this._imageCount}flush(){// nothing to draw early exit
...
this._tracks=[],this._wasPlayingOnHidden=!1,this._playbackRate=1,this._audioContext=io.create(),this._resource=new eB("",im.type.arraybuffer),t))if(/**
...
for(let t in this._warningTest)this._warningTest[t]()||t7.getInstance().warn("Warning browser feature missing, Excalibur will have reduced performance:",t);return!0}}/**
     ...
     * collision events.
     */p.Fixed="Fixed";let iI=5,iR={},iF=()=>{for(let t in iR)iR[t]=0},iB=(t,e)=>{let i=tC.isEnabled("suppress-obsolete-message");iR[t]<iI&&!i&&(t7.getInstance().warn(t),console.trace&&e.showStackTrace&&console.trace()),iR[t]++};/**
 * Obsolete decorator for marking Excalibur methods obsolete, you can optionally specify a custom message and/or alternate replacement
 * method do the deprecated one. Inspired by https://github.com/jayphelps/core-decorators.js
 */function iM(t){return t={message:"This feature will be removed in future versions of Excalibur.",alternateMethod:null,showStackTrace:!1,...t},function(e,i,s){if(s&&!("function"==typeof s.value||"function"==typeof s.get||"function"==typeof s.set))throw SyntaxError("Only classes/functions/getters/setters can be marked as obsolete");let r=`${e.name||""}${e.name&&i?".":""}${i||""}`,n=`${r} is marked obsolete: ${t.message}`+(t.alternateMethod?` Use ${t.alternateMethod} instead`:"");iR[n]||(iR[n]=0);// If descriptor is null it is a class
let o=s?{...s}:e;return s?(s&&s.value?o.value=function(){return iB(n,t),s.value.apply(this,arguments)}:(s&&s.get&&(o.get=function(){return iB(n,t),s.get.apply(this,arguments)}),s&&s.set&&(o.set=function(){return iB(n,t),s.set.apply(this,arguments)})),o):// with es2015 classes we need to change our decoration tactic
class extends o{constructor(...e){iB(n,t),super(...e)}}}}(_=K||(K={})).Arcade="arcade",_.Realistic="realistic",(g=Y||(Y={}))[g.DynamicAABBTree=0]="DynamicAABBTree",(m=$||($={}))[m.Euler=0]="Euler";/**
 ...
 *//* istanbul ignore next */class iD{static get gravity(){return iD.acc}static set gravity(t){iD.acc=t}/**
     ...
     */static useArcadePhysics(){iD.collisionResolutionStrategy=K.Arcade}/**
     * Configures Excalibur to use rigid body physics. Rigid body physics allows for complicated
     * simulated physical interactions.
     */static useRealisticPhysics(){iD.collisionResolutionStrategy=K.Realistic}static get dynamicTreeVelocityMultiplyer(){return iD.dynamicTreeVelocityMultiplier}static set dynamicTreeVelocityMultiplyer(t){iD.dynamicTreeVelocityMultiplier=t}}/**
 ...
 */iD.broadphaseStrategy=Y.DynamicAABBTree,/**
 ...
 * simulated physical interactions.
 */iD.collisionResolutionStrategy=K.Arcade,/**
 ...
 */class iH{constructor(){this.observers=[],this.subscriptions=[]}/**
     ...
     */clear(){this.observers.length=0,this.subscriptions.length=0}}class iN extends iU{constructor(){super(...arguments),this.type="ex.transform",this._transform=new iz,this._addChildTransform=t=>{let e=t.get(iN);e&&(e._transform.parent=this._transform)},/**
...
l.pos=l.pos.add(l.dir.scale(-2*iD.surfaceEpsilon));let d=new eg(1/0,1/0);if(this._dynamicCollisionTree.rayCastQuery(l,s+2*iD.surfaceEpsilon,e=>{if(!this._pairExists(t,e)&&iV.canCollide(t,e)){let t=e.rayCast(l,s+10*iD.surfaceEpsilon);if(t){let i=t.sub(h);i.size<d.size&&(d=i,r=e)}}return!1}),r&&eg.isValid(d)){let s=new iV(t,r);this._pairs.has(s.id)||(this._pairs.add(s.id),this._collisionPairCache.push(s));// move the fast moving object to the other body
 ...
 */class i8 extends iU{constructor(t){var e,i,s;super(),this.type="ex.body",this.dependencies=[iN,iW],this.id=tA("body",i8._ID++),this.events=new tS,this._oldTransform=new iz,/**
 ...
 * @param graphic
 */function so(t){return!!t.tick}sn._ID=0;class sa{constructor(t,e){this._options=t,this._graphics=e,this.graphics=[]}get name(){return this._options.name}hide(t){if(t){let e=null;e=t instanceof ek?t:this._graphics.getGraphic(t),this.graphics=this.graphics.filter(t=>t.graphic!==e),this._graphics.recalculateBounds()}else this.graphics.length=0}/**
 ...
 */class sB{constructor(t){this._entity=t,this._queue=new s_(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     ...
     */follow(t,e){return void 0===e?this._queue.add(new sR(this._entity,t)):this._queue.add(new sR(this._entity,t,e)),this}/**
     ...
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sC(()=>{t()}))});return t}}class sM extends iU{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iN,iW]}onAdd(t){this._ctx=new sB(t)}onRemove(){this._ctx=null}/**
...
i[t]=s,i[t+1]=r}}return this._chachedText=t,this._chachedLines=i,this._cachedRenderWidth=e,i}}class sk{static measureText(t,e,i){let s=sD.getHashCode(e,t);if(sk._MEASURE_CACHE.has(s))return sk._MEASURE_CACHE.get(s);sk._LOGGER.debug("Font text measurement cache miss");let r=e.measureTextWithoutCache(t,i);return sk._MEASURE_CACHE.set(s,r),r}static getTextInstance(t,e,i){let s=sD.getHashCode(e,t,i),r=sk._TEXT_CACHE.get(s);return r||(r=new sD(e,t,i),sk._TEXT_CACHE.set(s,r),sk._LOGGER.debug("Font text instance cache miss")),// Cache the bitmap for certain amount of time
sk._TEXT_USAGE.set(r,performance.now()),r}static checkAndClearCache(){let t=[],e=new Set;for(let[i,s]of sk._TEXT_USAGE.entries())if(s+100<performance.now())sk._LOGGER.debug(`Text cache entry timed out ${i.text}`),t.push(i),i.dispose();else{let t=i.getHashCode(!1);e.add(t)}for(let[e]of(// Deferred removal of text instances
t.forEach(t=>{sk._TEXT_USAGE.delete(t)}),// Regenerate text instance cache
this._TEXT_CACHE.clear(),this._TEXT_USAGE.entries()))this._TEXT_CACHE.set(e.getHashCode(),e);// Regenerated measurement cache
let i=new Map;for(let t of e)sk._MEASURE_CACHE.has(t)&&i.set(t,sk._MEASURE_CACHE.get(t));this._MEASURE_CACHE.clear(),this._MEASURE_CACHE=i}static get cacheSize(){return sk._TEXT_USAGE.size}/**
     * Force clear all cached text bitmaps
     */static clearCache(){for(let[t]of sk._TEXT_USAGE.entries())t.dispose();sk._TEXT_USAGE.clear(),sk._TEXT_CACHE.clear(),sk._MEASURE_CACHE.clear()}}sk._LOGGER=t7.getInstance(),sk._TEXT_USAGE=new Map,sk._TEXT_CACHE=new Map,sk._MEASURE_CACHE=new Map;/**
 * Represents a system or web font in Excalibur
 *
 * If no options specified, the system sans-serif 10 pixel is used
 *
 * If loading a custom web font be sure to have the font loaded before you use it https://erikonarheim.com/posts/dont-test-fonts/
 */class sL extends ek{constructor(t={}){var e,i,s,r,n,o,a,h,l,d,c,u,p,_,g,m,f,v,x;super(t),/**
...
let i=null!==(e=this.origin)&&void 0!==e?e:this._textBounds.center;t.translate(i.x,i.y),t.rotate(this.rotation),t.translate(-i.x,-i.y)}_flip(t){this.flipHorizontal&&(t.translate(this._textBounds.width/this.scale.x,0),t.scale(-1,1)),this.flipVertical&&(t.translate(0,-this._textBounds.height/2/this.scale.y),t.scale(1,-1))}measureTextWithoutCache(t,e){return this._textMeasurement.measureText(t,e)}/**
     ...
     * @param text
     * @returns BoundingBox
     */measureText(t,e){return sk.measureText(t,this,e)}_postDraw(t){t.restore()}render(t,e,i,s,r,n){let o=sk.getTextInstance(e,this,i);// Apply affine transformations
 ...
 */class Text extends ek{constructor(t){var e,i;super(t),this._text="",this._textWidth=0,this._textHeight=0,// This order is important font, color, then text
 ...
 */class sz extends sn{/**
     ...
     */set angularVelocity(t){this.motion.angularVelocity=t}get scale(){return this.get(iN).scale}set scale(t){this.get(iN).scale=t}get anchor(){return this._anchor}set anchor(t){this._anchor=eM(t,t=>this._handleAnchorChange(t)),this._handleAnchorChange(t)}_handleAnchorChange(t){this.graphics&&(this.graphics.anchor=t)}/**
...
/**
     ...
     */constructor(t){super(),this.events=new tS,/**
         ...
         */this._anchor=eM(eg.Half,t=>this._handleAnchorChange(t)),/**
         * Convenience reference to the global logger
         */this.logger=t7.getInstance(),/**
         * Draggable helper
         */this._draggable=!1,this._dragging=!1,this._pointerDragStartHandler=()=>{this._dragging=!0},this._pointerDragEndHandler=()=>{this._dragging=!1},this._pointerDragMoveHandler=t=>{this._dragging&&(this.pos=t.worldPos)},this._pointerDragLeaveHandler=t=>{this._dragging&&(this.pos=t.worldPos)};let{name:e,x:i,y:s,pos:r,coordPlane:n,scale:o,width:a,height:h,radius:l,collider:d,vel:c,acc:u,rotation:p,angularVelocity:_,z:g,color:m,visible:f,anchor:v,collisionType:x,collisionGroup:y}={...t};this._setName(e),this.anchor=null!=v?v:sz.defaults.anchor.clone();let w=new iN;this.addComponent(w),this.pos=null!=r?r:em(null!=i?i:0,null!=s?s:0),this.rotation=null!=p?p:0,this.scale=null!=o?o:em(1,1),this.z=null!=g?g:0,w.coordPlane=null!=n?n:j.World,this.addComponent(new su),this.addComponent(new sl({anchor:this.anchor})),this.addComponent(new iW),this.vel=null!=c?c:eg.Zero,this.acc=null!=u?u:eg.Zero,this.angularVelocity=null!=_?_:0,this.addComponent(new sM),this.addComponent(new i8),this.body.collisionType=null!=x?x:Z.Passive,y&&(this.body.group=y),d?this.addComponent(new i7(d)):l?this.addComponent(new i7(i6.Circle(l))):a>0&&h>0?this.addComponent(new i7(i6.Box(a,h,this.anchor))):this.addComponent(new i7),this.graphics.visible=null==f||f,m&&(this.color=m,a&&h?this.graphics.add(new sd({color:m,width:a,height:h})):l&&this.graphics.add(new sc({color:m,radius:l})))}clone(){let t=new sz({color:this.color.clone(),anchor:this.anchor.clone()});t.clearComponents(),t.processComponentRemoval();// Clone the current actors components
 ...
 */sz.defaults={anchor:eg.Half};/**
 * Helper [[Actor]] primitive for drawing UI's, optimized for UI drawing. Does
 * not participate in collisions. Drawn on top of all other actors.
 */class sO extends sz{constructor(t){var e,i;super({...t}),this.get(iN).coordPlane=j.Screen,this.anchor=null!==(e=null==t?void 0:t.anchor)&&void 0!==e?e:em(0,0),this.body.collisionType=null!==(i=null==t?void 0:t.collisionType)&&void 0!==i?i:Z.PreventCollision,this.pointer.useGraphicsBounds=!0,this.pointer.useColliderShape=!1,!(null==t?void 0:t.collider)&&(null==t?void 0:t.width)>0&&(null==t?void 0:t.height)>0&&this.collider.useBoxCollider(this.width,this.height,this.anchor)}_initialize(t){this._engine=t,super._initialize(t)}contains(t,e,i=!0){if(i)return super.contains(t,e);let s=this._engine.worldToScreenCoordinates(new eg(t,e));return super.contains(s.x,s.y)}}/**
...
this.random=null!=n?n:new er,this.randomRange=r,this.interval=this._generateRandomInterval(),this.on(()=>{this.interval=this._generateRandomInterval()})}this.repeats=i||this.repeats,t&&this.on(t)}/**
     ...
     */cancel(){this.pause(),this.scene&&this.scene.cancelTimer(this)}}sH._MAX_ID=0;class sN extends iU{constructor(t){super(),this.type="ex.parallax",this.parallaxFactor=em(1,1),this.parallaxFactor=null!=t?t:this.parallaxFactor}}/**
 ...
 *
 */class sW extends iU{constructor(t,e=!0){super(),this.draw=t,this.useTransform=e,this.type="ex.debuggraphics"}}let sG={PreUpdate:"preupdate",PostUpdate:"postupdate",PreDraw:"predraw",PostDraw:"postdraw"};/**
...
this._collider.$colliderAdded.notifyAll(this._composite)}/**
     ...
     */draw(t,e){let i,s,r,n;this.emit("predraw",new tB(t,e,this));// TODO fix event
...
let r=i[s];if(r){so(r)&&(null==r||r.tick(e,this._token));let i=this.renderFromTopOfGraphic?0:r.height-this.tileHeight;r.draw(t,a*this.tileWidth,l*this.tileHeight-i)}}l=0}this.emit("postdraw",new tM(t,e,this))}debug(t){let e=this.tileWidth*this.columns,i=this.tileHeight*this.rows,s=eg.Zero;for(let i=0;i<this.rows+1;i++){let r=em(0,i*this.tileHeight);t.drawLine(s.add(r),s.add(em(e,r.y)),ef.Red,2)}for(let e=0;e<this.columns+1;e++){let r=em(e*this.tileWidth,0);t.drawLine(s.add(r),s.add(em(r.x,i)),ef.Red,2)}let r=this._composite.getColliders();for(let e of r){let i=ef.Gray;i.a=.5;let s=e.localBounds,r=e.worldPos.sub(this.pos);t.drawRectangle(r,s.width,s.height,i)}}}/**
 * TileMap Tile
 *
...
e.colliderA.events.emit("precollision",new tX(e.colliderA,e.colliderB,t,i)),e.colliderB.events.emit("precollision",new tX(e.colliderB,e.colliderA,G.getOpposite(t),i.negate()))}}postSolve(t){var e,i;for(let s of t){if(s.isCanceled())continue;let t=s.colliderA,r=s.colliderB,n=null===(e=t.owner)||void 0===e?void 0:e.get(i8),o=null===(i=r.owner)||void 0===i?void 0:i.get(i8);if(n&&o&&(n.collisionType===Z.Passive||o.collisionType===Z.Passive))continue;let a=G.fromDirection(s.mtv),h=s.mtv.negate();// Publish collision events on both participants
...
if(t.collisionType===Z.Passive||n.collisionType===Z.Passive)continue;let e=null!==(s=this.idToContactConstraint.get(r.id))&&void 0!==s?s:[];for(let i of e){let e=r.normal,s=i3.FindContactSeparation(r,i.local),o=iD.steeringFactor,a=iD.slop,h=eh(o*(s+a),-5,0),l=e.scale(-h*i.normalMass);// This is a pseudo impulse, meaning we aren't doing a real impulse calculation
// We adjust position and rotation instead of doing the velocity
if(t.collisionType===Z.Active){// TODO make applyPseudoImpulse function?
let e=l.negate().scale(t.inverseMass);t.limitDegreeOfFreedom.includes(Q.X)&&(e.x=0),t.limitDegreeOfFreedom.includes(Q.Y)&&(e.y=0),t.globalPos=t.globalPos.add(e),t.limitDegreeOfFreedom.includes(Q.Rotation)||(t.rotation-=i.aToContact.cross(l)*t.inverseInertia)}if(n.collisionType===Z.Active){let t=l.scale(n.inverseMass);n.limitDegreeOfFreedom.includes(Q.X)&&(t.x=0),n.limitDegreeOfFreedom.includes(Q.Y)&&(t.y=0),n.globalPos=n.globalPos.add(t),n.limitDegreeOfFreedom.includes(Q.Rotation)||(n.rotation+=i.bToContact.cross(l)*n.inverseInertia)}}}}}solveVelocity(t){var e,i,s;for(let r=0;r<iD.velocityIterations;r++)for(let r of t){let t=null===(e=r.colliderA.owner)||void 0===e?void 0:e.get(i8),n=null===(i=r.colliderB.owner)||void 0===i?void 0:i.get(i8);if(t&&n){// Skip solving active+passive
...
this._lastFrameContacts=new Map(this._currentFrameContacts)}getSolver(){return iD.collisionResolutionStrategy===K.Realistic?this._realisticSolver:this._arcadeSolver}debug(t){this._processor.debug(t)}runContactStartEnd(){// Composite collider collisions may have a duplicate id because we want to treat those as a singular start/end
 ...
 */class Animation extends ek{constructor(t){var e,i;super(t),this.events=new tS,this.frames=[],this.strategy=th.Loop,this.frameDuration=100,this.timeScale=1,this._idempotencyToken=-1,this._firstTick=!0,this._currentFrame=0,this._timeLeftInFrame=0,this._pingPongDirection=1,this._done=!1,this._playing=!0,this._reversed=!1,this.frames=t.frames,this.strategy=null!==(e=t.strategy)&&void 0!==e?e:this.strategy,this.frameDuration=t.totalDuration?t.totalDuration/this.frames.length:null!==(i=t.frameDuration)&&void 0!==i?i:this.frameDuration,t.reverse&&this.reverse(),this.goToFrame(0)}clone(){return new Animation({frames:this.frames.map(t=>({...t})),frameDuration:this.frameDuration,reverse:this._reversed,strategy:this.strategy,...this.cloneGraphicOptions()})}get width(){let t=this.currentFrame;return t?Math.abs(t.graphic.width*this.scale.x):0}get height(){let t=this.currentFrame;return t?Math.abs(t.graphic.height*this.scale.y):0}/**
...
for(let t of o){s=this._processDownAndEmit(t),i=this._processUpAndEmit(t),e=this._processMoveAndEmit(t);let r=[...e.values(),...s.values(),...i.values()];this._processEnterLeaveAndEmit(t,r),this._processCancelAndEmit(t),this._processWheelAndEmit(t)}}}class rx extends s5{constructor(){super(...arguments),this.types=["ex.actions"],this.systemType=to.Update,this.priority=-1,this._actions=[]}notify(t){if(s4(t)){let e=t.data.get(sM);this._actions.push(e)}else{let e=t.data.get(sM),i=this._actions.indexOf(e);i>-1&&this._actions.splice(i,1)}}update(t,e){for(let t of this._actions)t.update(e)}}class ry extends iU{/**
     ...
     */constructor(t){super(),this.type="ex.isometricentity",/**
         ...
         */this.elevation=0,this.map=t}}class rw extends s5{constructor(){super(...arguments),this.types=["ex.transform","ex.isometricentity"],this.systemType=to.Update,this.priority=99}update(t,e){let i,s;for(let e of t){i=e.get(iN),s=e.get(ry);let t=Math.max(s.map.columns*s.map.tileWidth,s.map.rows*s.map.tileHeight),r=t*s.elevation+i.pos.y;i.z=r}}}class rb extends s5{constructor(){super(...arguments),this.types=["ex.transform","ex.graphics"],this.systemType=to.Draw,this.priority=-1}initialize(t){this._camera=t.camera,this._screen=t.engine.screen}update(t){let e,i,s;for(let r of(this._worldBounds=this._screen.getWorldBounds(),t)){let t;if(i=r.get(sl),e=r.get(iN),s=r.get(sN)){// We use the Tiled formula
// https://doc.mapeditor.org/en/latest/manual/layers/#parallax-scrolling-factor
// cameraPos * (1 - parallaxFactor)
...
this.onInitialize.call(this,t),this._initializeChildren(),this._logger.debug("Scene.onInitialize",this,t),this.events.emit("initialize",new t0(t,this)),this._isInitialized=!0)}/**
     ...
     *
     * @internal
     */_postdraw(t,e){this.emit("postdraw",new tM(t,e,this)),this.onPostDraw(t,e)}/**
...
this.emit("postdebugdraw",new tk(t,this))}/**
     ...
     */isTimerActive(t){return this._timers.indexOf(t)>-1&&!t.complete}isCurrentScene(){return!!this.engine&&this.engine.currentScene===this}_collectActorStats(t){let e=this.actors.filter(t=>t instanceof sO);for(let i of e)t.stats.currFrame.actors.ui++;for(let e of this.actors)for(let i of(t.stats.currFrame.actors.alive++,e.children))sU(i)?t.stats.currFrame.actors.ui++:t.stats.currFrame.actors.alive++}}(F=tc||(tc={})).Protanope="Protanope",F.Deuteranope="Deuteranope",F.Tritanope="Tritanope";/**
 ...
 */class rR{constructor(){this._id=0,this._delta=0,this._fps=0,this._actorStats={alive:0,killed:0,ui:0,get remaining(){return this.alive-this.killed},get total(){return this.remaining+this.ui}},this._durationStats={update:0,draw:0,get total(){return this.update+this.draw}},this._physicsStats=new rF,this._graphicsStats={drawCalls:0,drawnImages:0}}/**
     ...
     */get graphics(){return this._graphicsStats}}class rF{constructor(){this._pairs=0,this._collisions=0,this._contacts=new Map,this._fastBodies=0,this._fastBodyCollisions=0,this._broadphase=0,this._narrowphase=0}/**
     ...
     * Provides a clone of this instance.
     */clone(){let t=new rF;return t.reset(this),t}get pairs(){return this._pairs}set pairs(t){this._pairs=t}get collisions(){return this._collisions}set collisions(t){this._collisions=t}get contacts(){return this._contacts}set contacts(t){this._contacts=t}get fastBodies(){return this._fastBodies}set fastBodies(t){this._fastBodies=t}get fastBodyCollisions(){return this._fastBodyCollisions}set fastBodyCollisions(t){this._fastBodyCollisions=t}get broadphase(){return this._broadphase}set broadphase(t){this._broadphase=t}get narrowphase(){return this._narrowphase}set narrowphase(t){this._narrowphase=t}}class rB{on(t,e){this._nativeHandlers[t]&&this.off(t,this._nativeHandlers[t]),this._nativeHandlers[t]=this._decorate(e),this.nativeComponent.addEventListener(t,this._nativeHandlers[t])}off(t,e){e||(e=this._nativeHandlers[t]),this.nativeComponent.removeEventListener(t,e),this._nativeHandlers[t]=null}_decorate(t){return e=>{this._paused||t(e)}}pause(){this._paused=!0}resume(){this._paused=!1}clear(){for(let t in this._nativeHandlers)this.off(t)}constructor(t){this.nativeComponent=t,this._paused=!1,this._nativeHandlers={}}}class rM{constructor(t,e){this._windowGlobal=t,this._documentGlobal=e,this._windowComponent=new rB(this._windowGlobal),this._documentComponent=new rB(this._documentGlobal)}get window(){return this._windowComponent}get document(){return this._documentComponent}pause(){this.window.pause(),this.document.pause()}resume(){this.window.resume(),this.document.resume()}clear(){this.window.clear(),this.document.clear()}}class rD{static fromPagePosition(t,e,i){let s,r;3==arguments.length?(s=new eg(t,e),r=i):((s=t).x,s.y,r=e);let n=r.screen.pageToScreenCoordinates(s),o=r.screen.screenToWorldCoordinates(n);return new rD(o,s,n)}constructor(t,e,i){this.worldPos=t,this.pagePos=e,this.screenPos=i}}class PointerEvent{cancel(){this.active=!1}get pagePos(){return this.coordinates.pagePos}get screenPos(){return this.coordinates.screenPos}get worldPos(){return this.coordinates.worldPos}constructor(t,e,i,s,r,n){this.type=t,this.pointerId=e,this.button=i,this.pointerType=s,this.coordinates=r,this.nativeEvent=n,this.active=!0}}class WheelEvent{cancel(){this.active=!1}constructor(t,e,i,s,r,n,o,a,h,l,d,c){this.x=t,this.y=e,this.pageX=i,this.pageY=s,this.screenX=r,this.screenY=n,this.index=o,this.deltaX=a,this.deltaY=h,this.deltaZ=l,this.deltaMode=d,this.ev=c,this.active=!0}}class rk{constructor(){this.events=new tS,/**
         * The last position on the document this pointer was at. Can be `null` if pointer was never active.
         */this.lastPagePos=eg.Zero,/**
         * The last position on the screen this pointer was at. Can be `null` if pointer was never active.
         */this.lastScreenPos=eg.Zero,/**
         * The last position in the game world coordinates this pointer was at. Can be `null` if pointer was never active.
         */this.lastWorldPos=eg.Zero,this._onPointerMove=t=>{this.lastPagePos=new eg(t.pagePos.x,t.pagePos.y),this.lastScreenPos=new eg(t.screenPos.x,t.screenPos.y),this.lastWorldPos=new eg(t.worldPos.x,t.worldPos.y)},this._onPointerDown=t=>{this.lastPagePos=new eg(t.pagePos.x,t.pagePos.y),this.lastScreenPos=new eg(t.screenPos.x,t.screenPos.y),this.lastWorldPos=new eg(t.worldPos.x,t.worldPos.y)},this.on("move",this._onPointerMove),this.on("down",this._onPointerDown)}emit(t,e){this.events.emit(t,e)}on(t,e){return this.events.on(t,e)}once(t,e){return this.events.once(t,e)}off(t,e){this.events.off(t,e)}}(B=tu||(tu={})).Pixel="Pixel",B.Line="Line",B.Page="Page",(M=tp||(tp={}))[M.NoButton=-1]="NoButton",M[M.Left=0]="Left",M[M.Middle=1]="Middle",M[M.Right=2]="Right",M[M.Unknown=3]="Unknown",(D=t_||(t_={})).Left="Left",D.Middle="Middle",D.Right="Right",D.Unknown="Unknown",D.NoButton="NoButton",(k=tg||(tg={})).Touch="Touch",k.Mouse="Mouse",k.Pen="Pen",k.Unknown="Unknown";/**
 ...
 */class rL{constructor(t,e){this.target=t,this.engine=e,this.events=new tS,this.primary=new rk,this._activeNativePointerIdsToNormalized=new Map,this.lastFramePointerCoords=new Map,this.currentFramePointerCoords=new Map,this.currentFramePointerDown=new Map,this.lastFramePointerDown=new Map,this.currentFrameDown=[],this.currentFrameUp=[],this.currentFrameMove=[],this.currentFrameCancel=[],this.currentFrameWheel=[],this._pointers=[this.primary],this._boundHandle=this._handle.bind(this),this._boundWheel=this._handleWheel.bind(this)}/**
     ...
     * @param index
     */at(t){if(t>=this._pointers.length)for(let e=this._pointers.length-1;e<t;e++)this._pointers.push(new rk);return this._pointers[t]}/**
...
let s=this.engine.currentScene.world.systemManager.get(rv),r=this.engine.currentScene.world.queryManager.createQuery(s.types);s.preupdate(),s.update(r.getEntities())}_nativeButtonToPointerButton(t){switch(t){case tp.NoButton:return t_.NoButton;case tp.Left:return t_.Left;case tp.Middle:return t_.Middle;case tp.Right:return t_.Right;case tp.Unknown:return t_.Unknown;default:return eS(t)}}_stringToPointerType(t){switch(t){case"touch":return tg.Touch;case"mouse":return tg.Mouse;case"pen":return tg.Pen;default:return tg.Unknown}}}class rz{constructor(t){var e;this._samplePeriod=100,this._currentFrameTime=0,this._frames=0,this._previousSampleTime=0,this._beginFrameTime=0,this._fps=t.initialFps,this._samplePeriod=null!==(e=t.samplePeriod)&&void 0!==e?e:this._samplePeriod,this._currentFrameTime=1e3/t.initialFps,this._nowFn=t.nowFn,this._previousSampleTime=this._nowFn()}/**
 ...
 */class rH extends rU{constructor(t){super({...t}),this._logger=t7.getInstance(),this._running=!1,this._currentTime=0,this._updateMs=t.defaultUpdateMs}/**
     * Get the current time in milliseconds
...
let n=t&&t.pointerScope===W.Document?document:this.canvas;this.input={keyboard:new es,pointers:new rL(n,this),gamepads:new t6},this.input.keyboard.init({grabWindowFocus:null===(i=null===(e=this._originalOptions)||void 0===e?void 0:e.grabWindowFocus)||void 0===i||i}),this.input.pointers.init({grabWindowFocus:null===(r=null===(s=this._originalOptions)||void 0===s?void 0:s.grabWindowFocus)||void 0===r||r}),this.input.gamepads.init(),this.inputMapper=new rG(this.input),// Issue #385 make use of the visibility api
...
this.graphicsContext.flush(),this.graphicsContext.endDrawLifecycle(),this._checkForScreenShots()}/**
     ...
     * @internal
     */_postdraw(t,e){this.emit("postdraw",new tM(t,e,this)),this.onPostDraw(t,e)}onPostDraw(t,e){// Override me
}/**
...
this._overrideInitialize(this),this._isReady=!0,this._isReadyResolve(),this.emit("start",new tR(this)),this._isReadyPromise}_mainloop(t){this.emit("preframe",new tU(this,this.stats.prevFrame));let e=t*this.timescale;this.currentFrameElapsedMs=e;// reset frame stats (reuse existing instances)
let i=this.stats.prevFrame.id+1;this.stats.currFrame.reset(),this.stats.currFrame.id=i,this.stats.currFrame.delta=e,this.stats.currFrame.fps=this.clock.fpsSampler.fps,e$.clear();let s=this.clock.now(),r=1e3/this.fixedUpdateFps;if(this.fixedUpdateFps)for(this._lagMs+=e;this._lagMs>=r;)this._update(r),this._lagMs-=r;else this._update(e);let n=this.clock.now();this.currentFrameLagMs=this._lagMs,this._draw(e);let o=this.clock.now();this.stats.currFrame.duration.update=n-s,this.stats.currFrame.duration.draw=o-n,this.stats.currFrame.graphics.drawnImages=e$.DrawnImagesCount,this.stats.currFrame.graphics.drawCalls=e$.DrawCallCount,this.emit("postframe",new tO(this,this.stats.currFrame)),this.stats.prevFrame.reset(this.stats.currFrame),this._monitorPerformanceThresholdAndTriggerFallback()}/**
     ...
     */stop(){this.clock.isRunning()&&(this.emit("stop",new tF(this)),this.browser.pause(),this.clock.stop(),this._logger.debug("Game stopped"))}/**
 ...
 * your art assets.
 */class rY extends sn{constructor(t){super([new iN,new i8({type:Z.Fixed}),new i7,new sW(t=>this.debug(t),!1)],t.name),/**
 ...
 */class r${constructor(t,e){this._stopped=!1,this._sequenceBuilder=e,this._sequenceContext=new sB(t),this._actionQueue=this._sequenceContext.getQueue(),this._sequenceBuilder(this._sequenceContext)}update(t){this._actionQueue.update(t)}isComplete(){return this._stopped||this._actionQueue.isComplete()}stop(){this._stopped=!0}reset(){this._stopped=!1,this._actionQueue.reset()}clone(t){return new r$(t,this._sequenceBuilder)}}/**
 ...
 */class r6{/**
     ...
     */constructor(t,e=ef.Magenta,i=!1){this.path=t,this.color=e,this._stream=null,this._gif=null,this._textures=[],this._animation=null,this._transparentColor=null,this._resource=new eB(t,"arraybuffer",i),this._transparentColor=e}/**
     * Should excalibur add a cache busting querystring? By default false.
     * Must be set before loading
     */get bustCache(){return this._resource.bustCache}set bustCache(t){this._resource.bustCache=t}/**
...
})(),r.fWn,r.Ia8;var n=r.rqv;r.hLI,r.yyv,r.tX5;var o=r.vtX;r.r7K,r.lCh,r.cE4;var a=r.fwF;r.sce,r.AQ6;var h=r._c7;r.KUs,r.Ajp,r.dkO,r.RDh,r._H9,r.mxs,r.OmD,r.kBf,r.C4F,r.NQt,r.JjN,r.EK_,r.V1s,r.xHm,r.Xz7,r.Cdc,r.FKn,r.SUY,r.ab2,r.GfZ,r.YMS,r.oyv,r.aUb,r.SdD,r.JUv,r.jEj,r.TFq,r.HDU,r.R_y,r.ydN,r.t50,r.s$$,r.v2G;var l=r.Ilk;r.s9i,r.dxL,r.LLX;var d=r.wA2;r.R_p,r.IQ$,r.I5F,r.X8$,r.FR6,r.U8o;var c=r.kbG;r.iS_,r.cGG,r.RPN,r.skb,r.SLU,r.RdJ,r.cNu,r.gU7,r.LSk,r.Nmp;var u=r.d1Y;r.xrL,r.sRW,r.cmV,r.qWz,r.N0Q;var p=r.q8b;r.ynB,r.jT9,r.wAz;var _=r.D4V;r.NLr,r.N6H,r.W1A,r.JHW,r.ZZ$,r.v2K,r.pBf,r.vpe,r.GMl,r.zW2,r.B0K,r.Nv7,r.C_p,r.MUA,r.xqU,r.pTp,r.vUK,r.j9l,r.Zxw,r.v51,r.Hdx,r.Z$d,r.iqV,r.o$7;var g=r.olM;r.Zm$,r.$QH,r.i78,r.nJg,r.h6u,r.hts,r.j88,r.VME,r.fy2,r.nt,r.Ukr,r.zsu,r.oA6,r.TVh,r.TwZ,r.GTT,r.xxj,r.XdK,r.Jmb;var m=r.cXo;r.Dm5,r.IIB,r.ebW,r.zI0,r.LYD,r.cEG,r.SEl,r.t9V,r.ez5,r.N1d,r.R8U,r.SKZ,r.__J,r.RI$,r.x12,r.ccz;var f=r.aNw;r.XrL,r.xwn,r.dNK,r.ini,r.YdH,r.F5T,r.y3G,r.l57,r.xn0,r.t2V,r.uxB,r.cpd,r.fiy,r.$XZ,r.UG6,r.uqK,r.STE,r.y$z,r.mAD,r.sOq,r.hUw;var v=r._0G;r.Sqs,r.hpZ,r.Vol,r.vYX,r.wIZ,r.cBi,r.c30,r.MPV,r.RFv,r.Ux6,r.rxy,r.I$c,r.kfC,r.VjY,r.mgq,r.YVA,r.Kgp,r.HH$,r.M_d,r.rgh,r.Ra6,r.KhR,r.BS5,r.xhz,r.xOq,r.a9j,r.bHk,r.CgK,r.cuY,r.kvE,r.SBu,r.AE_,r.ctO,r.OLH;var x=r.kky;r.nSF,r.zHn,r.zwx,r.AeJ,r.hLz,r.D9g,r.wA,r.jhr,r.GVs,r._zO,r.LXZ,r.w6$,r.mhV,r.MOD,r.kwd,r.Lmr,r.xsS,r.K5l,r.lLr,r.Z$r,r.IXb,r.SGH,r.SMj,r.L34,r.exe,r.bnF,r.MFA;var y=r.$uU;r.Sap,r.jyi,r.E03;var w=r.V6q;r.rg2,r.DVW,r.nVo,r.F6N,r.xP7,r.Odq,r.Zif,r.ZGJ,r.MJk,r.xvT,r.PHM,r.dpR,r.n9L,r.KwO,r.SxM,r.B7y,r.x7r,r.wx7,r.Uvn,r.OFT,r.xzN,r.CcZ,r.M5Z;var b=r.ZrN,C=r.OWs;r.dF9,r.oZy,r.rD2,r.VHo,r.ohE,r.R$E,r.xQN,r.AdJ,r.q3I,r.Pab;var A=r.uZ5;r.McK,r.F9c,r.k0b,r.hnT,r.RSJ,r.Mku,r.h90,r.rms,r.ErP,r.aVg,r.lPc,r.Z8E,r._N2,r.yFn,r.lNv,r.cu9,r.MZQ,r.FUM,r.BxR;var S=r.vdf,T=r.iaL;r.w6H,r.Q4c,r.Xxe,r.Uxb,r.Yr5;var E=r.Bhw;r.yOA;var P={};P=new URL("KnightSheet.2897b254.png",import.meta.url).toString();var I={};I=new URL("SpiderSheet.597e1dd4.png",import.meta.url).toString();var R={};R=new URL("HeartSheet.54a99443.png",import.meta.url).toString();var F={};F=new URL("UISheet.2837e64f.png",import.meta.url).toString();var B={};B=new URL("TerrainSheet.720a833c.png",import.meta.url).toString();var M={};M=new URL("HighlightSheet.fff21fa0.png",import.meta.url).toString();var D={};D=new URL("Cloud.e0b572a9.png",import.meta.url).toString();var k={};k=new URL("Smoke.7bc6cfe7.png",import.meta.url).toString();var L={};L=new URL("hit.cc332530.wav",import.meta.url).toString();var z={};z=new URL("move.8e8aee5f.wav",import.meta.url).toString();var U={};U=new URL("unitselect.d85b2a99.wav",import.meta.url).toString();const O={KnightSpriteSheet:new m(/*@__PURE__*/t(P)),SpiderSheet:new m(/*@__PURE__*/t(I)),HeartSheet:new m(/*@__PURE__*/t(R)),UISheet:new m(/*@__PURE__*/t(F)),TerrainSheet:new m(/*@__PURE__*/t(B)),HighlightSheet:new m(/*@__PURE__*/t(M)),CloudSheet:new m(/*@__PURE__*/t(D)),Smoke:new m(/*@__PURE__*/t(k)),HitSound:new y(/*@__PURE__*/t(L)),MoveSound:new y(/*@__PURE__*/t(z)),SelectSound:new y(/*@__PURE__*/t(U))},H=w.fromImageSource({image:O.TerrainSheet,grid:{rows:5,columns:5,spriteHeight:32,spriteWidth:32}}),N=w.fromImageSource({image:O.HighlightSheet,grid:{rows:1,columns:5,spriteHeight:32,spriteWidth:32}}),W=a.fromSpriteSheetCoordinates({spriteSheet:N,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:100},{x:1,y:0,duration:100},{x:2,y:0,duration:100},{x:3,y:0,duration:100},{x:4,y:0,duration:100}]}),G=w.fromImageSource({image:O.SpiderSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),V=a.fromSpriteSheetCoordinates({spriteSheet:G,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),q=w.fromImageSource({image:O.KnightSpriteSheet,grid:{rows:1,columns:4,spriteHeight:32,spriteWidth:32}}),X=a.fromSpriteSheetCoordinates({spriteSheet:q,strategy:h.Loop,frameCoordinates:[{x:0,y:0,duration:200},{x:1,y:0,duration:200},{x:2,y:0,duration:200},{x:3,y:0,duration:200}]}),Z=w.fromImageSource({image:O.HeartSheet,grid:{rows:1,columns:6,spriteHeight:32,spriteWidth:32}}),K=new f;for(let t of Object.values(O))K.addResource(t);const Y=performance.now();console.log("Random seed:",Y);const $=new x(Y),j=E(3,3),Q=E(96,128),J={Knight:{graphics:{offset:E(0,12*j.y),idle:X},health:5,range:4,attack:2},Spider:{graphics:{offset:E(0,8*j.y),idle:V},health:3,range:3,attack:1}};class tt extends o{constructor(t){super({pos:t,coordPlane:c.Screen,vel:E(S(-30,-100),0),width:100,height:100})}onInitialize(t){this.cloudSprite=O.CloudSheet.toSprite(),this.cloudSprite.scale=j,this.graphics.use(this.cloudSprite)}onPostUpdate(t,e){this.pos.x+this.cloudSprite.width<0&&(this.pos.x=t.screen.contentArea.right+this.cloudSprite.width)}}class te extends d{static #t=this.type="path-node";constructor(t){super(),this.type="path-node",this.pos=E(0,0),/**
...
,this.gScore=1/0,this.hScore=1/0,this.weight=1,this.direction=C.Zero,this.connections=[],this.previousNode=null,this.pos=t}}const ti=W.clone(),ts=W.clone();class tr extends o{/**
     * Individual cells on the board
     * 
     * @param x integer coordinate
     * @param y integer coordinate
     * @param board 
     */constructor(t,e,i){super({name:`cell(${t}, ${e})`,pos:E(t*(i.tileWidth+i.margin)*j.x,e*(i.tileHeight+i.margin)*j.y).add(Q),anchor:C.Zero}),this.x=t,this.y=e,this.board=i,this.unit=null,this.pathNode=new te(this.pos),this.addComponent(this.pathNode),this.sprite=H.sprites[T(0,5)],this.sprite.scale=j,this.graphics.use(this.sprite.clone()),ti.scale=j,ts.scale=j,ts.tint=l.Green,this.graphics.add("range",ti),this.graphics.add("path",ts)}addUnit(t){this.unit=t,this.unit.cell=this,this.pathNode.walkableMask=t.player.mask}removeUnit(t){this.pathNode.walkableMask=-1,this.unit=null,t.cell=null}toggleHighlight(t,e){// reset highlight
this.graphics.hide("range"),this.graphics.hide("path"),t?this.graphics.show(e):this.graphics.hide(e)}getDistance(t){return Math.abs(this.pos.x-t.pos.x)+Math.abs(this.pos.y-t.pos.y)}/**
     * Returns the orthogonal neighbors (up, down, left, right)
     * @returns 
     */getNeighbors(){return[this.board.getCell(this.x,this.y-1),this.board.getCell(this.x,this.y+1),this.board.getCell(this.x+1,this.y),this.board.getCell(this.x-1,this.y)].filter(function(t){return null!==t})}}class tn{constructor(t){this.heuristicWeight=1,this.heuristic=(t,e)=>Math.abs(t.pos.x-e.pos.x)+Math.abs(e.pos.y-e.pos.y),this.query=t.world.queryManager.createQuery([te.type])}_buildPath(t){let e=[];for(;t.previousNode;)e.unshift(t),t=t.previousNode;return e.unshift(t),e}_getRangeHelper(t,e,i,s){s>=0&&(e.push(t),t.connections.filter(t=>t.isWalkable&&!!(t.walkableMask&i)).forEach(t=>this._getRangeHelper(t,e,i,s-1)))}getRange(t,e,i){let s=[];return this._getRangeHelper(t,s,e,i),s=// dedup results
(s=s.filter((t,e,i)=>i.indexOf(t)===e)).filter(t=>t.isWalkable)}/**
     ...
     * @param range 
     * @returns 
     */findPath(t,e,i,s){let r=this.query.getEntities().map(t=>t.get(te));r.forEach(t=>{t.gScore=0,t.hScore=0,t.previousNode=null}),t.gScore=0,t.hScore=t.gScore+this.heuristic(t,e)*this.heuristicWeight,t.direction=C.Down;let n=[t],o=[];for(;n.length>0;){// priority queue, evaluate nodes with the lowest cost
...
return[]}}class to extends o{constructor(t,e,i,s,r){super({anchor:E(0,0)}),this.player=r,this.cell=null,this.unitConfig={...J[i]};let n=this.unitConfig.graphics.idle;n.scale=j,this.graphics.use(n),this.graphics.onPostDraw=this.onPostDraw.bind(this);let o=s.getCell(t,e);o&&(this.pos=o.pos.sub(this.unitConfig.graphics.offset),o.addUnit(this))}onPostDraw(t){let e=Z.getSprite(A(this.unitConfig.health,0,5),0);e&&(e.scale=j,e.draw(t,10*j.x,16*j.y))}async move(t){this.cell&&this.cell.removeUnit(this);let e=null;for(let i of t.slice(1,t.length)){e=i.owner;let t=new n(this,t=>{t.delay(200),t.callMethod(()=>{O.MoveSound.play()})}),s=new n(this,t=>{t.easeTo(e.pos.sub(this.unitConfig.graphics.offset),300,p.EaseInOutCubic)}),r=new v([t,s]);await this.actions.runAction(r).toPromise()}e&&e.addUnit(this)}}class ta{static #t=this._STARTING_BIT=1;static #e=this._CURRENT_GROUP=ta._STARTING_BIT;constructor(t){this.name=t,this.mask=ta._CURRENT_GROUP=ta._CURRENT_GROUP<<1|0}}const th=new _({width:800,height:800,displayMode:u.FitScreenAndFill});// TODO move to level
// Add clouds :3
th.add(new tt(E(800,0))),th.add(new tt(E(400,300))),th.add(new tt(E(700,700)));const tl=new class{constructor(t,e,i){this.tileWidth=32,this.tileHeight=32,this.margin=2,this.cells=[],this.rows=t,this.cols=e;for(let t=0;t<this.rows*this.cols;t++){let e=new tr(t%this.cols,Math.floor(t/this.cols),this);this.cells.push(e),i.add(e)}// setup neighbors connections
for(let t of this.cells)t.pathNode.connections=t.getNeighbors().map(t=>t.pathNode);this.pathFinder=new tn(i)}getUnits(){let t=[];for(let e of this.cells)e.unit&&t.push(e.unit);return t}getEmptyCells(){return this.cells.filter(t=>!t.unit)}getCellByWorldPos(t){return this.getCell(Math.floor((t.x-Q.x)/((this.tileWidth+this.margin)*j.x)),Math.floor((t.y-Q.y)/((this.tileHeight+this.margin)*j.y)))}getCell(t,e){return t<0||t>=this.cols||e<0||e>=this.rows?null:this.cells[t+e*this.cols]}}(6,6,th.currentScene),td=new class{constructor(t,e){this.engine=t,this.board=e,this.currentPlayer=null,this.currentUnitSelection=null,this.currentRange=[],this.currentPath=[],this.active=!1,this.humanMove=new g,t.input.pointers.on("down",this.pointerClick.bind(this)),t.input.pointers.on("move",this.pointerMove.bind(this))}reset(){this.resetHighlight(),this.currentUnitSelection=null,this.currentPath=[],this.currentRange=[]}pointerMove(t){if(!this.active||!this.currentUnitSelection)return;this.resetHighlight();let e=this.findRange(this.currentUnitSelection);this.showHighlight(e,"range");let i=this.board.getCellByWorldPos(t.worldPos);if(i){let t=this.findPath(i,this.currentRange);this.showHighlight(t,"path")}}async pointerClick(t){if(!this.active)return;let e=this.board.getCellByWorldPos(t.worldPos);// a unit is currently selected
this.currentUnitSelection?e?(await this.selectDestinationAndMove(this.currentUnitSelection,e),this.humanMove.resolve()):this.reset():e?.unit?this.selectUnit(e.unit):this.reset()}selectPlayer(t){this.currentPlayer=t}selectUnit(t){t.player===this.currentPlayer&&(this.currentUnitSelection=t,this.currentRange=this.findRange(this.currentUnitSelection),this.showHighlight(this.currentRange,"range"))}async selectDestinationAndMove(t,e){if(t.player!==this.currentPlayer)return;let i=this.findRange(t);0===this.currentPath.length&&(this.currentPath=this.findPath(e,i)),this.currentPath.length>1&&(this.active=!1,await t.move(this.currentPath)),this.reset()}async waitForHumanMove(){this.active=!0,await this.humanMove.promise,this.humanMove=new g}findRange(t){return this.currentUnitSelection&&t.cell?this.board.pathFinder.getRange(t.cell.pathNode,t.player.mask,this.currentUnitSelection.unitConfig.range).filter(e=>e.isWalkable&&!!(e.walkableMask&t.player.mask)):[]}resetHighlight(){this.board.cells.forEach(t=>{t.toggleHighlight(!1,"range"),t.toggleHighlight(!1,"path")})}showHighlight(t,e){t.forEach(t=>{let i=t.owner;i.toggleHighlight(!0,e)})}findPath(t,e){if(!this.currentUnitSelection)return[];let i=this.currentUnitSelection.cell?.pathNode;if(t&&!t.unit&&e.includes(t.pathNode)){let s=this.board.pathFinder.findPath(i,t?.pathNode,this.currentUnitSelection.player.mask,e);return s}return[]}}(th,tl),tc=new class extends ta{constructor(t,e,i){super(t),this.selectionManger=e,this.board=i}async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t){await b.delay(1e3);// pick a random valid move
let t=[];e.cell&&(t=this.board.pathFinder.getRange(e.cell.pathNode,this.mask,e.unitConfig.range));let i=$.pickOne(t),s=i.owner;this.selectionManger.selectUnit(e),await b.delay(1e3);let r=this.selectionManger.findPath(s,t);this.selectionManger.showHighlight(r,"path"),await b.delay(1e3),await this.selectionManger.selectDestinationAndMove(e,s),await b.delay(1e3)}return!0}}("Monsters of the Forest",td,tl),tu=new class extends ta{constructor(t,e,i){super(t),this.selectionManager=e,this.board=i}// TODO event handlers need to be here
async makeMove(){let t=this.board.getUnits().filter(t=>t.player===this);for(let e of t)await this.selectionManager.waitForHumanMove();return!0}}("Knights of the Round Table",td,tl),tp=new class{constructor(t,e){if(this.players=t,this.currentPlayerIndex=0,0===t.length)throw Error("Players should be non-zero in length");this.currentPlayer=t[this.currentPlayerIndex],this.selectionManager=e}// todo generator??
async start(){let t=10;for(;t>0;){console.log("Current player turn:",this.currentPlayer.name),this.selectionManager.selectPlayer(this.currentPlayer);let e=!0;do e=await this.currentPlayer.makeMove();while(!e)this.nextTurn(),t--}}nextTurn(){this.currentPlayerIndex++,this.currentPlayer=this.players[this.currentPlayerIndex%this.players.length]}}([tu,tc],td),t_=new to(0,0,"Spider",tl,tc);th.add(t_);const tg=new to(4,5,"Spider",tl,tc);th.add(tg);const tm=new to(1,1,"Knight",tl,tu);th.add(tm);const tf=new to(2,1,"Knight",tl,tu);th.add(tf),th.start(K).then(()=>{tp.start()});//# sourceMappingURL=index.1b850a14.js.map

//# sourceMappingURL=index.1b850a14.js.map
